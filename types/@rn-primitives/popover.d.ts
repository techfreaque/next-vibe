declare module '@rn-primitives/popover' {
  ...
  export { Root, Portal, useRootContext } from '@rn-primitives/popover/dist/index';
  ...
  export const Close: React.ForwardRefExoticComponent<CloseProps & React.RefAttributes<CloseRef>>;
