declare module '@rn-primitives/menubar' {
  ...
  export { Root, Menu, Portal, useMenuContext, useRootContext, useSubContext } from '@rn-primitives/menubar/dist/index';
  ...
  export type SubContentProps = ViewProps & {
    className?: string;
    forceMount?: true | undefined;
    asChild?: boolean;
  };
  ...
  export type SubContentRef = View;
