...
ALTER TABLE "cron_tasks" ADD COLUMN "route_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "cron_tasks" ADD COLUMN "display_name" text NOT NULL;--> statement-breakpoint
