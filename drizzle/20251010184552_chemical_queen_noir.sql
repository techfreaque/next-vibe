...
CREATE TABLE "email_agent_processing" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"email_id" uuid NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.agent.enums.emailAgentStatus.pending' NOT NULL,
	"priority" text DEFAULT 'app.api.v1.core.agent.enums.processingPriority.normal' NOT NULL,
	"hard_rules_processed_at" timestamp,
	"hard_rules_result" json,
...
CREATE TABLE "human_confirmation_requests" (
	...
	"status" text DEFAULT 'app.api.v1.core.agent.enums.confirmationStatus.pending' NOT NULL,
...
CREATE TABLE "brand" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"brand_guidelines" boolean DEFAULT false,
	...
	"visual_style" text,
	"brand_promise" text,
	"brand_differentiators" text,
	"brand_mission" text,
	"brand_vision" text,
	"has_style_guide" boolean DEFAULT false,
	"has_logo_files" boolean DEFAULT false,
...
CREATE TABLE "consultations" (
	...
	"user_id" uuid,
	"lead_id" uuid,
	"status" text DEFAULT 'app.api.v1.core.consultation.enums.consultationStatus.pending' NOT NULL,
...
CREATE TABLE "contact" (
	...
	"status" text DEFAULT 'app.api.v1.core.contact.status.new' NOT NULL,
	"user_id" uuid,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE "imap_configurations" (
	...
	"logging_level" text DEFAULT 'app.api.v1.core.emails.enums.imapLoggingLevel.info' NOT NULL,
...
CREATE TABLE "emails" (
	...
	"type" text NOT NULL,
	"template_name" text,
	"status" text DEFAULT 'app.api.v1.core.emails.enums.emailStatus.pending' NOT NULL,
	"email_provider" text DEFAULT 'app.api.v1.core.emails.enums.emailProvider.smtp',
	"external_id" text,
	"sent_at" timestamp,
	...
	"sync_status" text DEFAULT 'app.api.v1.core.emails.enums.imapSyncStatus.pending',
	"sync_error" text,
	"metadata" json DEFAULT '{}'::json,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
...
CREATE TABLE "imap_accounts" (
	...
	"auth_method" text DEFAULT 'app.api.v1.core.emails.enums.imapAuthMethod.plain',
...
CREATE TABLE "imap_server_configs" (
	...
	"log_level" text DEFAULT 'app.api.v1.core.emails.enums.imapLoggingLevel.info' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "smtp_accounts" (
	...
	"security_type" text DEFAULT 'app.api.v1.core.emails.enums.smtpSecurityType.starttls' NOT NULL,
	"username" text NOT NULL,
	"password" text NOT NULL,
	...
	"status" text DEFAULT 'app.api.v1.core.emails.enums.smtpAccountStatus.active' NOT NULL,
...
CREATE TABLE "email_campaigns" (
	...
	"sent_at" timestamp,
	"status" text DEFAULT 'app.api.v1.core.leads.enums.emailStatus.pending' NOT NULL,
	"email_provider" text DEFAULT 'app.api.v1.core.emails.enums.emailProvider.smtp',
	"external_id" text,
	"smtp_account_id" uuid,
	"opened_at" timestamp,
...
CREATE TABLE "leads" (
	...
	"status" text DEFAULT 'app.api.v1.core.leads.enums.leadStatus.new' NOT NULL,
	"source" text,
	"notes" text,
	...
	"current_campaign_stage" text DEFAULT 'app.api.v1.core.leads.enums.emailCampaignStage.notStarted',
...
CREATE TABLE "csv_import_jobs" (
	...
	"default_status" text DEFAULT 'app.api.v1.core.leads.enums.leadStatus.new' NOT NULL,
	"default_campaign_stage" text DEFAULT 'app.api.v1.core.leads.enums.emailCampaignStage.notStarted' NOT NULL,
	"default_source" text DEFAULT 'app.api.v1.core.leads.enums.leadSource.csvImport' NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.leads.import.enums.csvImportJobStatus.pending' NOT NULL,
	"total_rows" integer,
...
CREATE TABLE "newsletter_subscriptions" (
	...
	"name" text,
	"user_id" uuid,
	"status" text DEFAULT 'app.api.v1.core.newsletter.enum.status.subscribed' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "onboarding_business_data" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" text NOT NULL,
	...
	"competitors" text,
	"brand_guidelines" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "payment_invoices" (
	...
	"amount" numeric(10, 2) NOT NULL,
	"currency" text NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.payment.enums.invoiceStatus.draft' NOT NULL,
	"invoice_url" text,
	"invoice_pdf" text,
	"due_date" timestamp,
	"paid_at" timestamp,
...
CREATE TABLE "payment_refunds" (
	...
	"amount" numeric(10, 2) NOT NULL,
	"currency" text NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.payment.enums.refundStatus.pending' NOT NULL,
	"reason" text,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
...
CREATE TABLE "payment_transactions" (
	...
	"amount" numeric(10, 2) NOT NULL,
	"currency" text NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.payment.enums.paymentStatus.pending' NOT NULL,
	"provider" text DEFAULT 'app.api.v1.core.payment.enums.paymentProvider.stripe' NOT NULL,
	"mode" text DEFAULT 'app.api.v1.core.payment.enums.checkoutMode.payment' NOT NULL,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE "subscriptions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"status" text DEFAULT 'app.api.v1.core.subscription.enums.status.incomplete' NOT NULL,
	"plan_id" text NOT NULL,
	"billing_interval" text DEFAULT 'app.api.v1.core.subscription.enums.billing.monthly' NOT NULL,
...
CREATE TABLE "users" (
	...
	"phone" text,
	"preferred_contact_method" text DEFAULT 'app.api.v1.core.user.contactMethods.email' NOT NULL,
	"image_url" text,
	"bio" text,
	"website" text,
	"job_title" text,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "users_lead_id_unique" UNIQUE("lead_id"),
...
--> statement-breakpoint
ALTER TABLE "email_agent_processing" ADD CONSTRAINT "email_agent_processing_email_id_emails_id_fk" FOREIGN KEY ("email_id") REFERENCES "public"."emails"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "human_confirmation_requests" ADD CONSTRAINT "human_confirmation_requests_email_id_emails_id_fk" FOREIGN KEY ("email_id") REFERENCES "public"."emails"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "human_confirmation_requests" ADD CONSTRAINT "human_confirmation_requests_processing_id_email_agent_processing_id_fk" FOREIGN KEY ("processing_id") REFERENCES "public"."email_agent_processing"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "audience" ADD CONSTRAINT "audience_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "brand" ADD CONSTRAINT "brand_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "business_info" ADD CONSTRAINT "business_info_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "social_platforms" ADD CONSTRAINT "social_platforms_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "email_agent_processing_email_id_idx" ON "email_agent_processing" USING btree ("email_id");--> statement-breakpoint
CREATE INDEX "email_agent_processing_status_idx" ON "email_agent_processing" USING btree ("status");--> statement-breakpoint
CREATE INDEX "email_agent_processing_priority_idx" ON "email_agent_processing" USING btree ("priority");--> statement-breakpoint
CREATE INDEX "email_agent_processing_chain_id_idx" ON "email_agent_processing" USING btree ("chain_id");--> statement-breakpoint
CREATE INDEX "email_agent_processing_bounce_category_idx" ON "email_agent_processing" USING btree ("bounce_category");--> statement-breakpoint
CREATE INDEX "email_agent_processing_spam_detected_idx" ON "email_agent_processing" USING btree ("spam_detected");--> statement-breakpoint
CREATE INDEX "email_agent_processing_last_processed_at_idx" ON "email_agent_processing" USING btree ("last_processed_at");--> statement-breakpoint
CREATE INDEX "email_agent_processing_created_at_idx" ON "email_agent_processing" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_email_id_idx" ON "human_confirmation_requests" USING btree ("email_id");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_processing_id_idx" ON "human_confirmation_requests" USING btree ("processing_id");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_status_idx" ON "human_confirmation_requests" USING btree ("status");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_action_type_idx" ON "human_confirmation_requests" USING btree ("action_type");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_expires_at_idx" ON "human_confirmation_requests" USING btree ("expires_at");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_requested_at_idx" ON "human_confirmation_requests" USING btree ("requested_at");--> statement-breakpoint
CREATE INDEX "human_confirmation_requests_responded_by_idx" ON "human_confirmation_requests" USING btree ("responded_by");--> statement-breakpoint
CREATE INDEX "social_platforms_user_id_idx" ON "social_platforms" USING btree ("user_id");--> statement-breakpoint
