...
CREATE TABLE "chat_threads" (
	...
	"folder_id" uuid,
	"status" text DEFAULT 'app.api.v1.core.agent.chat.enums.threadStatus.active' NOT NULL,
	"default_model" text,
	"default_tone" text,
	"system_prompt" text,
...
CREATE TABLE "payment_webhooks" (
	...
	CONSTRAINT "payment_webhooks_provider_event_id_unique" UNIQUE("provider_event_id")
);
--> statement-breakpoint
...
CREATE INDEX "chat_folders_allowed_roles_idx" ON "chat_folders" USING gin ("allowed_roles");--> statement-breakpoint
