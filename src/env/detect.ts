...
export type VibeServerMode = "atlas-dev" | "hermes-dev" | "hermes-prod" | "mcp";
...
export const vibeServerMode: VibeServerMode = _isMcpCommand
  ? "mcp"
  : _isStartCommand
    ? "hermes-prod"
    : _isHermesDev
...
export const LOG_FILE_BY_MODE: Record<VibeServerMode, string> = {
  "atlas-dev": ".atlas.log",
