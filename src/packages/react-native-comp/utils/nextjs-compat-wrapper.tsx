 ...
 * import { createPageWrapper } from "@/packages/react-native-comp/utils/nextjs-compat-wrapper";
 * import PageComponent from "./page";
 * export default createPageWrapper(PageComponent);
 *
 * // For layouts (Slot-based, no custom UI)
 * import { createLayoutWrapper } from "@/packages/react-native-comp/utils/nextjs-compat-wrapper";
