...
const StyledAnimatedView = Animated.View as React.ComponentType<
  React.ComponentProps<typeof Animated.View> & { className?: string }
>;
const StyledText = RNText as React.ComponentType<
  React.ComponentProps<typeof RNText> & { className?: string }
>;
const StyledPressable = Pressable as React.ComponentType<
  React.ComponentProps<typeof Pressable> & { className?: string }
>;
const StyledView = View as React.ComponentType<
...
export function ToastTitle({
  ...
  return (
    <StyledText className={cn("font-semibold text-foreground", className)}>
      {children}
    </StyledText>
  );
}
...
export function ToastDescription({
  ...
  return (
    <StyledText className={cn("text-sm text-muted-foreground mt-1", className)}>
      {children}
    </StyledText>
  );
}
...
export function ToastClose({
  ...
  return (
    ...
    >
      <StyledText className="text-foreground">✕</StyledText>
    </StyledPressable>
  );
}
...
export function ToastAction({
  ...
  return (
    <StyledPressable
      ...
      accessibilityRole="button"
    >
      <StyledText className="text-primary-foreground text-sm font-medium">
        {children}
      </StyledText>
    </StyledPressable>
  );
