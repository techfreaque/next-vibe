  ...
  fields: customWidgetObject({
    ...
    children: {
      ...
      referralCode: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "get.response.referralCode" as const,
        schema: z.string().nullable(),
      }),
      appName: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "get.response.appName" as const,
        schema: z.string(),
      }),
      leadMagnetHeadline: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "get.response.leadMagnetHeadline" as const,
        schema: z.string().nullable(),
      }),
      leadMagnetButtonText: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "get.response.leadMagnetButtonText" as const,
        schema: z.string().nullable(),
      }),
