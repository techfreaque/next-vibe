...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: {
        label: "Nutzer mit Marketing-Einwilligung",
        description: "Ausgabe-Zeitreihe",
      },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "Nutzer mit Marketing-Einwilligung Daten",
      description: "Nutzer mit Marketing-Einwilligung Zeitreihe zurückgegeben",
    },
    errors: {
      unauthorized: {
