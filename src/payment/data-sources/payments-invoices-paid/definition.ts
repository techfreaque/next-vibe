/**
 * Invoices Paid - Endpoint Definition
...
import { PAYMENTS_INVOICES_PAID_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const PaymentsInvoicesPaidWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.PaymentsInvoicesPaidWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [PAYMENTS_INVOICES_PAID_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: PaymentsInvoicesPaidWidget,
    noFormElement: true,
