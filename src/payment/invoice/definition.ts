      ...
      invoice: objectField(scopedTranslation, {
        ...
        children: {
          ...
          userId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.userId" as const,
            schema: z.uuid(),
          }),
          stripeInvoiceId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.stripeInvoiceId" as const,
            schema: z.string(),
          }),
          invoiceNumber: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.invoiceNumber" as const,
            schema: z.string(),
          }),
          ...
          invoiceUrl: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.invoiceUrl" as const,
            schema: z.string().url(),
          }),
          invoicePdf: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.invoicePdf" as const,
            schema: z.string().url(),
          }),
          ...
          paidAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.invoice.paidAt" as const,
