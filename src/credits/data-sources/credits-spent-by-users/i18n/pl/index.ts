...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: {
        label: "Kredyty wydane przez użytkowników",
        description: "Wyjściowa seria czasowa",
      },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Kredyty wydane przez użytkowników obliczone",
      description: "Seria kredytów wydanych przez użytkowników zwrócona",
    },
    errors: {
      unauthorized: {
