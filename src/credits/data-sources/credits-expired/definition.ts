/**
 * Credits Expired - Endpoint Definition
...
import { CREDITS_EXPIRED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsExpiredWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsExpiredWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_EXPIRED_ALIAS],
  method: Methods.POST,
