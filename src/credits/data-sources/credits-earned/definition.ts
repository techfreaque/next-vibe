/**
 * Credits Earned - Endpoint Definition
...
import { CREDITS_EARNED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsEarnedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsEarnedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_EARNED_ALIAS],
  method: Methods.POST,
