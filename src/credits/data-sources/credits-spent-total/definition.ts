/**
 * Credits Spent Total - Endpoint Definition
...
import { CREDITS_SPENT_TOTAL_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsSpentTotalWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsSpentTotalWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_SPENT_TOTAL_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsSpentTotalWidget,
    noFormElement: true,
