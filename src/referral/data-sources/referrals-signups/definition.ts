/**
 * Referral Signups - Endpoint Definition
...
import { REFERRALS_SIGNUPS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const ReferralsSignupsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ReferralsSignupsWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [REFERRALS_SIGNUPS_ALIAS],
  method: Methods.POST,
