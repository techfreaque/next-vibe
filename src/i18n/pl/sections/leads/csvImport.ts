import type { csvImportTranslations as EnglishCsvImportTranslations } from "../../../en/sections/leads/csvImport";

export const csvImportTranslations: typeof EnglishCsvImportTranslations = {
  exampleData: {
