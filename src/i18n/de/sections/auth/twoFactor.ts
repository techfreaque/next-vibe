import type { twoFactorTranslations as EnglishTwoFactorTranslations } from "../../../en/sections/auth/twoFactor";

export const twoFactorTranslations: typeof EnglishTwoFactorTranslations = {
