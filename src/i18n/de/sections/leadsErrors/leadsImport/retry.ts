import type { retryTranslations as EnglishRetryTranslations } from "../../../../en/sections/leadsErrors/leadsImport/retry";

export const retryTranslations: typeof EnglishRetryTranslations = {
  success: {
