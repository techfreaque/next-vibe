import type { manageTranslations as EnglishManageTranslations } from "../../../../en/sections/leadsErrors/campaigns/manage";

export const manageTranslations: typeof EnglishManageTranslations = {
  error: {
    validation: {
