import type { groupedTranslations as EnglishGroupedTranslations } from "../../../../../en/sections/leads/admin/stats/grouped";

export const groupedTranslations: typeof EnglishGroupedTranslations = {
