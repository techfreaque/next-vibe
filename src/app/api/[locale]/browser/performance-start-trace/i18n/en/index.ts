export const translations = {
  ...
  description: "Starts a performance trace recording on the selected page to analyze performance metrics and core web vitals",
  form: {
  ...
  errors: {
    ...
    network: { title: "Network Error", description: "A network error occurred while starting the performance trace" },
    unauthorized: { title: "Unauthorized", description: "You are not authorized to start performance traces" },
    forbidden: { title: "Forbidden", description: "Starting performance traces is forbidden" },
    notFound: { title: "Not Found", description: "The requested resource was not found" },
    serverError: { title: "Server Error", description: "An internal server error occurred while starting the performance trace" },
    unknown: { title: "Unknown Error", description: "An unknown error occurred while starting the performance trace" },
    unsavedChanges: { title: "Unsaved Changes", description: "You have unsaved changes that may be lost" },
    conflict: { title: "Conflict", description: "A conflict occurred while starting the performance trace" },
  },
  success: {
