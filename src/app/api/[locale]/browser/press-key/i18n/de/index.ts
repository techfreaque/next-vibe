...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: {
      ...
      description: "Ein Netzwerkfehler ist während des Tastendrucks aufgetreten",
    },
    unauthorized: {
    ...
    serverError: {
      title: "Serverfehler",
      description: "Ein interner Serverfehler ist während des Tastendrucks aufgetreten",
    },
    unknown: {
      title: "Unbekannter Fehler",
      description: "Ein unbekannter Fehler ist während des Tastendrucks aufgetreten",
    },
    unsavedChanges: {
