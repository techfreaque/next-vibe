...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: {
      title: "Błąd sieci",
      description: "Wystąpił błąd sieci podczas operacji naciśnięcia klawisza",
    },
    unauthorized: {
    ...
    forbidden: {
      title: "Zabronione",
      description: "Operacja naciśnięcia klawisza jest zabroniona",
    },
    notFound: {
    ...
    conflict: {
      title: "Konflikt",
      description: "Wystąpił konflikt podczas operacji naciśnięcia klawisza",
    },
  },
  success: {
