...
export const translations: typeof enTranslations = {
  ...
  form: {
    ...
    fields: {
      includePreservedRequests: {
        ...
        description: "Auf true setzen, um die bewahrten Anfragen der letzten 3 Navigationen zurückzugeben",
        placeholder: "false",
      },
      pageIdx: {
        label: "Seitenindex",
      ...
      resourceTypes: {
        ...
        description: "Anfragen filtern, um nur Anfragen der angegebenen Ressourcentypen zurückzugeben (weglassen für alle)",
  ...
  errors: {
    ...
    network: { title: "Netzwerkfehler", description: "Ein Netzwerkfehler ist beim Auflisten der Netzwerk-Anfragen aufgetreten" },
    unauthorized: { title: "Nicht autorisiert", description: "Sie sind nicht berechtigt, Netzwerk-Anfragen aufzulisten" },
    forbidden: { title: "Verboten", description: "Auflisten von Netzwerk-Anfragen ist verboten" },
    notFound: { title: "Nicht gefunden", description: "Die angeforderte Ressource wurde nicht gefunden" },
    serverError: { title: "Serverfehler", description: "Ein interner Serverfehler ist beim Auflisten der Netzwerk-Anfragen aufgetreten" },
    unknown: { title: "Unbekannter Fehler", description: "Ein unbekannter Fehler ist beim Auflisten der Netzwerk-Anfragen aufgetreten" },
    ...
    conflict: { title: "Konflikt", description: "Ein Konflikt ist beim Auflisten der Netzwerk-Anfragen aufgetreten" },
  },
  success: {
