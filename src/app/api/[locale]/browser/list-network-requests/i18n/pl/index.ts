...
export const translations: typeof enTranslations = {
  ...
  form: {
    ...
    fields: {
      ...
      resourceTypes: {
        label: "Typy zasobów",
        description: "Filtruj żądania, aby zwracać tylko żądania określonych typów zasobów (pomiń dla wszystkich)",
  ...
  errors: {
    ...
    network: { title: "Błąd sieci", description: "Wystąpił błąd sieci podczas listowania żądań sieciowych" },
    unauthorized: { title: "Nieautoryzowany", description: "Nie masz uprawnień do listowania żądań sieciowych" },
    forbidden: { title: "Zabronione", description: "Listowanie żądań sieciowych jest zabronione" },
    notFound: { title: "Nie znaleziono", description: "Żądany zasób nie został znaleziony" },
    serverError: { title: "Błąd serwera", description: "Wystąpił wewnętrzny błąd serwera podczas listowania żądań sieciowych" },
    unknown: { title: "Nieznany błąd", description: "Wystąpił nieznany błąd podczas listowania żądań sieciowych" },
    unsavedChanges: { title: "Niezapisane zmiany", description: "Masz niezapisane zmiany, które mogą zostać utracone" },
    conflict: { title: "Konflikt", description: "Wystąpił konflikt podczas listowania żądań sieciowych" },
  },
  success: {
