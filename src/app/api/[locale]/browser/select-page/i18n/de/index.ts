...
export const translations: typeof enTranslations = {
  ...
  form: {
    ...
    fields: {
      pageIdx: {
        label: "Seitenindex",
        description: "Der Index der auszuwählenden Seite (list_pages aufrufen um Seiten aufzulisten)",
  ...
  errors: {
    ...
    network: { title: "Netzwerkfehler", description: "Ein Netzwerkfehler ist beim Auswählen der Seite aufgetreten" },
    unauthorized: { title: "Nicht autorisiert", description: "Sie sind nicht berechtigt, Seiten auszuwählen" },
    ...
    serverError: { title: "Serverfehler", description: "Ein interner Serverfehler ist beim Auswählen der Seite aufgetreten" },
    unknown: { title: "Unbekannter Fehler", description: "Ein unbekannter Fehler ist beim Auswählen der Seite aufgetreten" },
    ...
    conflict: { title: "Konflikt", description: "Ein Konflikt ist beim Auswählen der Seite aufgetreten" },
  },
  success: {
