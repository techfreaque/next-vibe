...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: {
      title: "Błąd sieci",
      description: "Wystąpił błąd sieci podczas wybierania strony",
    },
    unauthorized: {
      title: "Nieautoryzowany",
      description: "Nie masz uprawnień do wybierania stron",
    },
    forbidden: {
      title: "Zabronione",
    ...
    serverError: {
      title: "Błąd serwera",
      description: "Wystąpił wewnętrzny błąd serwera podczas wybierania strony",
    },
    unknown: {
      title: "Nieznany błąd",
      description: "Wystąpił nieznany błąd podczas wybierania strony",
    },
    unsavedChanges: {
    ...
    conflict: {
      title: "Konflikt",
      description: "Wystąpił konflikt podczas wybierania strony",
    },
  },
  success: {
