export const translations = {
  ...
  errors: {
    ...
    network: { title: "Network Error", description: "A network error occurred while retrieving the console message" },
    unauthorized: { title: "Unauthorized", description: "You are not authorized to retrieve console messages" },
    forbidden: { title: "Forbidden", description: "Console message retrieval operation is forbidden" },
    notFound: { title: "Not Found", description: "The requested resource was not found" },
    serverError: { title: "Server Error", description: "An internal server error occurred while retrieving the console message" },
    unknown: { title: "Unknown Error", description: "An unknown error occurred while retrieving the console message" },
    unsavedChanges: { title: "Unsaved Changes", description: "You have unsaved changes that may be lost" },
    conflict: { title: "Conflict", description: "A conflict occurred while retrieving the console message" },
  },
  success: {
