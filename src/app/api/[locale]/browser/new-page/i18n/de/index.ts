...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: {
      ...
      description: "Ein Netzwerkfehler ist beim Erstellen der neuen Seite aufgetreten",
    },
    unauthorized: {
    ...
    serverError: {
      title: "Serverfehler",
      description: "Ein interner Serverfehler ist beim Erstellen der neuen Seite aufgetreten",
    },
    unknown: {
      title: "Unbekannter Fehler",
      description: "Ein unbekannter Fehler ist beim Erstellen der neuen Seite aufgetreten",
    },
    unsavedChanges: {
    ...
    conflict: {
      title: "Konflikt",
      description: "Ein Konflikt ist beim Erstellen der neuen Seite aufgetreten",
    },
  },
  success: {
