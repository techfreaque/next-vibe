...
export const translations: typeof enTranslations = {
  ...
  form: {
    ...
    fields: {
      uid: {
        label: "Element-UID",
        description: "Die UID des Dateiauswahl-Elements oder eines Elements, das den Dateiwähler öffnet",
  ...
  errors: {
    ...
    network: { title: "Netzwerkfehler", description: "Ein Netzwerkfehler ist während des Datei-Uploads aufgetreten" },
    unauthorized: { title: "Nicht autorisiert", description: "Sie sind nicht berechtigt, Datei-Uploads durchzuführen" },
    ...
    serverError: { title: "Serverfehler", description: "Ein interner Serverfehler ist während des Datei-Uploads aufgetreten" },
    unknown: { title: "Unbekannter Fehler", description: "Ein unbekannter Fehler ist während des Datei-Uploads aufgetreten" },
    ...
    conflict: { title: "Konflikt", description: "Ein Konflikt ist während des Datei-Uploads aufgetreten" },
  },
  success: {
