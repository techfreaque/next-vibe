export const translations = {
  ...
  errors: {
    ...
    network: { title: "Network Error", description: "A network error occurred during navigation" },
    unauthorized: { title: "Unauthorized", description: "You are not authorized to navigate pages" },
    forbidden: { title: "Forbidden", description: "Page navigation operation is forbidden" },
    notFound: { title: "Not Found", description: "The requested resource was not found" },
    serverError: { title: "Server Error", description: "An internal server error occurred during navigation" },
    unknown: { title: "Unknown Error", description: "An unknown error occurred during navigation" },
    unsavedChanges: { title: "Unsaved Changes", description: "You have unsaved changes that may be lost" },
    conflict: { title: "Conflict", description: "A conflict occurred during navigation" },
  },
  success: {
