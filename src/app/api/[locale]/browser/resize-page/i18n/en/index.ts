export const translations = {
  ...
  errors: {
    ...
    network: { title: "Network Error", description: "A network error occurred while resizing the page" },
    unauthorized: { title: "Unauthorized", description: "You are not authorized to resize pages" },
    forbidden: { title: "Forbidden", description: "Page resize operation is forbidden" },
    notFound: { title: "Not Found", description: "The requested resource was not found" },
    serverError: { title: "Server Error", description: "An internal server error occurred while resizing the page" },
    unknown: { title: "Unknown Error", description: "An unknown error occurred while resizing the page" },
    unsavedChanges: { title: "Unsaved Changes", description: "You have unsaved changes that may be lost" },
    conflict: { title: "Conflict", description: "A conflict occurred while resizing the page" },
  },
  success: {
