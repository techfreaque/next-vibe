...
export const translations: typeof enTranslations = {
  ...
  description:
    "Zatrzymuje aktywne nagrywanie trace wydajności na wybranej stronie i zwraca metryki wydajności",
  form: {
  ...
  errors: {
    ...
    network: {
      title: "Błąd sieci",
      description: "Wystąpił błąd sieci podczas zatrzymywania trace wydajności",
    },
    unauthorized: {
      title: "Nieautoryzowany",
      description: "Nie masz uprawnień do zatrzymywania trace wydajności",
    },
    forbidden: {
      title: "Zabronione",
      description: "Zatrzymywanie trace wydajności jest zabronione",
    },
    notFound: {
    ...
    conflict: {
      title: "Konflikt",
      description: "Wystąpił konflikt podczas zatrzymywania trace wydajności",
    },
  },
  success: {
