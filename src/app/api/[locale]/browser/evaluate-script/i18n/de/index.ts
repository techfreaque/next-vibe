...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: { title: "Netzwerkfehler", description: "Ein Netzwerkfehler ist während der Skript-Auswertung aufgetreten" },
    unauthorized: { title: "Nicht autorisiert", description: "Sie sind nicht berechtigt, Skripte auszuwerten" },
    forbidden: { title: "Verboten", description: "Skript-Auswertung ist verboten" },
    notFound: { title: "Nicht gefunden", description: "Die angeforderte Ressource wurde nicht gefunden" },
    serverError: { title: "Serverfehler", description: "Ein interner Serverfehler ist während der Skript-Auswertung aufgetreten" },
    unknown: { title: "Unbekannter Fehler", description: "Ein unbekannter Fehler ist während der Skript-Auswertung aufgetreten" },
    ...
    conflict: { title: "Konflikt", description: "Ein Konflikt ist während der Skript-Auswertung aufgetreten" },
  },
  success: {
