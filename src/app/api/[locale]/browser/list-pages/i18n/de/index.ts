...
export const translations: typeof enTranslations = {
  ...
  response: {
    ...
    result: "Ergebnis der Seitenauflistung",
    error: "Fehlermeldung",
  ...
  errors: {
    ...
    network: { title: "Netzwerkfehler", description: "Ein Netzwerkfehler ist beim Auflisten der Seiten aufgetreten" },
    unauthorized: { title: "Nicht autorisiert", description: "Sie sind nicht berechtigt, Seiten aufzulisten" },
    forbidden: { title: "Verboten", description: "Seitenauflistung ist verboten" },
    notFound: { title: "Nicht gefunden", description: "Die angeforderte Ressource wurde nicht gefunden" },
    serverError: { title: "Serverfehler", description: "Ein interner Serverfehler ist beim Auflisten der Seiten aufgetreten" },
    unknown: { title: "Unbekannter Fehler", description: "Ein unbekannter Fehler ist beim Auflisten der Seiten aufgetreten" },
    ...
    conflict: { title: "Konflikt", description: "Ein Konflikt ist beim Auflisten der Seiten aufgetreten" },
  },
  success: {
