...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    network: {
      ...
      description: "Ein Netzwerkfehler ist während des Ziehvorgangs aufgetreten",
    },
    unauthorized: {
    ...
    serverError: {
      title: "Serverfehler",
      description: "Ein interner Serverfehler ist während des Ziehvorgangs aufgetreten",
    },
    unknown: {
      title: "Unbekannter Fehler",
      description: "Ein unbekannter Fehler ist während des Ziehvorgangs aufgetreten",
    },
    unsavedChanges: {
