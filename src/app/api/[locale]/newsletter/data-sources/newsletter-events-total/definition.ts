/**
 * Newsletter Events Total - Endpoint Definition
...
import { NEWSLETTER_EVENTS_TOTAL_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const NewsletterEventsTotalWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.NewsletterEventsTotalWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [NEWSLETTER_EVENTS_TOTAL_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: NewsletterEventsTotalWidget,
    noFormElement: true,
