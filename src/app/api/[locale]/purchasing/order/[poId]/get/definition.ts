      ...
      result: objectField(scopedTranslation, {
        ...
        children: {
          id: responseField(scopedTranslation, {
            ...
            label: "orderGet.get.response.id" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          companyId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.companyId" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          vendorId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.vendorId" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          poNumber: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.poNumber" as const,
            schema: z.string(),
          }),
          status: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.status" as const,
            schema: z.string(),
          }),
          currency: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.currency" as const,
            schema: z.string(),
          }),
          expectedDeliveryDate: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.expectedDeliveryDate" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date().nullable(),
          }),
          deliveryWarehouseId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.deliveryWarehouseId" as const,
            hidden: true,
            schema: z.uuid().nullable(),
          }),
          notes: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.notes" as const,
            schema: z.string().nullable(),
          }),
          subtotal: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.subtotal" as const,
            fieldType: FieldDataType.NUMBER,
            schema: z.number(),
          }),
          taxAmount: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.taxAmount" as const,
            fieldType: FieldDataType.NUMBER,
            schema: z.number(),
          }),
          total: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.total" as const,
            fieldType: FieldDataType.NUMBER,
            schema: z.number(),
          }),
          billId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.billId" as const,
            hidden: true,
            schema: z.uuid().nullable(),
          }),
          confirmedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.confirmedAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date().nullable(),
          }),
          receivedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.receivedAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date().nullable(),
          }),
          createdAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.createdAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
          updatedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.updatedAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
          lines: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.lines" as const,
            schema: z.array(poLineSchema),
          }),
          receipts: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "orderGet.get.response.receipts" as const,
