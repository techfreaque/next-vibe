...
import listDef0 from "@/app/api/[locale]/purchasing/vendor/list/definition";
      ...
      result: objectField(scopedTranslation, {
        ...
        children: {
          id: responseField(scopedTranslation, {
            ...
            content: "vendorGet.get.response.id" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          companyId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.companyId" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          name: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.name" as const,
            schema: z.string(),
          }),
          code: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.code" as const,
            schema: z.string().nullable(),
          }),
          email: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.email" as const,
            schema: z.string().nullable(),
          }),
          phone: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.phone" as const,
            schema: z.string().nullable(),
          }),
          website: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.website" as const,
            schema: z.string().nullable(),
          }),
          vatNumber: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.vatNumber" as const,
            schema: z.string().nullable(),
          }),
          taxId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.taxId" as const,
            schema: z.string().nullable(),
          }),
          addressLine1: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.addressLine1" as const,
            schema: z.string().nullable(),
          }),
          addressLine2: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.addressLine2" as const,
            schema: z.string().nullable(),
          }),
          city: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.city" as const,
            schema: z.string().nullable(),
          }),
          region: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.region" as const,
            schema: z.string().nullable(),
          }),
          postalCode: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.postalCode" as const,
            schema: z.string().nullable(),
          }),
          country: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.country" as const,
            schema: z.string().nullable(),
          }),
          defaultCurrency: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.defaultCurrency" as const,
            schema: z.string(),
          }),
          defaultPaymentTermsDays: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.defaultPaymentTermsDays" as const,
            schema: z.number().nullable(),
          }),
          isActive: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.isActive" as const,
            schema: z.boolean(),
          }),
          notes: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.notes" as const,
            schema: z.string().nullable(),
          }),
          createdAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.createdAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
          updatedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "vendorGet.get.response.updatedAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
        },
