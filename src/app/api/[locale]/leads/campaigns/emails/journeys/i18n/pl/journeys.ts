export const journeysTranslations = {
  ...
  sideHustle: {
    ...
    reactivation: {
      ...
      previewText: "aktualizacja unbottled.ai + nadal mój link afiliacyjny",
      greeting: "Hej,",
      update:
  ...
  quietRecommendation: {
    ...
    followup1: {
      ...
      previewText: "trzy tygodnie prawdziwego użycia, nie pitch sprzedażowy",
      greeting: "Cześć,",
      specificThing:
    ...
    followup3: {
      ...
      stayInTouch: "Jeśli to nie jest istotne dla twojej pracy, żaden problem.",
      ctaText: "unbottled.ai",
      signature: " -  Sam",
    },
    nurture: {
  ...
  retention: {
    initial: {
      ...
      valueSummary:
        "Jako subskrybent masz priorytetowy dostęp do wszystkich {{modelCount}} modeli, wyższe limity użytkowania i pierwszeństwo dostępu do nowych funkcji.",
      whatIsNext:
