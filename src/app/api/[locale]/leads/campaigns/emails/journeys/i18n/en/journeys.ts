export const journeysTranslations = {
  uncensoredConvert: {
    initial: {
      ...
      previewText: "not sure why I'm even telling you this but here we go",
      greeting: "Hey,",
      opening:
  ...
  sideHustle: {
    initial: {
      subject: "I'm an affiliate for this. Here's why I think it matters.",
      previewText: "transparent from the start - I get a cut if you sign up",
      greeting: "Hey,",
      opening:
      ...
      signature: " -  Jordan",
      postScript: "P.S. Free trial available. No credit card needed to start.",
    },
    followup1: {
    ...
    followup2: {
      ...
      previewText: "how passive income from a tool you use actually works",
      greeting: "Hey,",
      anotherUseCase:
  ...
  quietRecommendation: {
    ...
    followup3: {
      ...
      stayInTouch: "If this isn't relevant to your work, no worries at all.",
      ctaText: "unbottled.ai",
      signature: " -  Sam",
    },
    nurture: {
  ...
  signupNurture: {
    ...
    followup1: {
      ...
      previewText: "quick tips from our most active users",
      greeting: "Hey,",
      checkIn:
        "Just checking in. Hope you've had a chance to explore. Here are 3 things our most active users do in their first week:",
      exploreModels:
    ...
    followup2: {
      ...
      previewText: "you control what the AI can and can't do",
      greeting: "Hey,",
      preferences:
    ...
    nurture: {
      ...
      previewText: "we added some worth trying",
      greeting: "Hey,",
      newModels:
  ...
  retention: {
    ...
    followup1: {
      ...
      previewText: "just added last week",
      greeting: "Hey,",
      newFeature:
    ...
    followup2: {
      ...
      previewText: "quick tip to go further",
      greeting: "Hey,",
      milestone:
    ...
    followup3: {
      ...
      previewText: "we actually read these",
      greeting: "Hey,",
      roadmap:
    ...
    nurture: {
      ...
      previewText: "thank you for sticking around",
      greeting: "Hey,",
      appreciation:
  ...
  winback: {
    ...
    followup1: {
      ...
      previewText: "a few things worth knowing",
      greeting: "Hey,",
      improvements:
        "Since you canceled, we've shipped several significant improvements that may address what wasn't working for you.",
      specificChange:
    ...
    followup2: {
      ...
      previewText: "30% off your first month back",
      greeting: "Hey,",
      specialOffer:
    ...
    followup3: {
      ...
      previewText: "we'll leave you alone after this",
      greeting: "Hey,",
      lastAttempt:
    ...
    nurture: {
      ...
      previewText: "we've come a long way",
      greeting: "Hey,",
      majorUpdate:
