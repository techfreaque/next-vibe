export const translations = {
  ...
  widget: {
    ...
    successTitle: "Configuration saved successfully",
    successDescription:
      "The campaign starter will apply these settings on the next scheduled run.",
    savedSettings: "Saved Settings",
    scheduleCron: "Schedule (cron)",
    enabled: "Enabled",
    dryRun: "Dry Run",
    minLeadAge: "Min Lead Age",
    ...
    yes: "Yes",
    no: "No",
    yesNoEmailsSent: "Yes (no emails sent)",
    dayMon: "Mon",
    dayTue: "Tue",
    dayWed: "Wed",
    dayThu: "Thu",
