/**
 * Bounce Processor Configuration API Route Definition
 * GET/PUT endpoints for managing the bounce processor cron task
 */
...
/**
 * GET — Retrieve current bounce processor config
 */
const { GET } = createEndpoint({
  scopedTranslation,
  method: Methods.GET,
  path: ["leads", "campaigns", "bounce-processor", "bounce-processor-config"],
...
/**
 * PUT — Update bounce processor config
 */
...
export type BounceProcessorConfigPutRequestOutput =
  typeof PUT.types.RequestOutput;
export type BounceProcessorConfigPutResponseOutput =
  typeof PUT.types.ResponseOutput;

// oxlint-disable-next-line no-unused-vars
const _requestResponseMatchCheck: BounceProcessorConfigGetResponseOutput =
  {} as BounceProcessorConfigPutRequestOutput;
