/**
 * Leads Form Submits - Endpoint Definition
...
import { LEADS_FORM_SUBMITS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsFormSubmitsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsFormSubmitsWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_FORM_SUBMITS_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsFormSubmitsWidget,
    noFormElement: true,
