/**
 * Leads Email Opens - Endpoint Definition
...
import { LEADS_EMAIL_OPENS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsEmailOpensWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsEmailOpensWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_EMAIL_OPENS_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsEmailOpensWidget,
    noFormElement: true,
