/**
 * Leads Unsubscribed - Endpoint Definition
...
import { LEADS_UNSUBSCRIBED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsUnsubscribedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsUnsubscribedWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_UNSUBSCRIBED_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsUnsubscribedWidget,
    noFormElement: true,
