/**
 * Leads Created - Endpoint Definition
...
import { LEADS_CREATED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsCreatedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsCreatedWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_CREATED_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsCreatedWidget,
    noFormElement: true,
