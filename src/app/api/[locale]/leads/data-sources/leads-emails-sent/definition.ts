/**
 * Leads Emails Sent - Endpoint Definition
...
import { LEADS_EMAILS_SENT_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsEmailsSentWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsEmailsSentWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_EMAILS_SENT_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsEmailsSentWidget,
    noFormElement: true,
