/**
 * Leads Newsletter Subscribers - Endpoint Definition
...
import { LEADS_NEWSLETTER_SUBSCRIBERS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsNewsletterSubscribersWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.LeadsNewsletterSubscribersWidget,
  })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_NEWSLETTER_SUBSCRIBERS_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsNewsletterSubscribersWidget,
    noFormElement: true,
