/**
 * Leads Engagements - Endpoint Definition
...
const LeadsEngagementsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsEngagementsWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_ENGAGEMENTS_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsEngagementsWidget,
    noFormElement: true,
