/**
 * Leads Active - Endpoint Definition
...
import { LEADS_ACTIVE_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsActiveWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsActiveWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_ACTIVE_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsActiveWidget,
    noFormElement: true,
