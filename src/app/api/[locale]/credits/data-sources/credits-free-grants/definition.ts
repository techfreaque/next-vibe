/**
 * Credits Free Grants - Endpoint Definition
...
import { CREDITS_FREE_GRANTS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const CreditsFreeGrantsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsFreeGrantsWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_FREE_GRANTS_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsFreeGrantsWidget,
    noFormElement: true,
