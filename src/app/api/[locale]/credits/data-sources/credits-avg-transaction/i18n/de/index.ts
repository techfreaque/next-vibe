...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: {
        label: "Durchschnittliche Kredit-Transaktion",
        description: "Ausgabe-Zeitreihe",
      },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "Durchschnittliche Kredit-Transaktion berechnet",
      description: "Durchschnittliche Kredit-Transaktion-Reihe zurückgegeben",
    },
    errors: {
      unauthorized: {
