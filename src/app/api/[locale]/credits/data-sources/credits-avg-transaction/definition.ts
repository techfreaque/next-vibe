/**
 * Credits Avg Transaction - Endpoint Definition
...
import { CREDITS_AVG_TRANSACTION_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const CreditsAvgTransactionWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsAvgTransactionWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_AVG_TRANSACTION_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsAvgTransactionWidget,
    noFormElement: true,
