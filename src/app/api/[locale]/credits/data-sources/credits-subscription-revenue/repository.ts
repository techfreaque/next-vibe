/**
 * Credits Subscription Revenue — Repository
...
export class QueryCreditsSubscriptionRevenueRepository {
  static async queryCreditsSubscriptionRevenue(data: {
  ...
  > {
    ...
    const rows = await db
      ...
      .where(
        and(
          eq(creditTransactions.type, CreditTransactionType.SUBSCRIPTION),
