/**
 * Credits Spent By Leads - Endpoint Definition
...
import { CREDITS_SPENT_BY_LEADS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsSpentByLeadsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsSpentByLeadsWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_SPENT_BY_LEADS_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsSpentByLeadsWidget,
    noFormElement: true,
