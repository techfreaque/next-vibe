/**
 * Credits Usage With Feature - Endpoint Definition
...
import { CREDITS_USAGE_WITH_FEATURE_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsUsageWithFeatureWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.CreditsUsageWithFeatureWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_USAGE_WITH_FEATURE_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsUsageWithFeatureWidget,
    noFormElement: true,
