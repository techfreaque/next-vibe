/**
 * Credits Transfer Volume - Endpoint Definition
...
import { CREDITS_TRANSFER_VOLUME_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const CreditsTransferVolumeWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsTransferVolumeWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_TRANSFER_VOLUME_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsTransferVolumeWidget,
    noFormElement: true,
