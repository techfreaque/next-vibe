...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Transfervolumen", description: "Ausgabe-Zeitreihe" },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "Credits Transfervolumen berechnet",
      description: "Credits Transfervolumen-Reihe zurückgegeben",
    },
    errors: {
      unauthorized: {
