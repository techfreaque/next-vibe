/**
 * Credits Transactions Count - Endpoint Definition
...
import { CREDITS_TRANSACTIONS_COUNT_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const CreditsTransactionsCountWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.CreditsTransactionsCountWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_TRANSACTIONS_COUNT_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsTransactionsCountWidget,
    noFormElement: true,
