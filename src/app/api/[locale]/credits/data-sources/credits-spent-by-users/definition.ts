/**
 * Credits Spent By Users - Endpoint Definition
...
import { CREDITS_SPENT_BY_USERS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const CreditsSpentByUsersWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.CreditsSpentByUsersWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CREDITS_SPENT_BY_USERS_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: CreditsSpentByUsersWidget,
    noFormElement: true,
