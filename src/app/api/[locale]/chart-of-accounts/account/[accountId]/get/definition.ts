      ...
      result: objectField(scopedTranslation, {
        ...
        children: {
          id: responseField(scopedTranslation, {
            ...
            content: "accountGet.response.id",
            hidden: true,
            schema: z.string().uuid(),
          }),
          companyId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.companyId",
            schema: z.string().uuid(),
          }),
          code: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.code",
            schema: z.string(),
          }),
          name: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.name",
            schema: z.string(),
          }),
          type: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.type",
            schema: z.string(),
          }),
          subtype: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.subtype",
            schema: z.string(),
          }),
          parentId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.parentId",
            schema: z.string().uuid().nullable(),
          }),
          isPostable: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.isPostable",
            schema: z.boolean(),
          }),
          isActive: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.isActive",
            schema: z.boolean(),
          }),
          isSystem: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.isSystem",
            schema: z.boolean(),
          }),
          description: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.description",
            schema: z.string().nullable(),
          }),
          sortOrder: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "accountGet.response.sortOrder",
            schema: z.number(),
          }),
        },
      }),
