...
const templateLoaders: Record<string, () => Promise<EmailTemplateDefinitionAny>> = {
  ...
  "corvina-purchase-inquiry": async () =>
    (
      await import("@/app/api/[locale]/corvina/device-licenses/purchase-inquiry/email")
    )["purchaseInquiryEmailTemplate"] as EmailTemplateDefinitionAny,
  "corvina-subscription-reminder": async () =>
    (
      await import("@/app/api/[locale]/corvina/device-licenses/subscription-reminder/email")
    )["subscriptionReminderEmailTemplate"] as EmailTemplateDefinitionAny,
...
> = {
  ...
  "corvina-purchase-inquiry": {
    id: "corvina-purchase-inquiry",
    version: "1.0.0",
    name: "post.title",
    description: "post.description",
    category: "category",
    path: "src/app/api/[locale]/corvina/device-licenses/purchase-inquiry/email.tsx",
    exampleProps: {
  ...
  "corvina-subscription-reminder": {
    id: "corvina-subscription-reminder",
    version: "1.0.0",
    name: "post.title",
    description: "post.description",
    category: "category",
    path: "src/app/api/[locale]/corvina/device-licenses/subscription-reminder/email.tsx",
    exampleProps: {
      logicalId: "device-abc-123",
      orgResourceId: "org-xyz-456",
      expiryDate: 1781481600000,
      daysUntilExpiry: 12,
      isAdmin: false,
    },
  },
