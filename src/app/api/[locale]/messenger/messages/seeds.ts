...
export async function dev(
  ...
  try {
    ...
    const emails = [
      createEmailSeed({
        messageId: `welcome-001@${translations.appName}`,
      ...
      createEmailSeed({
        messageId: `notification-002@${translations.appName}`,
      ...
      createEmailSeed({
        messageId: `support-003@${translations.appName}`,
      ...
      createEmailSeed({
        messageId: `newsletter-004@${translations.appName}`,
