/**
 * Messenger Opened - Endpoint Definition
...
import { MESSENGER_OPENED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const MessengerOpenedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.MessengerOpenedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [MESSENGER_OPENED_ALIAS],
  method: Methods.POST,
