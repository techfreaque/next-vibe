/**
 * Messenger Bounced - Endpoint Definition
...
import { MESSENGER_BOUNCED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const MessengerBouncedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.MessengerBouncedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [MESSENGER_BOUNCED_ALIAS],
  method: Methods.POST,
