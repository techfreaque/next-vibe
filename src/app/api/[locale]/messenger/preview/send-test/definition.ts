...
const EmailPreviewSendTestContainer = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.EmailPreviewSendTestContainer,
  })),
);
...
const { POST } = createEndpoint({
  ...
  titleShort: "preview.sendTest.post.titleShort" as const,
  ...
  fields: customWidgetObject({
    ...
    children: {
      ...
      success: responseField(scopedTranslation, {
        ...
        label: "preview.sendTest.post.fields.success.title" as const,
        schema: z.boolean(),
      }),

      message: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "preview.sendTest.post.fields.message.title" as const,
