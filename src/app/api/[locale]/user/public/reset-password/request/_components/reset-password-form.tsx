...
import { useResetPasswordRequest } from "@/app/api/[locale]/user/public/reset-password/request/hooks";
      ...
      <Card className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xl">
        ...
        <CardContent>
          ...
          <Form form={form} onSubmit={submitForm} className="flex flex-col gap-6">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200"
