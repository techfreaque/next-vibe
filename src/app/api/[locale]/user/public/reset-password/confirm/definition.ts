...
const { POST } = createEndpoint({
  ...
  fields: objectField(
    ...
    { request: "data", response: true },
    {
      ...
      verification: objectField(
        {
          type: WidgetType.CONTAINER,
          title: "app.api.user.public.resetPassword.confirm.groups.verification.title" as const,
          description:
          ...
          token: requestDataField(
            {
              ...
              label: "app.api.user.public.resetPassword.confirm.fields.token.label" as const,
              description:
              ...
              helpText: "app.api.user.public.resetPassword.confirm.fields.token.help" as const,
            },
            z.string().min(1, {
              message: "app.api.user.public.resetPassword.confirm.fields.token.validation.required",
            }),
          ),
          ...
          email: requestDataField(
            {
              ...
              label: "app.api.user.public.resetPassword.confirm.fields.email.label" as const,
              description:
      ...
      newPassword: objectField(
        {
          type: WidgetType.CONTAINER,
          title: "app.api.user.public.resetPassword.confirm.groups.newPassword.title" as const,
          description:
          ...
          password: requestDataField(
            {
              ...
              label: "app.api.user.public.resetPassword.confirm.fields.password.label" as const,
              description:
              ...
              helpText: "app.api.user.public.resetPassword.confirm.fields.password.help" as const,
            },
            z.string().min(8, {
              message:
      ...
      response: objectField(
        {
          type: WidgetType.CONTAINER,
          title: "app.api.user.public.resetPassword.confirm.response.title" as const,
          description: "app.api.user.public.resetPassword.confirm.response.description" as const,
          layoutType: LayoutType.GRID,
          columns: 12,
        },
        { response: true },
        {
          ...
          message: responseField(
            {
              ...
              content: "app.api.user.public.resetPassword.confirm.response.message.label" as const,
            },
          ...
          securityTip: responseField(
            {
              type: WidgetType.TEXT,
              content: "app.api.user.public.resetPassword.confirm.response.securityTip" as const,
            },
          ...
          nextSteps: responseField(
            ...
            z.array(z.string()).describe("Recommended actions after password reset"),
          ),
        },
      ),
    },
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title: "app.api.user.public.resetPassword.confirm.errors.validation.title" as const,
      description:
        "app.api.user.public.resetPassword.confirm.errors.validation.description" as const,
    },
    [EndpointErrorTypes.UNAUTHORIZED]: {
      title: "app.api.user.public.resetPassword.confirm.errors.unauthorized.title" as const,
      description:
        "app.api.user.public.resetPassword.confirm.errors.unauthorized.description" as const,
    },
    [EndpointErrorTypes.SERVER_ERROR]: {
      title: "app.api.user.public.resetPassword.confirm.errors.internal.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.internal.description" as const,
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title: "app.api.user.public.resetPassword.confirm.errors.unknown.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.unknown.description" as const,
    },
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title: "app.api.user.public.resetPassword.confirm.errors.network.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.network.description" as const,
    },
    [EndpointErrorTypes.FORBIDDEN]: {
      title: "app.api.user.public.resetPassword.confirm.errors.forbidden.title" as const,
      description:
        "app.api.user.public.resetPassword.confirm.errors.forbidden.description" as const,
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title: "app.api.user.public.resetPassword.confirm.errors.notFound.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.notFound.description" as const,
    },
    [EndpointErrorTypes.UNSAVED_CHANGES]: {
      title: "app.api.user.public.resetPassword.confirm.errors.unsaved.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.unsaved.description" as const,
    },
    [EndpointErrorTypes.CONFLICT]: {
      title: "app.api.user.public.resetPassword.confirm.errors.conflict.title" as const,
      description: "app.api.user.public.resetPassword.confirm.errors.conflict.description" as const,
    },
  },
  ...
  successTypes: {
    ...
    description: "app.api.user.public.resetPassword.confirm.success.description" as const,
  },
...
export type ResetPasswordConfirmPostRequestInput = typeof POST.types.RequestInput;
export type ResetPasswordConfirmPostRequestOutput = typeof POST.types.RequestOutput;
export type ResetPasswordConfirmPostResponseInput = typeof POST.types.ResponseInput;
export type ResetPasswordConfirmPostResponseOutput = typeof POST.types.ResponseOutput;
