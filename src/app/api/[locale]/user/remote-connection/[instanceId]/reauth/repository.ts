...
import { encryptToken, deriveDefaultSelfInstanceId } from "../../repository";
import type { RemoteConnectionReauthPostRequestInput } from "./definition";
...
): Promise<ResponseType<{ reauthenticated: boolean }>> {
