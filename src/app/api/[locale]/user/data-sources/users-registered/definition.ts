...
import { USERS_REGISTERED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const UsersRegisteredWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.UsersRegisteredWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_REGISTERED_ALIAS],
  method: Methods.POST,
