/**
 * Users Login Attempts Failed - Endpoint Definition
...
import { USERS_LOGIN_ATTEMPTS_FAILED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const UsersLoginAttemptsFailedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.UsersLoginAttemptsFailedWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_LOGIN_ATTEMPTS_FAILED_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: UsersLoginAttemptsFailedWidget,
    noFormElement: true,
