...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: {
        label: "Użytkownicy ze zweryfikowanym e-mailem",
        description: "Wyjściowa seria czasowa",
      },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Dane użytkowników ze zweryfikowanym e-mailem",
      description: "Seria użytkowników ze zweryfikowanym e-mailem zwrócona",
    },
    errors: {
      unauthorized: {
