...
import { USERS_EMAIL_VERIFIED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const UsersEmailVerifiedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.UsersEmailVerifiedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_EMAIL_VERIFIED_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: UsersEmailVerifiedWidget,
    noFormElement: true,
