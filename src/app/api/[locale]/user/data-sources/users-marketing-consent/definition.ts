/**
 * Users Marketing Consent - Endpoint Definition
...
import { USERS_MARKETING_CONSENT_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "next-vibe-ui/unified/_shared/lazy-widget";
const UsersMarketingConsentWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.UsersMarketingConsentWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_MARKETING_CONSENT_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: UsersMarketingConsentWidget,
    noFormElement: true,
