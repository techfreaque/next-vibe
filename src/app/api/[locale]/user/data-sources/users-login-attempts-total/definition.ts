...
import { USERS_LOGIN_ATTEMPTS_TOTAL_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const UsersLoginAttemptsTotalWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.UsersLoginAttemptsTotalWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_LOGIN_ATTEMPTS_TOTAL_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: UsersLoginAttemptsTotalWidget,
    noFormElement: true,
