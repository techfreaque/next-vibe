...
import { USERS_BANNED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const UsersBannedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.UsersBannedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [USERS_BANNED_ALIAS],
  method: Methods.POST,
