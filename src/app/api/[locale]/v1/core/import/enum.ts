...
export const {
  ...
  PENDING: "app.api.v1.core.import.enum.status.pending.label",
  PROCESSING: "app.api.v1.core.import.enum.status.processing.label",
  COMPLETED: "app.api.v1.core.import.enum.status.completed.label",
  FAILED: "app.api.v1.core.import.enum.status.failed.label",
  CANCELLED: "app.api.v1.core.import.enum.status.cancelled.label",
  PAUSED: "app.api.v1.core.import.enum.status.paused.label",
});
...
export const {
  ...
  LEADS: "app.api.v1.core.import.enum.domain.leads.label",
  CONTACTS: "app.api.v1.core.import.enum.domain.contacts.label",
  BUSINESS_DATA: "app.api.v1.core.import.enum.domain.businessData.label",
  EMAILS: "app.api.v1.core.import.enum.domain.emails.label",
  USERS: "app.api.v1.core.import.enum.domain.users.label",
  TEMPLATES: "app.api.v1.core.import.enum.domain.templates.label",
});
...
export const {
  ...
  CSV: "app.api.v1.core.import.enum.format.csv.label",
  XLSX: "app.api.v1.core.import.enum.format.xlsx.label",
  JSON: "app.api.v1.core.import.enum.format.json.label",
  TSV: "app.api.v1.core.import.enum.format.tsv.label",
});
...
export const {
  ...
  IMMEDIATE: "app.api.v1.core.import.enum.processing.immediate.label",
  BACKGROUND: "app.api.v1.core.import.enum.processing.background.label",
  SCHEDULED: "app.api.v1.core.import.enum.processing.scheduled.label",
});
...
export const {
  ...
  VALIDATION_ERROR: "app.api.v1.core.import.enum.errorType.validation.label",
  DUPLICATE_ERROR: "app.api.v1.core.import.enum.errorType.duplicate.label",
  FORMAT_ERROR: "app.api.v1.core.import.enum.errorType.format.label",
  PROCESSING_ERROR: "app.api.v1.core.import.enum.errorType.processing.label",
  SYSTEM_ERROR: "app.api.v1.core.import.enum.errorType.system.label",
});
...
export const {
  ...
  SMALL: "app.api.v1.core.import.enum.batchSize.small.label",
  MEDIUM: "app.api.v1.core.import.enum.batchSize.medium.label",
  LARGE: "app.api.v1.core.import.enum.batchSize.large.label",
  XLARGE: "app.api.v1.core.import.enum.batchSize.xlarge.label",
});
