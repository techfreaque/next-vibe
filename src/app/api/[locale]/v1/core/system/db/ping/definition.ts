...
const { POST } = createEndpoint({
  method: Methods.POST,
  path: ["v1", "core", "system", "db", "ping"],
  title: "app.api.v1.core.system.db.ping.post.title",
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title: "app.api.v1.core.system.db.ping.post.errors.validation.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.validation.description",
    },
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title: "app.api.v1.core.system.db.ping.post.errors.network.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.network.description",
    },
    [EndpointErrorTypes.UNAUTHORIZED]: {
      title: "app.api.v1.core.system.db.ping.post.errors.unauthorized.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.unauthorized.description",
    },
    [EndpointErrorTypes.FORBIDDEN]: {
      title: "app.api.v1.core.system.db.ping.post.errors.forbidden.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.forbidden.description",
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title: "app.api.v1.core.system.db.ping.post.errors.notFound.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.notFound.description",
    },
    [EndpointErrorTypes.SERVER_ERROR]: {
      title: "app.api.v1.core.system.db.ping.post.errors.server.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.server.description",
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title: "app.api.v1.core.system.db.ping.post.errors.unknown.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.unknown.description",
    },
    ...
    [EndpointErrorTypes.CONFLICT]: {
      title: "app.api.v1.core.system.db.ping.post.errors.conflict.title",
      description:
        "app.api.v1.core.system.db.ping.post.errors.conflict.description",
    },
  },

  // === SUCCESS HANDLING ===
  successTypes: {
    title: "app.api.v1.core.system.db.ping.post.success.title",
    description: "app.api.v1.core.system.db.ping.post.success.description",
  },
