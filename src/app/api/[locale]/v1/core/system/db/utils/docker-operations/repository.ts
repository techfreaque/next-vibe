  ...
  async dockerComposeDown(
    ...
    try {
      ...
      const result = await this.executeDockerCommandInternal(command, {
        ...
        hideStandardLogs: true,
        description: t(
          "app.api.v1.core.system.db.utils.docker.stopping_containers",
        ),
        locale,
        logger,
      });
  ...
  async dockerComposeUp(
    ...
    try {
      ...
      const result = await this.executeDockerCommandInternal(command, {
        ...
        hideStandardLogs: true,
        description: t(
          "app.api.v1.core.system.db.utils.docker.starting_containers",
        ),
        locale,
        logger,
      });
  ...
  private async executeDockerCommandInternal(
    ...
    return await new Promise((resolve) => {
      if (description) {
        ...
        logger.debug(
          t(
            "app.api.v1.core.system.db.utils.dockerOperations.messages.executingCommand",
            { command },
          ),
        );
      }
      ...
      child.on("close", (code) => {
        ...
        if (!success && error) {
          logger.error(
            t(
              "app.api.v1.core.system.db.utils.dockerOperations.messages.commandFailed",
      ...
      child.on("error", (err: Error) => {
        ...
        logger.error(
          t(
            "app.api.v1.core.system.db.utils.dockerOperations.messages.executionFailed",
            { command },
          ),
          err,
        );
      ...
      Promise.race([
        ...
        logger.error(
          t(
            "app.api.v1.core.system.db.utils.dockerOperations.messages.commandError",
            { error: err.message },
          ),
        );
        resolve({
