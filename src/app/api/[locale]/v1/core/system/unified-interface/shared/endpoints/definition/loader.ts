...
import { getEndpoint } from "@/app/api/[locale]/v1/core/system/generated/endpoint";
  ...
  async load<TEndpoint extends CreateApiEndpointAny = CreateApiEndpointAny>(
    ...
    try {
      ...
      if (!endpoint) {
        ...
        return fail({
          message:
            "app.api.v1.core.system.unifiedInterface.shared.endpoints.definition.loader.errors.endpointNotFound",
      ...
      return fail({
        message:
          "app.api.v1.core.system.unifiedInterface.shared.endpoints.definition.loader.errors.loadFailed",
  ...
  async loadMany<TEndpoint extends CreateApiEndpointAny = CreateApiEndpointAny>(
    ...
    try {
      ...
      if (failures.length > 0) {
        ...
        return fail({
          message:
            "app.api.v1.core.system.unifiedInterface.shared.endpoints.definition.loader.errors.batchLoadFailed",
          errorType: ErrorResponseTypes.INTERNAL_ERROR,
          messageParams: {
