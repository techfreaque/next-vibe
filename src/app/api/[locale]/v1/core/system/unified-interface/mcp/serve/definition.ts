...
const { POST } = createEndpoint({
  method: Methods.POST,
  path: ["v1", "core", "system", "unified-interface", "mcp", "serve"],
  aliases: ["mcp", "mcp:serve", "mcp:start", "start-mcp"],
  title: "app.api.v1.core.system.unifiedInterface.mcp.serve.post.title" as const,
  description:
    "app.api.v1.core.system.unifiedInterface.mcp.serve.post.description" as const,
  category:
    "app.api.v1.core.system.unifiedInterface.mcp.serve.category" as const,
  tags: ["app.api.v1.core.system.unifiedInterface.mcp.serve.tags.mcp" as const],
  allowedRoles: [
    UserRole.ADMIN,
    UserRole.WEB_OFF,
  ...
  fields: objectField(
    {
      ...
      title:
        "app.api.v1.core.system.unifiedInterface.mcp.serve.post.response.title" as const,
      description:
        "app.api.v1.core.system.unifiedInterface.mcp.serve.post.response.description" as const,
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title:
        "app.api.v1.core.system.unifiedInterface.mcp.serve.post.errors.validation.title",
      description:
  ...
  successTypes: {
    title:
      "app.api.v1.core.system.unifiedInterface.mcp.serve.post.success.title",
    description:
      "app.api.v1.core.system.unifiedInterface.mcp.serve.post.success.description",
  },
