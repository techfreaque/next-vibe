...
export class InteractiveModeHandler {
  ...
  /**
   * Get session with proper type safety
  ...
  private setupSignalHandlers(): void {
    ...
    process.on("SIGINT", () => {
      // Using process.stdout for immediate output in signal handler
      // eslint-disable-next-line i18next/no-literal-string
  ...
  private addRouteToTree(route: DiscoveredRoute): void {
    ...
    // Parse route path: /api/[locale]/v1/core/system/unified-interface/cli/setup -> ["core", "system", "cli", "setup"]
