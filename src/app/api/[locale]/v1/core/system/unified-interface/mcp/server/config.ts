 ...
 * import { MCP_CONFIG, getPlatformConfig, Platform } from "../shared/config";
 *
...
import { MCP_CONFIG } from "@/app/api/[locale]/v1/core/system/unified-interface/shared/server-only/config";
