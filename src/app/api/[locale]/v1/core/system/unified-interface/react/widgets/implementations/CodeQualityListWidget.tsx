  ...
  if (!data) {
    return (
      <Div className={cn("text-muted-foreground italic", className)}>
        {t(
          "app.api.v1.core.system.unifiedInterface.react.widgets.codeQualityList.noData",
        )}
      </Div>
    );
  }
          ...
          >
            ...
            {item.rule && (
              <Div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                {t(
                  "app.api.v1.core.system.unifiedInterface.react.widgets.codeQualityList.rule",
                  { rule: item.rule },
                )}
              </Div>
            )}
