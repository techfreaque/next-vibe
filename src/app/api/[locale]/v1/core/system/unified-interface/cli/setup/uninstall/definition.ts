...
const { POST } = createEndpoint({
      ...
      success: responseField(
        {
          ...
          content:
            "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.success.title",
        },
        z.boolean(),
      ),
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.validation.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.validation.description",
    },
    ...
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.network.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.network.description",
    },
    [EndpointErrorTypes.FORBIDDEN]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.forbidden.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.forbidden.description",
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.notFound.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.notFound.description",
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.unknown.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.unknown.description",
    },
    [EndpointErrorTypes.UNSAVED_CHANGES]: {
      title:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.conflict.title",
      description:
        "app.api.v1.core.system.unifiedInterface.cli.setup.uninstall.post.errors.conflict.description",
    },
