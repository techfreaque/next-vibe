  ...
  if (!data) {
    return (
      <Div className={cn("text-muted-foreground italic", className)}>
        {t(
          "app.api.v1.core.system.unifiedInterface.react.widgets.dataList.noData",
        )}
      </Div>
    );
  }
  ...
  return (
    <Div className={cn("flex flex-col gap-3", className)}>
      ...
      {hasMore && (
        ...
        >
          {t(
            "app.api.v1.core.system.unifiedInterface.react.widgets.dataList.showMore",
      ...
      {showAll && maxItems && items.length > maxItems && (
        ...
        >
          {t(
            "app.api.v1.core.system.unifiedInterface.react.widgets.dataList.showLess",
          )}
        </Button>
      )}
    </Div>
