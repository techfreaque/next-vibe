...
/**
 * Type for additional issue properties
 */
type IssueProperty = string | number | boolean | null | undefined;
...
export class CodeQualityListWidgetRenderer extends BaseWidgetRenderer {
  ...
  private groupByFile(
    ...
    for (const item of data) {
      const filePath = String(item[groupBy] || "unknown");
