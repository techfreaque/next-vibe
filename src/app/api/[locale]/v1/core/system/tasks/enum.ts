...
export const {
  ...
  CRON: "app.api.v1.core.system.tasks.type.cron" as const,
  SIDE: "app.api.v1.core.system.tasks.type.side" as const,
  TASK_RUNNER: "app.api.v1.core.system.tasks.type.task_runner" as const,
});
...
export const {
  ...
  CRITICAL: "app.api.v1.core.system.tasks.priority.critical" as const,
  HIGH: "app.api.v1.core.system.tasks.priority.high" as const,
  MEDIUM: "app.api.v1.core.system.tasks.priority.medium" as const,
  LOW: "app.api.v1.core.system.tasks.priority.low" as const,
  BACKGROUND: "app.api.v1.core.system.tasks.priority.background" as const,
} as const);
...
export const {
  ...
  ALL: "app.api.v1.core.system.tasks.priority.filter.all" as const,
  CRITICAL: "app.api.v1.core.system.tasks.priority.critical" as const,
  HIGH: "app.api.v1.core.system.tasks.priority.high" as const,
  MEDIUM: "app.api.v1.core.system.tasks.priority.medium" as const,
  LOW: "app.api.v1.core.system.tasks.priority.low" as const,
  BACKGROUND: "app.api.v1.core.system.tasks.priority.background" as const,
  HIGH_AND_ABOVE:
    "app.api.v1.core.system.tasks.priority.filter.highAndAbove" as const,
  MEDIUM_AND_ABOVE:
    "app.api.v1.core.system.tasks.priority.filter.mediumAndAbove" as const,
});
...
export const {
  ...
  PENDING: "app.api.v1.core.system.tasks.status.pending" as const,
  RUNNING: "app.api.v1.core.system.tasks.status.running" as const,
  COMPLETED: "app.api.v1.core.system.tasks.status.completed" as const,
  FAILED: "app.api.v1.core.system.tasks.status.failed" as const,
  TIMEOUT: "app.api.v1.core.system.tasks.status.timeout" as const,
  CANCELLED: "app.api.v1.core.system.tasks.status.cancelled" as const,
  SKIPPED: "app.api.v1.core.system.tasks.status.skipped" as const,
  BLOCKED: "app.api.v1.core.system.tasks.status.blocked" as const,
  SCHEDULED: "app.api.v1.core.system.tasks.status.scheduled" as const,
  STOPPED: "app.api.v1.core.system.tasks.status.stopped" as const,
  ERROR: "app.api.v1.core.system.tasks.status.error" as const,
});
...
export const {
  ...
  ALL: "app.api.v1.core.system.tasks.status.filter.all" as const,
  ACTIVE: "app.api.v1.core.system.tasks.status.filter.active" as const,
  COMPLETED: "app.api.v1.core.system.tasks.status.completed" as const,
  FAILED: "app.api.v1.core.system.tasks.status.failed" as const,
  RUNNING: "app.api.v1.core.system.tasks.status.running" as const,
  PENDING: "app.api.v1.core.system.tasks.status.pending" as const,
  ERROR: "app.api.v1.core.system.tasks.status.filter.error" as const,
  STOPPED: "app.api.v1.core.system.tasks.status.stopped" as const,
});
...
export const {
  ...
  DEVELOPMENT: "app.api.v1.core.system.tasks.taskCategory.development" as const,
  BUILD: "app.api.v1.core.system.tasks.taskCategory.build" as const,
  WATCH: "app.api.v1.core.system.tasks.taskCategory.watch" as const,
  GENERATOR: "app.api.v1.core.system.tasks.taskCategory.generator" as const,
  TEST: "app.api.v1.core.system.tasks.taskCategory.test" as const,
  MAINTENANCE: "app.api.v1.core.system.tasks.taskCategory.maintenance" as const,
  DATABASE: "app.api.v1.core.system.tasks.taskCategory.database" as const,
  SYSTEM: "app.api.v1.core.system.tasks.taskCategory.system" as const,
  MONITORING: "app.api.v1.core.system.tasks.taskCategory.monitoring" as const,
});
...
export const {
  ...
  ASC: "app.api.v1.core.system.tasks.sort.asc" as const,
  DESC: "app.api.v1.core.system.tasks.sort.desc" as const,
});
