...
const { POST } = createEndpoint({
  method: Methods.POST,
  path: ["v1", "core", "system", "help", "list"],
  title: "app.api.v1.core.system.help.list.post.title",
      ...
      category: requestDataField(
        {
          ...
          label: "app.api.v1.core.system.help.list.fields.category.label",
          description:
          ...
          options: [
            {
              value: "tree",
              label:
                "app.api.v1.core.system.help.list.fields.format.options.tree",
            },
            {
              value: "flat",
              label:
                "app.api.v1.core.system.help.list.fields.format.options.flat",
            },
            {
              value: "json",
              label:
                "app.api.v1.core.system.help.list.fields.format.options.json",
            },
          ],
        },
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title: "app.api.v1.core.system.help.list.post.errors.validation.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.validation.description",
    },
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title: "app.api.v1.core.system.help.list.post.errors.network.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.network.description",
    },
    [EndpointErrorTypes.UNAUTHORIZED]: {
      title: "app.api.v1.core.system.help.list.post.errors.unauthorized.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.unauthorized.description",
    },
    [EndpointErrorTypes.FORBIDDEN]: {
      title: "app.api.v1.core.system.help.list.post.errors.forbidden.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.forbidden.description",
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title: "app.api.v1.core.system.help.list.post.errors.notFound.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.notFound.description",
    },
    [EndpointErrorTypes.SERVER_ERROR]: {
      title: "app.api.v1.core.system.help.list.post.errors.server.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.server.description",
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title: "app.api.v1.core.system.help.list.post.errors.unknown.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.unknown.description",
    },
    ...
    [EndpointErrorTypes.CONFLICT]: {
      title: "app.api.v1.core.system.help.list.post.errors.conflict.title",
      description:
        "app.api.v1.core.system.help.list.post.errors.conflict.description",
    },
  },

  // === SUCCESS HANDLING ===
  successTypes: {
    title: "app.api.v1.core.system.help.list.post.success.title",
    description: "app.api.v1.core.system.help.list.post.success.description",
  },
