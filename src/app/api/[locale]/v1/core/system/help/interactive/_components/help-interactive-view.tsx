...
import type { WidgetData } from "@/app/api/[locale]/v1/core/system/unified-interface/shared/widgets/types";
      ...
      <Div className="container max-w-7xl mx-auto">
        <Div className="text-center mb-12">
          <H1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-linear-to-r from-cyan-500 to-blue-600">
            {t("app.api.v1.core.system.help.interactive.ui.title")}
          </H1>
          <P className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {t("app.api.v1.core.system.help.interactive.ui.description")}{" "}
            {allEndpoints.length}{" "}
            {t("app.api.v1.core.system.help.interactive.ui.availableEndpoints")}
          </P>
        </Div>
            ...
            <Card className="sticky top-4">
              <CardContent className="mt-6">
                <H2 className="text-lg font-semibold mb-4">
                  {t(
                    "app.api.v1.core.system.help.interactive.ui.endpointsLabel",
                  )}
                </H2>
                            ...
                            >
                              ...
                              {ep.aliases && ep.aliases.length > 0 && (
                                <Div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                  {t(
                                    "app.api.v1.core.system.help.interactive.ui.aliasesLabel",
                                  )}{" "}
                                  {ep.aliases.join(", ")}
                                </Div>
                              )}
              ...
              <Card>
                <CardContent className="mt-6 text-center py-12">
                  <P className="text-gray-500 dark:text-gray-400">
                    {t(
                      "app.api.v1.core.system.help.interactive.ui.selectEndpoint",
                    )}
                  </P>
                </CardContent>
              </Card>
