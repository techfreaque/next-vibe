...
export class CliAuthHandler extends BaseAuthHandler {
      ...
      if (context.jwtPayload) {
        if (context.jwtPayload.isPublic) {
          return createErrorResponse(
            "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.publicPayloadNotSupported",
  ...
  async verifyToken(
    ...
    try {
      ...
      if (
        ...
        return createErrorResponse(
          "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.invalidTokenPayload",
          ErrorResponseTypes.UNAUTHORIZED,
        );
      }
      ...
      return createErrorResponse(
        "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.invalidToken",
        ErrorResponseTypes.UNAUTHORIZED,
  ...
  async signToken(
    ...
    try {
      ...
      return createErrorResponse(
        "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.signingFailed",
  ...
  private async authenticateByEmail(
    ...
    try {
      ...
      if (!userResult.success || !userResult.data) {
        ...
        return createErrorResponse(
          "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.userNotFound",
      ...
      logger.error("Error authenticating by email", parseError(error));
      return createErrorResponse(
        "app.api.v1.core.system.unifiedBackend.cli.vibe.errors.authenticationFailed",
        ErrorResponseTypes.INTERNAL_ERROR,
        { error: parseError(error).message },
      );
    }
