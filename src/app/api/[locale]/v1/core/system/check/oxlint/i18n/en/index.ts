export const translations = {
  title: "Oxlint",
  description: "Run ESLint with Oxlint configuration on your codebase",
  ...
  errors: {
    ...
    configNotFound: "lint.config.ts not found in project root",
    configMissingExport: "lint.config.ts must export 'config' or 'default'",
