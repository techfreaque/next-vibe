...
export declare function isJSXIdentifier(node: OxlintASTNode): node is JSXIdentifier;
...
type LintConfigValue = LintPrimitive | LintPrimitive[] | LintConfigObject | LintConfigObject[] | (LintPrimitive | LintConfigObject)[];
