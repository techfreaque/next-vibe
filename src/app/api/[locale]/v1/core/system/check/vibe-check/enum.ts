...
export const { enum: CheckType, options: CheckTypeOptions } = createEnumOptions(
  {
    ...
    TYPECHECK: "app.api.v1.core.system.check.vibeCheck.checkType.typecheck" as const,
    TEST: "app.api.v1.core.system.check.vibeCheck.checkType.test" as const,
    STRUCTURE: "app.api.v1.core.system.check.vibeCheck.checkType.structure" as const,
    MIGRATION: "app.api.v1.core.system.check.vibeCheck.checkType.migration" as const,
...
export const { enum: CheckSeverity, options: CheckSeverityOptions } =
  createEnumOptions({
    ...
    SUGGESTION: "app.api.v1.core.system.check.vibeCheck.severity.suggestion" as const,
  });
...
export const { enum: FixAction, options: FixActionOptions } = createEnumOptions(
  {
    AUTO_FIX: "app.api.v1.core.system.check.vibeCheck.fixAction.autoFix" as const,
    MANUAL_FIX: "app.api.v1.core.system.check.vibeCheck.fixAction.manualFix" as const,
