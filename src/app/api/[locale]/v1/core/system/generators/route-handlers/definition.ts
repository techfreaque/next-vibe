...
const { POST } = createEndpoint({
  method: Methods.POST,
  path: ["v1", "core", "system", "generators", "route-handlers"],
  title: "app.api.v1.core.system.generators.route-handlers.post.title" as const,
  description:
    "app.api.v1.core.system.generators.route-handlers.post.description" as const,
      ...
      success: responseField(
        {
          ...
          content:
            "app.api.v1.core.system.generators.route-handlers.post.fields.success.title" as const,
        },
        z.boolean(),
      ),
      message: responseField(
        {
          type: WidgetType.TEXT,
          content:
            "app.api.v1.core.system.generators.route-handlers.post.fields.message.title" as const,
        },
        z.string(),
      ),
      routesFound: responseField(
        {
          type: WidgetType.TEXT,
          content:
            "app.api.v1.core.system.generators.route-handlers.post.fields.routesFound.title" as const,
        },
        z.number(),
      ),
      duration: responseField(
        {
          type: WidgetType.TEXT,
          content:
            "app.api.v1.core.system.generators.route-handlers.post.fields.duration.title" as const,
        },
        z.number(),
      ),
    },
  ...
  successTypes: {
    title:
      "app.api.v1.core.system.generators.route-handlers.post.success.title" as const,
    description:
      "app.api.v1.core.system.generators.route-handlers.post.success.description" as const,
  },
});
