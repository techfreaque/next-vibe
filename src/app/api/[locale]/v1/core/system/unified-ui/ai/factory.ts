...
import { FieldUsage } from "@/app/api/[locale]/v1/core/system/unified-backend/shared/enums";
import { generateSchemaForUsage } from "@/app/api/[locale]/v1/core/system/unified-backend/shared/field-utils";
  ...
  createToolFromEndpoint(
    ...
    return tool({
      ...
      execute: async (params: z.infer<typeof parameters>) => {
        ...
        // Cast to Record<string, ToolParameterValue> is safe as Zod ensures type compatibility
        const executionContext: AIToolExecutionContext = {
          toolName: endpoint.toolName,
          parameters: params as Record<string, ToolParameterValue>,
          user: context.user,
