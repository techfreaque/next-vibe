...
```
src/app/api/[locale]/v1/core/payment/providers/nowpayments/
...
```
Production: https://yourdomain.com/api/en-GLOBAL/v1/core/payment/providers/nowpayments/webhook
Development: http://localhost:3000/api/en-GLOBAL/v1/core/payment/providers/nowpayments/webhook
```
...
```typescript
import { getPaymentProvider } from "@/app/api/[locale]/v1/core/payment/providers";
