...
export class ReferralRepositoryImpl implements ReferralRepository {
  ...
  async createReferralCode(
    ...
    try {
      ...
      if (existingCode) {
        return fail({
          message: "app.api.v1.core.referral.errors.conflict.title",
      ...
      return fail({
        message: "app.api.v1.core.referral.errors.serverError.title",
  ...
  async validateReferralCode(
    ...
    try {
      ...
      if (!referralCode) {
        return fail({
          message: "app.api.v1.core.referral.errors.notFound.title",
      ...
      if (!referralCode.isActive) {
        return fail({
          message: "app.api.v1.core.referral.errors.validation.title",
