...
import listNetworkRequestsEndpoints, { type ListNetworkRequestsResponseOutput } from "./definition";
...
export const { POST, tools } = endpointsHandler({
  ...
  [Methods.POST]: {
    email: undefined,
    handler: async ({ data, user, locale, logger }): Promise<ResponseType<ListNetworkRequestsResponseOutput>> => {
