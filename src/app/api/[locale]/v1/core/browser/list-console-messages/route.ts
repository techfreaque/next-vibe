...
import listConsoleMessagesEndpoints, { type ListConsoleMessagesResponseOutput } from "./definition";
...
export const { POST, tools } = endpointsHandler({
  ...
  [Methods.POST]: {
    email: undefined,
    handler: async ({ data, user, locale, logger }): Promise<ResponseType<ListConsoleMessagesResponseOutput>> => {
