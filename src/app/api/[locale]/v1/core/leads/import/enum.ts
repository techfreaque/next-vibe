...
export const {
  ...
  PROCESSING:
    "app.api.v1.core.leads.import.enums.csvImportJobStatus.processing",
  COMPLETED: "app.api.v1.core.leads.import.enums.csvImportJobStatus.completed",
  FAILED: "app.api.v1.core.leads.import.enums.csvImportJobStatus.failed",
});
...
export const {
  ...
  RETRY: "app.api.v1.core.leads.import.enums.csvImportJobAction.retry",
  DELETE: "app.api.v1.core.leads.import.enums.csvImportJobAction.delete",
  STOP: "app.api.v1.core.leads.import.enums.csvImportJobAction.stop",
});
...
export const {
  ...
  CREATE_ONLY: "app.api.v1.core.leads.import.enums.importMode.createOnly",
  UPDATE_ONLY: "app.api.v1.core.leads.import.enums.importMode.updateOnly",
  CREATE_OR_UPDATE:
    "app.api.v1.core.leads.import.enums.importMode.createOrUpdate",
  SKIP_DUPLICATES:
    "app.api.v1.core.leads.import.enums.importMode.skipDuplicates",
});
...
export const {
  ...
  CSV: "app.api.v1.core.leads.import.enums.importFormat.csv",
  TSV: "app.api.v1.core.leads.import.enums.importFormat.tsv",
  JSON: "app.api.v1.core.leads.import.enums.importFormat.json",
});
...
export const {
  ...
  IMMEDIATE:
    "app.api.v1.core.leads.import.enums.importProcessingType.immediate",
  CHUNKED: "app.api.v1.core.leads.import.enums.importProcessingType.chunked",
  SCHEDULED:
    "app.api.v1.core.leads.import.enums.importProcessingType.scheduled",
});
...
export const {
  ...
  VALIDATION_ERROR:
    "app.api.v1.core.leads.import.enums.importErrorType.validationError",
  DUPLICATE_EMAIL:
    "app.api.v1.core.leads.import.enums.importErrorType.duplicateEmail",
  INVALID_FORMAT:
    "app.api.v1.core.leads.import.enums.importErrorType.invalidFormat",
  MISSING_REQUIRED_FIELD:
    "app.api.v1.core.leads.import.enums.importErrorType.missingRequiredField",
  PROCESSING_ERROR:
    "app.api.v1.core.leads.import.enums.importErrorType.processingError",
  SYSTEM_ERROR:
    "app.api.v1.core.leads.import.enums.importErrorType.systemError",
});
...
export const {
  ...
  PENDING: "app.api.v1.core.leads.import.enums.batchProcessingStatus.pending",
  PROCESSING:
    "app.api.v1.core.leads.import.enums.batchProcessingStatus.processing",
  COMPLETED:
    "app.api.v1.core.leads.import.enums.batchProcessingStatus.completed",
  FAILED: "app.api.v1.core.leads.import.enums.batchProcessingStatus.failed",
  RETRYING: "app.api.v1.core.leads.import.enums.batchProcessingStatus.retrying",
});
...
export const {
  ...
  LOW: "app.api.v1.core.leads.import.enums.importPriority.low",
  NORMAL: "app.api.v1.core.leads.import.enums.importPriority.normal",
  HIGH: "app.api.v1.core.leads.import.enums.importPriority.high",
  URGENT: "app.api.v1.core.leads.import.enums.importPriority.urgent",
});
...
export const {
  ...
  WEB_UPLOAD: "app.api.v1.core.leads.import.enums.importSource.webUpload",
  API_UPLOAD: "app.api.v1.core.leads.import.enums.importSource.apiUpload",
  SCHEDULED_IMPORT:
    "app.api.v1.core.leads.import.enums.importSource.scheduledImport",
  BULK_OPERATION:
    "app.api.v1.core.leads.import.enums.importSource.bulkOperation",
});
...
export const {
  ...
  COMMA: "app.api.v1.core.leads.import.enums.csvDelimiter.comma",
  SEMICOLON: "app.api.v1.core.leads.import.enums.csvDelimiter.semicolon",
  TAB: "app.api.v1.core.leads.import.enums.csvDelimiter.tab",
  PIPE: "app.api.v1.core.leads.import.enums.csvDelimiter.pipe",
});
...
export const {
  ...
  STRICT: "app.api.v1.core.leads.import.enums.importValidationLevel.strict",
  MODERATE: "app.api.v1.core.leads.import.enums.importValidationLevel.moderate",
  LENIENT: "app.api.v1.core.leads.import.enums.importValidationLevel.lenient",
});
...
export const {
  ...
  EMAIL: "app.api.v1.core.leads.import.enums.importNotificationType.email",
  IN_APP: "app.api.v1.core.leads.import.enums.importNotificationType.inApp",
  WEBHOOK: "app.api.v1.core.leads.import.enums.importNotificationType.webhook",
  NONE: "app.api.v1.core.leads.import.enums.importNotificationType.none",
});
