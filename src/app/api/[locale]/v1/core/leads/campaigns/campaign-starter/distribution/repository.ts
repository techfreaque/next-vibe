...
import { getCronFrequencyMinutes } from "@/app/api/[locale]/v1/core/system/unified-interface/tasks/cron-formatter";
...
export class DistributionRepositoryImpl implements DistributionRepository {
  calculateDistribution(
    ...
    try {
      ...
      return fail({
          message: "app.api.v1.core.leads.leadsErrors.campaigns.common.error.server.title" as const,
