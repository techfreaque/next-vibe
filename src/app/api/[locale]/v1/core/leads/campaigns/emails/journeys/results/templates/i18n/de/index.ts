...
export const translations: typeof enTranslations = {
  ...
  resultsJourney: {
    followup1: {
      ...
      subheadline: "Verlassen Sie sich nicht nur auf unser Wort - sehen Sie, was wir für Unternehmen wie Ihres erreicht haben",
    ...
    followup2: {
      ...
      intro: "Wir verstehen, dass Sie die richtige Wahl treffen möchten. Lassen Sie uns transparent darüber sprechen, was uns auszeichnet.",
      ...
      opportunityCostText: "Jeder Tag ohne die richtige Lösung bedeutet verpasste Chancen und verlorenes Potenzial. Lassen Sie nicht zu, dass Unentschlossenheit Sie mehr kostet als unser Service.",
    ...
    followup3: {
      ...
      intro: "Wir haben unseren Wert geteilt, Bedenken angesprochen und gezeigt, was möglich ist. Jetzt ist Entscheidungszeit.",
      finalOpportunityTitle: "Letzte Gelegenheit",
      finalOpportunityText: "Dieses Sonderangebot läuft bald ab. Lassen Sie sich diese Gelegenheit nicht entgehen.",
    ...
    nurture: {
      ...
      intro: "Wir sind hier, um Ihnen zum Erfolg zu verhelfen, ob Sie mit uns arbeiten oder nicht. Hier sind einige Einblicke, die Ihrem Unternehmen zum Erfolg verhelfen.",
      ...
      freeResourceDescription: "Laden Sie unseren umfassenden Leitfaden voller umsetzbarer Tipps und Strategien herunter",
    ...
    reactivation: {
      ...
      intro: "Wir haben bemerkt, dass Sie in letzter Zeit nicht aktiv waren. Wir haben einige aufregende Verbesserungen vorgenommen und haben ein spezielles Willkommen-zurück-Angebot nur für Sie.",
