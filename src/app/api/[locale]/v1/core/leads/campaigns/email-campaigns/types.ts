...
export const emailCampaignConfigSchema = z.object({
  ...
  delayBetweenStages: z.object({
    ...
    [EmailCampaignStage.FOLLOWUP_2]: z.number(),
    [EmailCampaignStage.FOLLOWUP_3]: z.number(),
    [EmailCampaignStage.NURTURE]: z.number(),
    [EmailCampaignStage.REACTIVATION]: z.number(),
  }),
  enabledDays: z.array(z.number().min(0).max(7)),
...
export const emailCampaignResultSchema = z.object({
  ...
  stageTransitions: z.record(z.string(), z.number()),
