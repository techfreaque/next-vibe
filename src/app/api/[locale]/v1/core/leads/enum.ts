...
export const {
  ...
  EMAIL_OPEN: "app.api.v1.core.leads.enums.engagementTypes.emailOpen" as const,
  EMAIL_CLICK:
    "app.api.v1.core.leads.enums.engagementTypes.emailClick" as const,
  WEBSITE_VISIT:
...
export const {
  ...
  CAMPAIGN_RUNNING: "app.api.v1.core.leads.enums.leadStatus.campaignRunning", // Changed from CONTACTED
  WEBSITE_USER: "app.api.v1.core.leads.enums.leadStatus.websiteUser", // For leads created through website engagement tracking
  NEWSLETTER_SUBSCRIBER:
    "app.api.v1.core.leads.enums.leadStatus.newsletterSubscriber" as const, // For website users who subscribed to newsletter
  IN_CONTACT: "app.api.v1.core.leads.enums.leadStatus.inContact", // For leads who have contacted us and are in the process of being contacted but not yet converted
  SIGNED_UP: "app.api.v1.core.leads.enums.leadStatus.signedUp", // User created account (what CONVERTED currently means)
  CONSULTATION_BOOKED:
    "app.api.v1.core.leads.enums.leadStatus.consultationBooked", // User booked consultation call
  SUBSCRIPTION_CONFIRMED:
    "app.api.v1.core.leads.enums.leadStatus.subscriptionConfirmed", // True conversion - subscription confirmed
  UNSUBSCRIBED: "app.api.v1.core.leads.enums.leadStatus.unsubscribed",
...
export const {
  ...
  NOT_STARTED:
    "app.api.v1.core.leads.enums.emailCampaignStage.notStarted" as const,
  INITIAL: "app.api.v1.core.leads.enums.emailCampaignStage.initial" as const,
  FOLLOWUP_1:
    "app.api.v1.core.leads.enums.emailCampaignStage.followup1" as const,
  FOLLOWUP_2:
    "app.api.v1.core.leads.enums.emailCampaignStage.followup2" as const,
  FOLLOWUP_3:
    "app.api.v1.core.leads.enums.emailCampaignStage.followup3" as const,
  NURTURE: "app.api.v1.core.leads.enums.emailCampaignStage.nurture" as const,
  REACTIVATION:
    "app.api.v1.core.leads.enums.emailCampaignStage.reactivation" as const,
} as const);
...
export const {
  ...
  PERSONAL_APPROACH:
    "app.api.v1.core.leads.enums.emailJourneyVariant.personalApproach",
  RESULTS_FOCUSED:
    "app.api.v1.core.leads.enums.emailJourneyVariant.resultsFocused",
  PERSONAL_RESULTS:
    "app.api.v1.core.leads.enums.emailJourneyVariant.personalResults",
});
...
export const {
  ...
  ALL: "app.api.v1.core.leads.enums.emailJourneyVariantFilter.all",
  PERSONAL_APPROACH:
    "app.api.v1.core.leads.enums.emailJourneyVariantFilter.personalApproach",
  RESULTS_FOCUSED:
    "app.api.v1.core.leads.enums.emailJourneyVariantFilter.resultsFocused",
  PERSONAL_RESULTS:
    "app.api.v1.core.leads.enums.emailJourneyVariantFilter.personalResults",
});
...
export const {
  ...
  ASC: "app.api.v1.core.leads.enums.sortOrder.asc",
  DESC: "app.api.v1.core.leads.enums.sortOrder.desc",
});
...
export const {
  ...
  EMAIL: "app.api.v1.core.leads.enums.leadSortField.email",
  BUSINESS_NAME: "app.api.v1.core.leads.enums.leadSortField.businessName",
  CREATED_AT: "app.api.v1.core.leads.enums.leadSortField.createdAt",
  UPDATED_AT: "app.api.v1.core.leads.enums.leadSortField.updatedAt",
  LAST_ENGAGEMENT_AT:
    "app.api.v1.core.leads.enums.leadSortField.lastEngagementAt",
});
...
export const {
  ...
  CSV: "app.api.v1.core.leads.enums.exportFormat.csv",
  XLSX: "app.api.v1.core.leads.enums.exportFormat.xlsx",
});
...
export const {
  ...
  CSV: "app.api.v1.core.leads.enums.mimeType.csv",
  XLSX: "app.api.v1.core.leads.enums.mimeType.xlsx",
});
...
export const {
  ...
  LEAD_CREATED: "app.api.v1.core.leads.enums.activityType.leadCreated",
  LEAD_UPDATED: "app.api.v1.core.leads.enums.activityType.leadUpdated",
  EMAIL_SENT: "app.api.v1.core.leads.enums.activityType.emailSent",
  EMAIL_OPENED: "app.api.v1.core.leads.enums.activityType.emailOpened",
  EMAIL_CLICKED: "app.api.v1.core.leads.enums.activityType.emailClicked",
  LEAD_CONVERTED: "app.api.v1.core.leads.enums.activityType.leadConverted",
  LEAD_UNSUBSCRIBED:
    "app.api.v1.core.leads.enums.activityType.leadUnsubscribed",
});
...
export const {
  ...
  WITH_USER: "app.api.v1.core.leads.enums.userAssociation.withUser",
  WITH_LEAD: "app.api.v1.core.leads.enums.userAssociation.withLead",
  STANDALONE: "app.api.v1.core.leads.enums.userAssociation.standalone",
  WITH_BOTH: "app.api.v1.core.leads.enums.userAssociation.withBoth",
});
...
export const {
  ...
  WEBSITE: "app.api.v1.core.leads.enums.leadSource.website",
  SOCIAL_MEDIA: "app.api.v1.core.leads.enums.leadSource.socialMedia",
  EMAIL_CAMPAIGN: "app.api.v1.core.leads.enums.leadSource.emailCampaign",
  REFERRAL: "app.api.v1.core.leads.enums.leadSource.referral",
  CSV_IMPORT: "app.api.v1.core.leads.enums.leadSource.csvImport",
  API: "app.api.v1.core.leads.enums.leadSource.api",
});
...
export const {
  ...
  ALL: "app.api.v1.core.leads.enums.leadStatusFilter.all",
  NEW: "app.api.v1.core.leads.enums.leadStatusFilter.new",
  PENDING: "app.api.v1.core.leads.enums.leadStatusFilter.pending",
  CAMPAIGN_RUNNING:
    "app.api.v1.core.leads.enums.leadStatusFilter.campaignRunning",
  WEBSITE_USER: "app.api.v1.core.leads.enums.leadStatusFilter.websiteUser",
  NEWSLETTER_SUBSCRIBER:
    "app.api.v1.core.leads.enums.leadStatusFilter.newsletterSubscriber" as const,
  IN_CONTACT: "app.api.v1.core.leads.enums.leadStatusFilter.inContact",
  SIGNED_UP: "app.api.v1.core.leads.enums.leadStatusFilter.signedUp",
  CONSULTATION_BOOKED:
    "app.api.v1.core.leads.enums.leadStatusFilter.consultationBooked",
  SUBSCRIPTION_CONFIRMED:
    "app.api.v1.core.leads.enums.leadStatusFilter.subscriptionConfirmed",
  UNSUBSCRIBED: "app.api.v1.core.leads.enums.leadStatusFilter.unsubscribed",
  BOUNCED: "app.api.v1.core.leads.enums.leadStatusFilter.bounced",
  INVALID: "app.api.v1.core.leads.enums.leadStatusFilter.invalid",
});
...
export const {
  ...
  ALL: "app.api.v1.core.leads.enums.emailCampaignStageFilter.all",
  NOT_STARTED: "app.api.v1.core.leads.enums.emailCampaignStage.notStarted",
  INITIAL: "app.api.v1.core.leads.enums.emailCampaignStage.initial",
  FOLLOWUP_1: "app.api.v1.core.leads.enums.emailCampaignStage.followup1",
  FOLLOWUP_2: "app.api.v1.core.leads.enums.emailCampaignStage.followup2",
  FOLLOWUP_3: "app.api.v1.core.leads.enums.emailCampaignStage.followup3",
  NURTURE: "app.api.v1.core.leads.enums.emailCampaignStage.nurture",
  REACTIVATION: "app.api.v1.core.leads.enums.emailCampaignStage.reactivation",
});
...
export const {
  ...
  ALL: "app.api.v1.core.leads.enums.leadSourceFilter.all",
  WEBSITE: "app.api.v1.core.leads.enums.leadSource.website",
  SOCIAL_MEDIA: "app.api.v1.core.leads.enums.leadSource.socialMedia",
  EMAIL_CAMPAIGN: "app.api.v1.core.leads.enums.leadSource.emailCampaign",
  REFERRAL: "app.api.v1.core.leads.enums.leadSource.referral",
...
export const {
  ...
  CURRENT_PAGE: "app.api.v1.core.leads.enums.batchOperationScope.currentPage",
  ALL_PAGES: "app.api.v1.core.leads.enums.batchOperationScope.allPages",
});
