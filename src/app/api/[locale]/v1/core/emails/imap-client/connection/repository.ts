...
export class ImapConnectionRepositoryImpl implements ImapConnectionRepository {
        ...
        >((resolve) => {
          ...
          imap.once("ready", () => {
            ...
            resolveOnce(
              createSuccessResponse({
                success: true,
                message: "imap.connection.test.success" as const,
  ...
  async disconnect(
    ...
    try {
      ...
      return createErrorResponse(
        "imapErrors.connection.close.failed",
        ErrorResponseTypes.INTERNAL_ERROR,
      );
    }
  }
  ...
  async listFolders(
    ...
    try {
      ...
      logger.error("Error listing IMAP folders", error);
      return createErrorResponse(
  ...
  async listMessages(
    ...
    try {
      ...
      logger.error("Error listing IMAP messages", error);
      return createErrorResponse(
