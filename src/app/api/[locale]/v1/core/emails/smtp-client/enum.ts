...
export const {
  ...
  ACTIVE: "app.api.v1.core.emails.enums.smtpAccountStatus.active",
  INACTIVE: "app.api.v1.core.emails.enums.smtpAccountStatus.inactive",
  ERROR: "app.api.v1.core.emails.enums.smtpAccountStatus.error",
  TESTING: "app.api.v1.core.emails.enums.smtpAccountStatus.testing",
});
...
export const {
  ...
  NONE: "app.api.v1.core.emails.enums.smtpSecurityType.none",
  TLS: "app.api.v1.core.emails.enums.smtpSecurityType.tls",
  SSL: "app.api.v1.core.emails.enums.smtpSecurityType.ssl",
  STARTTLS: "app.api.v1.core.emails.enums.smtpSecurityType.starttls",
});
...
export const {
  ...
  ALL: "app.api.v1.core.emails.enums.smtpStatusFilter.all",
  ACTIVE: "app.api.v1.core.emails.enums.smtpAccountStatus.active",
  INACTIVE: "app.api.v1.core.emails.enums.smtpAccountStatus.inactive",
  ERROR: "app.api.v1.core.emails.enums.smtpAccountStatus.error",
  TESTING: "app.api.v1.core.emails.enums.smtpAccountStatus.testing",
...
export const {
  ...
  HEALTHY: "app.api.v1.core.emails.enums.smtpHealthStatus.healthy",
  DEGRADED: "app.api.v1.core.emails.enums.smtpHealthStatus.degraded",
  UNHEALTHY: "app.api.v1.core.emails.enums.smtpHealthStatus.unhealthy",
  UNKNOWN: "app.api.v1.core.emails.enums.smtpHealthStatus.unknown",
});
...
export const {
  ...
  ALL: "app.api.v1.core.emails.enums.smtpHealthStatusFilter.all",
  HEALTHY: "app.api.v1.core.emails.enums.smtpHealthStatus.healthy",
  DEGRADED: "app.api.v1.core.emails.enums.smtpHealthStatus.degraded",
  UNHEALTHY: "app.api.v1.core.emails.enums.smtpHealthStatus.unhealthy",
  UNKNOWN: "app.api.v1.core.emails.enums.smtpHealthStatus.unknown",
...
export const {
  ...
  NAME: "app.api.v1.core.emails.enums.smtpSortField.name",
  STATUS: "app.api.v1.core.emails.enums.smtpSortField.status",
  CREATED_AT: "app.api.v1.core.emails.enums.smtpSortField.createdAt",
  UPDATED_AT: "app.api.v1.core.emails.enums.smtpSortField.updatedAt",
  PRIORITY: "app.api.v1.core.emails.enums.smtpSortField.priority",
  TOTAL_EMAILS_SENT:
    "app.api.v1.core.emails.enums.smtpSortField.totalEmailsSent",
  LAST_USED_AT: "app.api.v1.core.emails.enums.smtpSortField.lastUsedAt",
});
...
export const {
  ...
  ALL: "app.api.v1.core.emails.enums.smtpCampaignTypeFilter.all",
  LEAD_CAMPAIGN: "app.api.v1.core.emails.enums.smtpCampaignType.leadCampaign",
  NEWSLETTER: "app.api.v1.core.emails.enums.smtpCampaignType.newsletter",
  TRANSACTIONAL: "app.api.v1.core.emails.enums.smtpCampaignType.transactional",
  NOTIFICATION: "app.api.v1.core.emails.enums.smtpCampaignType.notification",
...
export const {
  ...
  NAME: "app.api.v1.core.emails.enums.selectionRuleSortField.name",
  PRIORITY: "app.api.v1.core.emails.enums.selectionRuleSortField.priority",
  CAMPAIGN_TYPE:
    "app.api.v1.core.emails.enums.selectionRuleSortField.campaignType",
  JOURNEY_VARIANT:
    "app.api.v1.core.emails.enums.selectionRuleSortField.journeyVariant",
  CAMPAIGN_STAGE:
    "app.api.v1.core.emails.enums.selectionRuleSortField.campaignStage",
  COUNTRY: "app.api.v1.core.emails.enums.selectionRuleSortField.country",
  LANGUAGE: "app.api.v1.core.emails.enums.selectionRuleSortField.language",
  CREATED_AT: "app.api.v1.core.emails.enums.selectionRuleSortField.createdAt",
  UPDATED_AT: "app.api.v1.core.emails.enums.selectionRuleSortField.updatedAt",
  EMAILS_SENT: "app.api.v1.core.emails.enums.selectionRuleSortField.emailsSent",
  SUCCESS_RATE:
    "app.api.v1.core.emails.enums.selectionRuleSortField.successRate",
  LAST_USED_AT:
    "app.api.v1.core.emails.enums.selectionRuleSortField.lastUsedAt",
});
...
export const {
  ...
  ALL: "app.api.v1.core.emails.enums.selectionRuleStatusFilter.all",
  ACTIVE: "app.api.v1.core.emails.enums.selectionRuleStatusFilter.active",
  INACTIVE: "app.api.v1.core.emails.enums.selectionRuleStatusFilter.inactive",
  DEFAULT: "app.api.v1.core.emails.enums.selectionRuleStatusFilter.default",
  FAILOVER: "app.api.v1.core.emails.enums.selectionRuleStatusFilter.failover",
});
...
export const {
  ...
  ROUND_ROBIN: "app.api.v1.core.emails.enums.loadBalancingStrategy.roundRobin",
  WEIGHTED: "app.api.v1.core.emails.enums.loadBalancingStrategy.weighted",
  PRIORITY: "app.api.v1.core.emails.enums.loadBalancingStrategy.priority",
  LEAST_USED: "app.api.v1.core.emails.enums.loadBalancingStrategy.leastUsed",
});
...
export const {
  ...
  SUCCESS: "app.api.v1.core.emails.enums.testResult.success",
  AUTH_FAILED: "app.api.v1.core.emails.enums.testResult.authFailed",
  CONNECTION_FAILED: "app.api.v1.core.emails.enums.testResult.connectionFailed",
  TIMEOUT: "app.api.v1.core.emails.enums.testResult.timeout",
  UNKNOWN_ERROR: "app.api.v1.core.emails.enums.testResult.unknownError",
});
