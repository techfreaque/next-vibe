...
### Add a Memory
```bash
vibe post /v1/core/agent/chat/memories \
  --data '{"content": "Profession: Software Engineer", "tags": ["profession"]}'
```

### List Memories
```bash
vibe get /v1/core/agent/chat/memories
```
...
Location: `src/app/api/[locale]/v1/core/agent/ai-stream/system-prompt-builder.ts`
...
### Chat DB Export
Location: `src/app/api/[locale]/v1/core/agent/chat/db.ts`
...
# Update memory
vibe patch /v1/core/agent/chat/memories/[id] \
  --data '{"content": "Allergies: Peanuts and shellfish"}'

# Delete memory
vibe delete /v1/core/agent/chat/memories/[id]
