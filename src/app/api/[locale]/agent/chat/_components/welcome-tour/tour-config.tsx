...
export const TOUR_DATA_ATTRS = {
  ...
  CHARACTER_SELECTOR_FAVORITES: "character-selector-favorites",
  CHARACTER_SELECTOR_SHOW_ALL: "character-selector-show-all",
  CHARACTER_SELECTOR_SEARCH: "character-selector-search",
  CHARACTER_SELECTOR_GROUP: "character-selector-group",
