      ...
      persona: objectField(
        {
          type: WidgetType.CONTAINER,
          title:
            "app.api.agent.chat.personas.id.get.response.persona.title" as const,
          ...
          id: responseField(
            {
              ...
              content:
                "app.api.agent.chat.personas.id.get.response.persona.id.content" as const,
            },
            z.string(),
          ),
          name: responseField(
            {
              type: WidgetType.TEXT,
              content:
                "app.api.agent.chat.personas.id.get.response.persona.name.content" as const,
            },
            z.string(),
          ),
          description: responseField(
            {
              type: WidgetType.TEXT,
              content:
                "app.api.agent.chat.personas.id.get.response.persona.description.content" as const,
            },
            z.string(),
          ),
          icon: responseField(
            {
              type: WidgetType.TEXT,
              content:
                "app.api.agent.chat.personas.id.get.response.persona.icon.content" as const,
            },
            z.string(),
          ),
          systemPrompt: responseField(
            {
              type: WidgetType.TEXT,
              content:
                "app.api.agent.chat.personas.id.get.response.persona.systemPrompt.content" as const,
            },
            z.string(),
          ),
          ...
          preferredModel: responseField(
            {
              type: WidgetType.TEXT,
              content:
                "app.api.agent.chat.personas.id.get.response.persona.preferredModel.content" as const,
            },
          ...
          suggestedPrompts: responseArrayOptionalField(
            ...
            field(
              ...
              { response: true },
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.id.get.response.persona.suggestedPrompts.content" as const,
              },
            ),
          ),
        },
      ...
      personaDescription: requestDataField(
        {
          ...
          fieldType: FieldDataType.TEXT,
          label:
            "app.api.agent.chat.personas.id.patch.personaDescription.label" as const,
          description:
            "app.api.agent.chat.personas.id.patch.personaDescription.description" as const,
          columns: 6,
        },
      ...
      preferredModel: requestDataField(
        {
          ...
          fieldType: FieldDataType.SELECT,
          label:
            "app.api.agent.chat.personas.id.patch.preferredModel.label" as const,
          description:
            "app.api.agent.chat.personas.id.patch.preferredModel.description" as const,
