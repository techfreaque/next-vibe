...
const { GET } = createEndpoint({
  ...
  fields: objectField(
    {
      ...
      title: "app.api.agent.chat.personas.get.container.title" as const,
      description:
        "app.api.agent.chat.personas.get.container.description" as const,
        ...
        objectField(
          {
            type: WidgetType.CONTAINER,
            title:
              "app.api.agent.chat.personas.get.response.personas.persona.title" as const,
            ...
            id: responseField(
              {
                ...
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.id.content" as const,
              },
              z.string(),
            ),
            name: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.name.content" as const,
              },
              z.string(),
            ),
            description: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.description.content" as const,
              },
              z.string(),
            ),
            icon: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.icon.content" as const,
              },
            ...
            systemPrompt: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.systemPrompt.content" as const,
              },
              z.string(),
            ),
            ...
            preferredModel: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.preferredModel.content" as const,
              },
            ...
            suggestedPrompts: responseField(
              {
                type: WidgetType.TEXT,
                content:
                  "app.api.agent.chat.personas.get.response.personas.persona.suggestedPrompts.content" as const,
              },
  ...
  errorTypes: {
    [EndpointErrorTypes.VALIDATION_FAILED]: {
      title: "app.api.agent.chat.personas.get.errors.validation.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.validation.description" as const,
    },
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title: "app.api.agent.chat.personas.get.errors.network.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.network.description" as const,
    },
    [EndpointErrorTypes.UNAUTHORIZED]: {
      title:
        "app.api.agent.chat.personas.get.errors.unauthorized.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.unauthorized.description" as const,
    },
    [EndpointErrorTypes.FORBIDDEN]: {
      title: "app.api.agent.chat.personas.get.errors.forbidden.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.forbidden.description" as const,
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title: "app.api.agent.chat.personas.get.errors.notFound.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.notFound.description" as const,
    },
    [EndpointErrorTypes.SERVER_ERROR]: {
      title: "app.api.agent.chat.personas.get.errors.server.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.server.description" as const,
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title: "app.api.agent.chat.personas.get.errors.unknown.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.unknown.description" as const,
    },
    [EndpointErrorTypes.UNSAVED_CHANGES]: {
      title:
        "app.api.agent.chat.personas.get.errors.unsavedChanges.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.unsavedChanges.description" as const,
    },
    [EndpointErrorTypes.CONFLICT]: {
      title: "app.api.agent.chat.personas.get.errors.conflict.title" as const,
      description:
        "app.api.agent.chat.personas.get.errors.conflict.description" as const,
    },
  },

  successTypes: {
    title: "app.api.agent.chat.personas.get.success.title" as const,
    description: "app.api.agent.chat.personas.get.success.description" as const,
  },
...
const { POST } = createEndpoint({
  ...
  fields: objectField(
    {
      type: WidgetType.CONTAINER,
      title: "app.api.agent.chat.personas.post.container.title" as const,
      description:
        "app.api.agent.chat.personas.post.container.description" as const,
      layoutType: LayoutType.STACKED,
    },
