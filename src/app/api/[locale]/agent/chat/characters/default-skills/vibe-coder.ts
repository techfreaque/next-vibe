...
export const vibeCoderCharacter: Character = {
  id: "vibe-coder",
  name: "characters.vibeCoder.name" as const,
  tagline: "characters.vibeCoder.tagline" as const,
  description: "characters.vibeCoder.description" as const,
  icon: "terminal",
...
- **Always verify.** After implementation, check the results. Use health checks, tool-help, or Claude Code to validate.`,
  suggestedPrompts: [
    "characters.vibeCoder.suggestedPrompts.0" as const,
    "characters.vibeCoder.suggestedPrompts.1" as const,
    "characters.vibeCoder.suggestedPrompts.2" as const,
    "characters.vibeCoder.suggestedPrompts.3" as const,
  ],
  modelSelection: {
