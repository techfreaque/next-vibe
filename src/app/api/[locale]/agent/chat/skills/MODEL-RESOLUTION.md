...
| `speedRange`        | FAST → BALANCED → THOROUGH     | Latency tier. FAST <1s, BALANCED 1–5s, THOROUGH = deep reasoning (10s+)                                                                |
...
**Fallback chain:** MANUAL model unavailable → treat as FILTERS with no constraints (all models eligible).
...
- Building a "Fast Customer Support Bot"? Set `intelligenceRange: {max: SMART}, speedRange: {min: FAST}`.
...
| Use case                | intelligenceRange   | priceRange     | speedRange    | contentRange                   |
| ----------------------- | ------------------- | -------------- | ------------- | ------------------------------ |
| Fast assistant          | QUICK–SMART         | CHEAP–STANDARD | FAST–BALANCED | MAINSTREAM                     |
| Deep reasoning          | BRILLIANT–BRILLIANT | any            | any           | MAINSTREAM                     |
| Budget mode             | QUICK–SMART         | CHEAP–CHEAP    | FAST–FAST     | MAINSTREAM                     |
| Uncensored creative     | SMART–BRILLIANT     | CHEAP–STANDARD | any           | OPEN–UNCENSORED                |
| Multi-modal image skill | SMART–BRILLIANT     | any            | any           | (+ set imageGenModelSelection) |
