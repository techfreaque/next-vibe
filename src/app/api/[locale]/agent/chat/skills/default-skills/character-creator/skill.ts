...
\`\`\`json
{"availableTools":[{"toolId":"brave-search"},{"toolId":"fetch-url-content"}],"pinnedTools":[{"toolId":"brave-search"},{"toolId":"fetch-url-content"}]}
\`\`\`

### Skill with search + image generation:
\`\`\`json
{"availableTools":[{"toolId":"brave-search"},{"toolId":"fetch-url-content"},{"toolId":"image-generation"}],"pinnedTools":[{"toolId":"brave-search"},{"toolId":"fetch-url-content"},{"toolId":"image-generation"}]}
\`\`\`

**Available tool IDs to use**: \`brave-search\`, \`kagi-search\`, \`fetch-url-content\`, \`image-generation\`, \`music-generation\`, \`video-generation\`, \`memory-add\`, \`memory-update\`, \`memory-delete\`, \`ai-run\`
