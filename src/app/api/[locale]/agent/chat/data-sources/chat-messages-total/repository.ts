/**
 * Chat Messages Total — Repository
 * Server-only. DB access.
 * Count of all chat messages per resolution bucket.
 */
...
export class QueryChatMessagesTotalRepository {
  static async queryChatMessagesTotal(data: {
