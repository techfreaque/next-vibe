...
const ChatMessagesByUserWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ChatMessagesByUserWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CHAT_MESSAGES_BY_USER_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: ChatMessagesByUserWidget,
    noFormElement: true,
