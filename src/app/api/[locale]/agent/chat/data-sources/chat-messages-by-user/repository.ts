/**
 * Chat Messages By User — Repository
 * Server-only. DB access.
 * Count of user-role chat messages per resolution bucket.
 */
...
export class QueryChatMessagesByUserRepository {
  static async queryChatMessagesByUser(data: {
