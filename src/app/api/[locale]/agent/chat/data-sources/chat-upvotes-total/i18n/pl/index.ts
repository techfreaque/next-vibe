...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Głosy za", description: "Wyjściowa seria czasowa" },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Głosy za w czacie łącznie obliczone",
      description: "Seria głosów za w czacie łącznie zwrócona",
    },
    errors: {
      unauthorized: {
