/**
 * Chat Errors Total - Repository
 * Server-only. DB access.
 * Count of error-role chat messages per resolution bucket.
 */
...
export class QueryChatErrorsTotalRepository {
  static async queryChatErrorsTotal(data: {
