/**
 * Chat Messages By AI - Repository
 * Server-only. DB access.
 * Count of assistant-role chat messages per resolution bucket.
 */
...
export class QueryChatMessagesByAiRepository {
  static async queryChatMessagesByAi(data: {
