/**
 * Chat Messages By AI - Endpoint Definition
...
import { CHAT_MESSAGES_BY_AI_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const ChatMessagesByAiWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ChatMessagesByAiWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CHAT_MESSAGES_BY_AI_ALIAS],
  method: Methods.POST,
