...
import { CHAT_THREADS_ACTIVE_TOTAL_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const ChatThreadsActiveTotalWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ChatThreadsActiveTotalWidget })),
);
...
const { POST } = createEndpoint({
  ...
  fields: customWidgetObject({
    render: ChatThreadsActiveTotalWidget,
    noFormElement: true,
