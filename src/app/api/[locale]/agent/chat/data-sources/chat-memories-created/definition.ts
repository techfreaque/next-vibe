/**
 * Chat Memories Created - Endpoint Definition
...
import { CHAT_MEMORIES_CREATED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "@/app/api/[locale]/system/unified-interface/unified-ui/widgets/_shared/lazy-widget";
const ChatMemoriesCreatedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ChatMemoriesCreatedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [CHAT_MEMORIES_CREATED_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: ChatMemoriesCreatedWidget,
    noFormElement: true,
