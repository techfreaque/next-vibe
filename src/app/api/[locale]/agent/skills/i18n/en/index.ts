export const translations = {
  id: {
    ...
    get: {
      ...
      addAnotherTooltip:
        "Add another instance of this skill to your collection",
      variants: {
        title: "Variants",
      },
    ...
    patch: {
      ...
      source: {
        label: "Source",
        description:
          "The source of this skill (built-in, custom, or community)",
      },
      modelSelection: {
      ...
      variants: {
        ...
        skillDefaultsHint:
          "Fallback when a variant doesn't configure a modality",
      },
      preferredModel: {
