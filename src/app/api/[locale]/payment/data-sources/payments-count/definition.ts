/**
 * Payments Count - Endpoint Definition
...
import { PAYMENTS_COUNT_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const PaymentsCountWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.PaymentsCountWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [PAYMENTS_COUNT_ALIAS],
  method: Methods.POST,
