/**
 * Payments Refund Volume - Endpoint Definition
...
import { PAYMENTS_REFUND_VOLUME_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const PaymentsRefundVolumeWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.PaymentsRefundVolumeWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [PAYMENTS_REFUND_VOLUME_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: PaymentsRefundVolumeWidget,
    noFormElement: true,
