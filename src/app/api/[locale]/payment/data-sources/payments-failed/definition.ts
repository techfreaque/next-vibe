/**
 * Payments Failed - Endpoint Definition
...
import { PAYMENTS_FAILED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "next-vibe-ui/unified/_shared/lazy-widget";
const PaymentsFailedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.PaymentsFailedWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [PAYMENTS_FAILED_ALIAS],
  method: Methods.POST,
