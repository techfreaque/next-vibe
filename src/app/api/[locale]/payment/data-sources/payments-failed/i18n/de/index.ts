...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Fehlgeschlagen", description: "Ausgabe-Zeitreihe" },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "Fehlgeschlagene Zahlungen berechnet",
      description: "Reihe fehlgeschlagener Zahlungen zurückgegeben",
    },
    errors: {
      unauthorized: {
