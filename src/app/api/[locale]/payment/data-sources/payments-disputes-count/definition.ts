/**
 * Payment Disputes Count - Endpoint Definition
...
import { PAYMENTS_DISPUTES_COUNT_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";

import { lazyWidget } from "next-vibe-ui/unified/_shared/lazy-widget";
const PaymentsDisputesCountWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.PaymentsDisputesCountWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [PAYMENTS_DISPUTES_COUNT_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: PaymentsDisputesCountWidget,
    noFormElement: true,
