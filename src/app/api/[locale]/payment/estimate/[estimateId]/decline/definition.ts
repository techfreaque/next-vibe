...
const EstimateDeclineWidgetLazy = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.EstimateDeclineWidget })),
);
...
const { POST } = createEndpoint({
  ...
  fields: customWidgetObject({
    render: EstimateDeclineWidgetLazy,
...
export type EstimateDeclineUrlPathParams = typeof POST.types.UrlVariablesOutput;
export type EstimateDeclineResponseOutput = typeof POST.types.ResponseOutput;
