...
const EstimateSendWidgetLazy = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.EstimateSendWidget })),
);
...
export type EstimateSendUrlPathParams = typeof POST.types.UrlVariablesOutput;
export type EstimateSendResponseOutput = typeof POST.types.ResponseOutput;
