...
export function BillApproveWidget(_props: {
  ...
  return (
    <Div className="flex flex-col gap-4">
      ...
      <Div className="rounded-md border border-amber-200 bg-amber-50/60 dark:border-amber-800 dark:bg-amber-900/10 px-4 py-3">
