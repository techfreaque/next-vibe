...
import { scopedTranslation } from "next-vibe/tooling/generators/endpoints-meta/i18n";
import {
  objectField,
  requestField,
  responseField,
...
const { POST } = createEndpoint({
  scopedTranslation,
  method: Methods.POST,
  path: ["system", "tooling", "generators", "endpoints-meta"],
  title: "post.title",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      outputDir: requestField(scopedTranslation, {
        ...
        columns: 12,
        schema: z.string().default("src/generated/endpoints-meta"),
      }),
      ...
      endpointsFound: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "post.fields.endpointsFound.title",
        schema: z.coerce.number(),
      }),
      filesWritten: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "post.fields.filesWritten.title",
        schema: z.coerce.number(),
      }),
