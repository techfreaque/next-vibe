...
import type { GeneratorsRouteHandlersT } from "next-vibe/tooling/generators/route-handlers/i18n";
...
export class RouteHandlersGeneratorRepository {
  static async generateRouteHandlers(
    ...
    try {
      ...
      const fixedPaths =
        await RouteHandlersGeneratorRepository.reconcileDefinitionPaths(
          validRouteFiles,
          data.dryRun,
        );
