...
import { scopedTranslation } from "next-vibe/tooling/generators/route-handlers/i18n";
import {
  objectField,
  requestField,
  responseField,
...
const { POST } = createEndpoint({
  scopedTranslation,
  method: Methods.POST,
  path: ["system", "tooling", "generators", "route-handlers"],
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      outputFile: requestField(scopedTranslation, {
        ...
        columns: 12,
        schema: z.string().default("src/generated/route-handlers.ts"),
      }),
      ...
      routesFound: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "post.fields.routesFound.title" as const,
