...
import { scopedTranslation } from "next-vibe/tooling/generators/skills-index/i18n";
import {
  objectField,
  requestField,
  responseField,
...
const { POST } = createEndpoint({
  scopedTranslation,
  method: Methods.POST,
  path: ["system", "tooling", "generators", "skills-index"],
  title: "post.title",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      outputFile: requestField(scopedTranslation, {
        ...
        columns: 12,
        schema: z.string().default("src/generated/skills-index.ts"),
      }),
      ...
      skillsFound: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "post.fields.skillsFound.title",
  ...
  examples: {
    ...
    responses: {
      default: {
        success: true,
        message: "Generated skills index with 53 skills in 120ms",
        skillsFound: 53,
        duration: 120,
      },
    },
...
const skillsIndexGeneratorEndpoints = { POST };
export default skillsIndexGeneratorEndpoints;
