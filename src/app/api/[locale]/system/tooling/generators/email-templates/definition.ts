...
import { scopedTranslation } from "next-vibe/tooling/generators/email-templates/i18n";
import {
  objectField,
  requestField,
  responseField,
...
const { POST } = createEndpoint({
  scopedTranslation,
  method: Methods.POST,
  path: ["system", "tooling", "generators", "email-templates"],
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      templatesFound: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        label: "post.fields.templatesFound.title" as const,
