...
const CronTasksContainer = lazyWidget(() =>
  import("next-vibe/tasks/cron/tasks/widget").then((m) => ({
    default: m.CronTasksContainer,
  })),
);
        ...
        child: objectField(scopedTranslation, {
          ...
          children: {
            ...
            runOnce: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "get.response.task.runOnce",
              schema: z.boolean(),
            }),
            notificationTargets: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "get.response.task.notificationTargets",
              schema: z
                .array(
                  z.object({
            ...
            targetInstance: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "get.response.task.targetInstance",
              schema: z.string().nullable(),
            }),
            tags: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "get.response.task.tags",
    ...
    children: {
      ...
      task: objectField(scopedTranslation, {
        ...
        children: {
          id: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.id",
            schema: z.string(),
          }),
          shortId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.shortId",
            schema: z.string(),
          }),
          routeId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.routeId",
            schema: z.string(),
          }),
          displayName: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.displayName",
            schema: z.string(),
          }),
          description: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.taskDescription",
            schema: z.string().nullable(),
          }),
          version: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.version",
            schema: z.string(),
          }),
          category: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.category",
            schema: z.enum(TaskCategoryDB),
          }),
          schedule: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.schedule",
            schema: z.string(),
          }),
          timezone: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.timezone",
            schema: z.string().nullable(),
          }),
          enabled: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.enabled",
            schema: z.boolean(),
          }),
          hidden: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.hidden",
            schema: z.boolean(),
          }),
          priority: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.priority",
            schema: z.enum(CronTaskPriorityDB),
          }),
          timeout: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.timeout",
            schema: z.number().nullable(),
          }),
          retries: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.retries",
            schema: z.number().nullable(),
          }),
          retryDelay: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.retryDelay",
            schema: z.number().nullable(),
          }),
          taskInput: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.taskInput",
            schema: taskInputSchema.optional().default({}),
          }),
          runOnce: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.runOnce",
            schema: z.boolean(),
          }),
          outputMode: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.outputMode",
            schema: z.enum(TaskOutputModeDB),
          }),
          notificationTargets: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.notificationTargets",
            schema: z
              .array(
                z.object({
                  type: z.enum(["email", "sms", "webhook"]),
          ...
          lastExecutedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.lastExecutedAt",
            schema: z.string().nullable(),
          }),
          lastExecutionStatus: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.lastExecutionStatus",
            schema: z.enum(CronTaskStatusDB).nullable(),
          }),
          lastExecutionError: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.lastExecutionError",
            schema: z.string().nullable(),
          }),
          lastExecutionDuration: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.lastExecutionDuration",
            schema: z.number().nullable(),
          }),
          nextExecutionAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.nextExecutionAt",
            schema: z.string().nullable(),
          }),
          executionCount: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.executionCount",
            schema: z.number(),
          }),
          successCount: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.successCount",
            schema: z.number(),
          }),
          errorCount: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.errorCount",
            schema: z.number(),
          }),
          averageExecutionTime: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.averageExecutionTime",
            schema: z.number().nullable(),
          }),
          consecutiveFailures: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.consecutiveFailures",
            schema: z.number(),
          }),
          targetInstance: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.targetInstance",
            schema: z.string().nullable(),
          }),
          tags: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.tags",
            schema: z.array(z.string()).optional().default([]),
          }),
          owner: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.owner",
            schema: taskOwnerSchema,
          }),
          createdAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.createdAt",
            schema: dateSchema,
          }),
          updatedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            label: "post.response.task.updatedAt",
            schema: dateSchema,
          }),
        },
      }),
