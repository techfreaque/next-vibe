/**
 * Date Range Field Widget - Platform-agnostic React implementation
 */
...
import type { DateRangeFieldWidgetConfig } from "./types";
...
export function DateRangeFieldWidget<
...
export default DateRangeFieldWidget;
