/**
 * Password Field Widget - Platform-agnostic React implementation
 */
...
import type { PasswordFieldWidgetConfig } from "./types";

export function PasswordFieldWidget<
...
export default PasswordFieldWidget;
