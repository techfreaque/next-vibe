...
const STAGE_DIR = "dist/electron-stage";
...
export async function electronBuildRepository(
  ...
  try {
    ...
    const platformFlags = PLATFORM_FLAG[data.platform] ?? "";
    const builderConfig = {
    ...
    output.push(`   ✅ Staged to ${STAGE_DIR}/`);
