...
import {
  GraphOwnerType,
  GraphResolution,
} from "next-vibe/core/utils/dataflow/enum";
...
export function GraphListContainer(): React.JSX.Element {
  ...
  const handleView = useCallback(
    (graph: GraphSummary): void => {
      void (async (): Promise<void> => {
        const dataDef =
          await import("next-vibe/core/utils/dataflow/graphs/[id]/data/definition");
  ...
  const handleCreate = useCallback((): void => {
    void (async (): Promise<void> => {
      const editDef =
        await import("next-vibe/core/utils/dataflow/graphs/[id]/edit/definition");
  ...
  const handleArchive = useCallback(
    (graph: GraphSummary): void => {
      void (async (): Promise<void> => {
        const archiveDef =
          await import("next-vibe/core/utils/dataflow/graphs/[id]/archive/definition");
