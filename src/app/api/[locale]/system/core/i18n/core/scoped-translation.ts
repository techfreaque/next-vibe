 ...
 *   en: enTranslations,
 *   de: () => require("next-vibe/ui/cli/ui/icons/src/app/api/[locale]/system/generated/endpoints-meta/de").translations,  // lazy - loaded on first DE request
 *   pl: () => require("next-vibe/ui/cli/ui/icons/src/app/api/[locale]/system/generated/endpoints-meta/pl").translations,  // lazy - loaded on first PL request
 * });
 *
 * // Usage:
