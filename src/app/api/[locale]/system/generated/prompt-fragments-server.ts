...
export async function loadAllPromptFragments(
  ...
  const [promptContextDataResult, cortexDataResult, favoritesDataResult, remoteInstancesDataResult, skillDataResult, tasksDataResult, webDataResult] = await Promise.allSettled([
