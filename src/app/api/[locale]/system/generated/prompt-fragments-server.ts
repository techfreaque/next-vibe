...
import { loadCodingAgentSettingData } from "@/app/api/[locale]/agent/chat/settings/system-prompt/server";
...
export async function loadAllPromptFragments(
  ...
  const codingAgentSettingBuilt = codingAgentSettingData && (codingAgentSettingFragment.condition ? codingAgentSettingFragment.condition(codingAgentSettingData) : true) ? codingAgentSettingFragment.build(codingAgentSettingData) : null;
  ...
  const sshConnectionsBuilt = remoteInstancesData && (sshConnectionsFragment.condition ? sshConnectionsFragment.condition(remoteInstancesData) : true) ? sshConnectionsFragment.build(remoteInstancesData) : null;
