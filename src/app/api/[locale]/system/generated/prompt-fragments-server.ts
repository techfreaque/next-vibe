...
export async function loadAllPromptFragments(
  ...
  const [promptContextDataResult, contactDataResult, cortexDataResult, favoritesDataResult, remoteInstancesDataResult, skillDataResult, webDataResult] = await Promise.allSettled([
