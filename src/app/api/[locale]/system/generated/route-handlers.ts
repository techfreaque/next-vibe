...
export async function getRouteHandler(
  ...
  switch (path) {
    ...
    case "system_unified-interface_vibe-sense_graphs_id_data_POST":
      return (
        await import("@/app/api/[locale]/system/unified-interface/vibe-sense/graphs/[id]/data/route")
      ).tools.POST as GenericHandlerBase;
    ...
    case "system_unified-interface_vibe-sense_registry_GET":
      return (
        await import("@/app/api/[locale]/system/unified-interface/vibe-sense/registry/route")
      ).tools.GET as GenericHandlerBase;
    case "t":
      return (
        await import("@/app/api/[locale]/system/check/testing/test/route")
