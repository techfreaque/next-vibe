...
export async function getRouteHandler(
  ...
  switch (path) {
    ...
    case "agent_chat_folders_id_move_PATCH":
      return (
        await import("@/app/api/[locale]/agent/chat/folders/[id]/move/route")
      ).tools.PATCH as GenericHandlerBase;
    ...
    case "agent_chat_folders_id_rename_PATCH":
      return (
        await import("@/app/api/[locale]/agent/chat/folders/[id]/rename/route")
      ).tools.PATCH as GenericHandlerBase;
    case "agent_chat_folders_id_update_PATCH":
      return (
        await import("@/app/api/[locale]/agent/chat/folders/[id]/update/route")
      ).tools.PATCH as GenericHandlerBase;
