...
export function useAllPromptFragments(
  ...
  const desktopData = useDesktopData(params);
  ...
  const desktopBuilt = desktopFragment.condition && !desktopFragment.condition(desktopData) ? null : desktopFragment.build(desktopData);
