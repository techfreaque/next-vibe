 ...
 *
 * Fragments found: 19
 * Fragment IDs: bootstrap, extra-instructions, favorites, folder-context, formatting, guest-context, headless-context, identity, language, media-capabilities, memories, message-metadata, platform-overview, remote-instances, skill, system-context, tasks, tool-execution-control, user-name
 */
