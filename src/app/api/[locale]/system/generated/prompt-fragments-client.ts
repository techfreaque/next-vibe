 ...
 *
 * Fragments found: 20
 * Fragment IDs: bootstrap, extra-instructions, favorites, folder-context, formatting, guest-context, headless-context, identity, language, media-capabilities, memories, message-metadata, platform-overview, remote-instances, skill, sub-agent-guard, system-context, tasks, tool-execution-control, user-name
 */
...
export function useAllPromptFragments(
  ...
  const memoriesBuilt = memoriesFragment.condition && !memoriesFragment.condition(memoriesData) ? null : memoriesFragment.build(memoriesData);
