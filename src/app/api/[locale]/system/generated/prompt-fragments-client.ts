...
export function useAllPromptFragments(
  ...
  const sshConnectionsBuilt = sshConnectionsFragment.condition && !sshConnectionsFragment.condition(remoteInstancesData) ? null : sshConnectionsFragment.build(remoteInstancesData);
