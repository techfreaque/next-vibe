...
export const endpointsMeta: EndpointMeta[] = [
  ...
  },
  {
    ...
    icon: "mouse-pointer",
    category: "Browser-Automatisierung",
  ...
  },
  {
    ...
    icon: "x-square",
    category: "Browser-Automatisierung",
    tags: ["Browser-Automatisierung", "Chrome DevTools"],
    examples: {
  ...
  },
  {
    ...
    icon: "upload",
    category: "Datenimport",
    tags: ["CSV", "Upload", "Batch-Verarbeitung"],
    examples: {
      inputs: {
        default: {
          fileUploadSection: {
