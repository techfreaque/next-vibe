...
export const aliasToPathMap = {
  ...
  "agent_ai-stream_stream_POST": "agent_ai-stream_stream_POST",
  ...
  agent_chat_folders_rootFolderId_create_POST:
    "agent_chat_folders_rootFolderId_create_POST",
  agent_chat_folders_rootFolderId_GET: "agent_chat_folders_rootFolderId_GET",
  ...
  agent_chat_memories_search_GET: "agent_chat_memories_search_GET",
  ...
  "agent-run": "agent_ai-stream_run_POST",
  "ai-run": "agent_ai-stream_run_POST",
  "ai-stream": "agent_ai-stream_stream_POST",
  ...
  "character-create": "agent_chat_characters_create_POST",
  "character-delete": "agent_chat_characters_id_DELETE",
  "character-get": "agent_chat_characters_id_GET",
  "character-update": "agent_chat_characters_id_PATCH",
  characters: "agent_chat_characters_GET",
  "chat-settings": "agent_chat_settings_GET",
  "chat-settings-update": "agent_chat_settings_POST",
  ...
  "complete-task": "system_unified-interface_tasks_complete-task_POST",
  ...
  "cron-create": "system_unified-interface_tasks_cron_tasks_POST",
  "cron-dashboard": "system_unified-interface_tasks_cron_dashboard_GET",
  "cron-delete": "system_unified-interface_tasks_cron_id_DELETE",
  "cron-get": "system_unified-interface_tasks_cron_id_GET",
  "cron-history": "system_unified-interface_tasks_cron_history_GET",
  "cron-list": "system_unified-interface_tasks_cron_tasks_GET",
  "cron-stats": "system_unified-interface_tasks_cron_stats_GET",
  "cron-tasks": "system_unified-interface_tasks_cron_tasks_GET",
  "cron-update": "system_unified-interface_tasks_cron_id_PUT",
  "cron:stats": "system_unified-interface_tasks_cron_stats_GET",
  "csv-import": "import_csv_POST",
  d: "system_server_dev_POST",
  "db-health": "system_unified-interface_tasks_db-health_POST",
  "db-migrate-tasks": "system_db_migrate_task-management_POST",
  "db-ping": "system_unified-interface_tasks_db-health_POST",
  ...
  electron: "system_server_electron_start_POST",
  "electron:build": "system_server_electron_build_POST",
  "electron:dev": "system_server_electron_start_POST",
  "electron:start": "system_server_electron_start_POST",
  elint: "system_check_lint_POST",
  "email-stats": "emails_messages_stats_GET",
  ...
  "error-monitor": "system_unified-interface_tasks_error-monitor_POST",
  ...
  "favorite-create": "agent_chat_favorites_create_POST",
  "favorite-delete": "agent_chat_favorites_id_DELETE",
  "favorite-get": "agent_chat_favorites_id_GET",
  "favorite-update": "agent_chat_favorites_id_PATCH",
  favorites: "agent_chat_favorites_GET",
  "favorites-reorder": "agent_chat_favorites_reorder_POST",
  ...
  "leads-list": "leads_list_GET",
  "leads-stats": "leads_stats_GET",
  lint: "system_check_oxlint_POST",
  list: "system_help_GET",
  login: "user_public_login_POST",
  ls: "system_help_GET",
  ...
  "memories-search": "agent_chat_memories_search_GET",
  ...
  "pulse-execute": "system_unified-interface_tasks_pulse_execute_POST",
  "pulse-history": "system_unified-interface_tasks_pulse_history_GET",
  "pulse-status": "system_unified-interface_tasks_pulse_status_GET",
  "pulse:execute": "system_unified-interface_tasks_pulse_execute_POST",
  "pulse:history": "system_unified-interface_tasks_pulse_history_GET",
  "pulse:status": "system_unified-interface_tasks_pulse_status_GET",
  rebuild: "system_server_rebuild_POST",
  "rebuild-and-restart": "system_server_rebuild_POST",
  "rebuild-restart": "system_server_rebuild_POST",
  "rebuild-server": "system_server_rebuild_POST",
  ...
  "referral-stats": "referral_stats_GET",
  ...
  "run-ai": "agent_ai-stream_run_POST",
  ...
  system_server_electron_build_POST: "system_server_electron_build_POST",
  system_server_electron_start_POST: "system_server_electron_start_POST",
  system_server_health_GET: "system_server_health_GET",
  system_server_rebuild_POST: "system_server_rebuild_POST",
  ...
  "system_unified-interface_mcp_serve_POST":
    "system_unified-interface_mcp_serve_POST",
  "system_unified-interface_tasks_complete-task_POST":
    "system_unified-interface_tasks_complete-task_POST",
  "system_unified-interface_tasks_cron_dashboard_GET":
    "system_unified-interface_tasks_cron_dashboard_GET",
  ...
  "system_unified-interface_tasks_error-monitor_cleanup_POST":
    "system_unified-interface_tasks_error-monitor_cleanup_POST",
  "system_unified-interface_tasks_error-monitor_POST":
    "system_unified-interface_tasks_error-monitor_POST",
  ...
  "system_unified-interface_tasks_unified-runner_POST":
    "system_unified-interface_tasks_unified-runner_POST",
  "system_unified-interface_vibe-frame_mount_GET":
    "system_unified-interface_vibe-frame_mount_GET",
  t: "system_check_test_POST",
  "task-dashboard": "system_unified-interface_tasks_cron_dashboard_GET",
  ...
  "user_remote-connection_connect_POST": "user_remote-connection_connect_POST",
  "user_remote-connection_disconnect_POST":
    "user_remote-connection_disconnect_POST",
  "user_remote-connection_GET": "user_remote-connection_GET",
  ...
  "users-list": "users_list_GET",
  "users-stats": "users_stats_GET",
...
export async function getEndpoint(
  ...
  switch (path) {
    ...
    case "system_unified-interface_vibe-frame_mount_GET":
      return (
    ...
    case "user_public_signup_POST":
      return (await import("@/app/api/[locale]/user/public/signup/definition"))
        .default.POST;
    case "user_remote-connection_GET":
      return (
        await import("@/app/api/[locale]/user/remote-connection/definition")
      ).default.GET;
    case "user_remote-connection_connect_POST":
      return (
        await import("@/app/api/[locale]/user/remote-connection/connect/definition")
      ).default.POST;
    case "user_remote-connection_disconnect_POST":
      return (
        await import("@/app/api/[locale]/user/remote-connection/disconnect/definition")
      ).default.POST;
