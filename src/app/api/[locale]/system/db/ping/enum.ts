 ...
 */
export const { enum: DbPingStatus, options: DbPingStatusOptions } = createEnumOptions({
 ...
 */
export const { enum: DbConnectionType, options: DbConnectionTypeOptions } = createEnumOptions({
