...
import type { StreamRelayPostBody } from "@/app/api/[locale]/system/unified-interface/websocket/remote-event-bridge/transport/stream-relay";
...
describe("StreamRelayResult", () => {
  it("has responseThreadId and messageId fields", async () => {
    ...
    const mod = await import("@/app/api/[locale]/system/unified-interface/websocket/remote-event-bridge/transport/stream-relay");
