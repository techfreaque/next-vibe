/**
 * Password Field Widget - CLI Ink implementation
 */
...
export function PasswordFieldWidgetInk<TKey extends string>({
  value,
  field,
  fieldName,
  context,
  ...
  PasswordFieldWidgetConfig<TKey, StringWidgetSchema, FieldUsageConfig>
>): JSX.Element {
  const { t } = context;
  const [inputValue, setInputValue] = useState(value ? String(value) : "");

  // Response mode - just display masked value
  if (context.response) {
