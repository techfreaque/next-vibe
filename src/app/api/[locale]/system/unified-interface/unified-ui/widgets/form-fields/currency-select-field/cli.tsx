/**
 * Currency Select Field Widget - CLI Ink implementation
 */
...
export function CurrencySelectFieldWidgetInk<
...
>({
  ...
  TEndpoint,
  CurrencySelectFieldWidgetConfig<TKey, StringWidgetSchema, FieldUsageConfig>
>): JSX.Element {
  const { t } = context;
