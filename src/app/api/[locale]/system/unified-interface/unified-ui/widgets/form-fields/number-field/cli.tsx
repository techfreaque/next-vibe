/**
 * Number Field Widget - CLI Ink implementation
 */
...
export function NumberFieldWidgetInk<TKey extends string>({
  value,
  field,
  fieldName,
  context,
  ...
  NumberFieldWidgetConfig<TKey, NumberWidgetSchema, FieldUsageConfig>
>): JSX.Element {
  const { t } = context;
