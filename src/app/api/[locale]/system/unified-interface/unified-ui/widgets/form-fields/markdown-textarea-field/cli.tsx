/**
 * Markdown Textarea Field Widget - CLI Ink implementation
 * Plain text input (same as textarea - markdown preview not applicable in CLI)
 */
...
export function MarkdownTextareaFieldWidgetInk<
...
>({
  ...
  TEndpoint,
  TUsage,
  MarkdownTextareaFieldWidgetConfig<TKey, StringWidgetSchema, TUsage>
>): JSX.Element {
...
export default MarkdownTextareaFieldWidgetInk;
