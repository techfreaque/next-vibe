/**
 * Color Field Widget - CLI Ink implementation
 */
...
export function ColorFieldWidgetInk<TKey extends string>({
  value,
  field,
  fieldName,
  context,
  ...
  ColorFieldWidgetConfig<TKey, StringWidgetSchema, FieldUsageConfig>
>): JSX.Element {
  const { t } = context;
