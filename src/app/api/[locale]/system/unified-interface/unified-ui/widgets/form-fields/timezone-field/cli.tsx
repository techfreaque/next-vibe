/**
 * Timezone Field Widget - CLI Ink implementation
 */
...
import type { TimezoneFieldWidgetConfig } from "./types";

export function TimezoneFieldWidgetInk<TKey extends string>({
  value,
  field,
  context,
}: InkWidgetProps<
