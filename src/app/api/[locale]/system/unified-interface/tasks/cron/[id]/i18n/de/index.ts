  ...
  get: {
    ...
    response: {
      task: {
        ...
        taskInput: "Aufgabeneingabe",
        runOnce: "Einmal ausführen",
        outputMode: "Ausgabemodus",
        notificationTargets: "Benachrichtigungsziele",
        lastExecutedAt: "Zuletzt ausgeführt am",
        lastExecutionStatus: "Letzter Ausführungsstatus",
        lastExecutionError: "Letzter Ausführungsfehler",
        lastExecutionDuration: "Letzte Ausführungsdauer (ms)",
        nextExecutionAt: "Nächste Ausführung am",
        executionCount: "Ausführungsanzahl",
        successCount: "Erfolge",
