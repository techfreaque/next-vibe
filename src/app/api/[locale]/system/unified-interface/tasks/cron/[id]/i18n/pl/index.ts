  ...
  get: {
    ...
    response: {
      task: {
        ...
        taskInput: "Dane wejściowe zadania",
        runOnce: "Uruchom raz",
        outputMode: "Tryb wyjścia",
        notificationTargets: "Cele powiadomień",
        lastExecutedAt: "Ostatnio wykonane o",
        lastExecutionStatus: "Ostatni status wykonania",
        lastExecutionError: "Ostatni błąd wykonania",
        lastExecutionDuration: "Ostatni czas wykonania (ms)",
        nextExecutionAt: "Następne wykonanie o",
        executionCount: "Liczba wykonań",
        successCount: "Liczba sukcesów",
        errorCount: "Liczba błędów",
        averageExecutionTime: "Średni czas wykonania (ms)",
        consecutiveFailures: "Kolejne niepowodzenia",
        targetInstance: "Docelowa instancja",
        tags: "Tagi",
        owner: "Właściciel",
        createdAt: "Utworzono",
