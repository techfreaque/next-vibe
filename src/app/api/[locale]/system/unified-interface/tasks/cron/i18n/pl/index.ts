...
export const translations: typeof enTranslations = {
  ...
  errors: {
    ...
    execution_update_failed: "Nie udało się zaktualizować wykonania zadania cron",
    ...
    recent_executions_fetch_failed: "Nie udało się pobrać ostatnich wykonań cron",
    schedules_fetch_failed: "Nie udało się pobrać harmonogramów zadań cron",
    schedule_update_failed: "Nie udało się zaktualizować harmonogramu zadania cron",
