...
import { tools as route55Tools } from "../../../generators/task-index/route";
import { tools as route56Tools } from "../../../generators/seeds/route";
import { tools as route57Tools } from "../../../generators/generate-trpc-router/validation/route";
import { tools as route58Tools } from "../../../../manifest/route";
import { tools as route59Tools } from "../../../../leads/lead/[id]/route";
import { tools as route60Tools } from "../../../../leads/tracking/engagement/route";
import { tools as route61Tools } from "../../../../leads/search/route";
import { tools as route62Tools } from "../../../../leads/campaigns/campaign-starter/campaign-starter-config/route";
import { tools as route63Tools } from "../../../../leads/campaigns/emails/test-mail/route";
import { tools as route64Tools } from "../../../../leads/list/route";
import { tools as route65Tools } from "../../../../leads/import/route";
import { tools as route66Tools } from "../../../../leads/export/route";
import { tools as route67Tools } from "../../../../leads/stats/route";
import { tools as route68Tools } from "../../../../leads/create/route";
import { tools as route69Tools } from "../../../../leads/batch/route";
import { tools as route70Tools } from "../../../../referral/earnings/list/route";
import { tools as route71Tools } from "../../../../referral/link-to-lead/route";
import { tools as route72Tools } from "../../../../referral/codes/list/route";
import { tools as route73Tools } from "../../../../referral/stats/route";
import { tools as route74Tools } from "../../../../users/user/[id]/route";
import { tools as route75Tools } from "../../../../users/list/route";
import { tools as route76Tools } from "../../../../users/stats/route";
import { tools as route77Tools } from "../../../../users/create/route";
import { tools as route78Tools } from "../../../../user/private/logout/route";
import { tools as route79Tools } from "../../../../user/private/me/route";
import { tools as route80Tools } from "../../../../user/public/login/options/route";
import { tools as route81Tools } from "../../../../user/public/signup/route";
import { tools as route82Tools } from "../../../../user/public/reset-password/validate/route";
import { tools as route83Tools } from "../../../../user/public/reset-password/request/route";
import { tools as route84Tools } from "../../../../user/public/reset-password/confirm/route";
import { tools as route85Tools } from "../../../../user/search/route";
import { tools as route86Tools } from "../../../../user/auth/check/route";
import { tools as route87Tools } from "../../../../subscription/route";
import { tools as route88Tools } from "../../../../payment/portal/route";
import { tools as route89Tools } from "../../../../payment/invoice/route";
import { tools as route90Tools } from "../../../../payment/providers/stripe/cli/route";
import { tools as route91Tools } from "../../../../payment/providers/nowpayments/cli/route";
import { tools as route92Tools } from "../../../../payment/checkout/route";
import { tools as route93Tools } from "../../../../payment/refund/route";
import { tools as route94Tools } from "../../../../credits/history/route";
import { tools as route95Tools } from "../../../../credits/purchase/route";
import { tools as route96Tools } from "../../../../contact/route";
import { tools as route97Tools } from "../../../../emails/smtp-client/list/route";
import { tools as route98Tools } from "../../../../emails/smtp-client/edit/[id]/route";
import { tools as route99Tools } from "../../../../emails/smtp-client/create/route";
import { tools as route100Tools } from "../../../../emails/send/route";
import { tools as route101Tools } from "../../../../emails/messages/[id]/route";
import { tools as route102Tools } from "../../../../emails/imap-client/messages/[id]/route";
import { tools as route103Tools } from "../../../../emails/imap-client/folders/list/route";
import { tools as route104Tools } from "../../../../emails/imap-client/folders/sync/route";
import { tools as route105Tools } from "../../../../emails/imap-client/config/route";
import { tools as route106Tools } from "../../../../emails/imap-client/health/route";
import { tools as route107Tools } from "../../../../emails/imap-client/sync/route";
import { tools as route108Tools } from "../../../../emails/imap-client/accounts/[id]/route";
import { tools as route109Tools } from "../../../../import/route";
import { tools as route110Tools } from "../../../../newsletter/unsubscribe/route";
import { tools as route111Tools } from "../../../../newsletter/subscribe/route";
import { tools as route112Tools } from "../../../../newsletter/status/route";
import { tools as route113Tools } from "../../../../browser/performance-analyze-insight/route";
import { tools as route114Tools } from "../../../../browser/get-console-message/route";
import { tools as route115Tools } from "../../../../browser/new-page/route";
import { tools as route116Tools } from "../../../../browser/take-snapshot/route";
import { tools as route117Tools } from "../../../../browser/drag/route";
import { tools as route118Tools } from "../../../../browser/get-network-request/route";
import { tools as route119Tools } from "../../../../browser/list-pages/route";
import { tools as route120Tools } from "../../../../browser/close-page/route";
import { tools as route121Tools } from "../../../../browser/resize-page/route";
import { tools as route122Tools } from "../../../../browser/fill/route";
import { tools as route123Tools } from "../../../../browser/hover/route";
import { tools as route124Tools } from "../../../../browser/upload-file/route";
import { tools as route125Tools } from "../../../../browser/handle-dialog/route";
import { tools as route126Tools } from "../../../../browser/select-page/route";
import { tools as route127Tools } from "../../../../browser/navigate-page/route";
import { tools as route128Tools } from "../../../../browser/press-key/route";
import { tools as route129Tools } from "../../../../browser/fill-form/route";
import { tools as route130Tools } from "../../../../browser/performance-stop-trace/route";
import { tools as route131Tools } from "../../../../browser/performance-start-trace/route";
import { tools as route132Tools } from "../../../../browser/emulate/route";
import { tools as route133Tools } from "../../../../browser/take-screenshot/route";
import { tools as route134Tools } from "../../../../browser/list-network-requests/route";
import { tools as route135Tools } from "../../../../browser/evaluate-script/route";
import { tools as route136Tools } from "../../../../browser/list-console-messages/route";
import { tools as route137Tools } from "../../../../browser/wait-for/route";
import { tools as route138Tools } from "../../../../browser/click/route";
...
export const appRouter = router({
  ...
  system: router({
    ...
    generators: router({
      ...
      "task-index": router({ ...route55 }),
      seeds: router({ ...route56 }),
      "generate-trpc-router": router({
        validation: router({ ...route57 }),
      }),
    }),
  }),
  manifest: router({ ...route58 }),
  leads: router({
    lead: router({ ...route59 }),
    tracking: router({
      engagement: router({ ...route60 }),
    }),
    search: router({ ...route61 }),
    campaigns: router({
      "campaign-starter": router({
        "campaign-starter-config": router({ ...route62 }),
      }),
      emails: router({
        "test-mail": router({ ...route63 }),
      }),
    }),
    list: router({ ...route64 }),
    import: router({ ...route65 }),
    export: router({ ...route66 }),
    stats: router({ ...route67 }),
    create: router({ ...route68 }),
    batch: router({ ...route69 }),
  }),
  referral: router({
    earnings: router({
      list: router({ ...route70 }),
    }),
    "link-to-lead": router({ ...route71 }),
    codes: router({
      list: router({ ...route72 }),
    }),
  ...
  users: router({
    user: router({ ...route74 }),
    list: router({ ...route75 }),
    stats: router({ ...route76 }),
    create: router({ ...route77 }),
  }),
  user: router({
    private: router({
      logout: router({ ...route78 }),
      me: router({ ...route79 }),
    }),
    public: router({
      login: router({
        options: router({ ...route80 }),
      }),
      signup: router({ ...route81 }),
      "reset-password": router({
        validate: router({ ...route82 }),
        request: router({ ...route83 }),
        confirm: router({ ...route84 }),
      }),
    }),
    search: router({ ...route85 }),
    auth: router({
      check: router({ ...route86 }),
    }),
  }),
  subscription: router({ ...route87 }),
  payment: router({
    portal: router({ ...route88 }),
    invoice: router({ ...route89 }),
    providers: router({
      stripe: router({
        cli: router({ ...route90 }),
      }),
    ...
    checkout: router({ ...route92 }),
    refund: router({ ...route93 }),
  }),
  credits: router({
    history: router({ ...route94 }),
    purchase: router({ ...route95 }),
  }),
  contact: router({ ...route96 }),
  emails: router({
    "smtp-client": router({
      list: router({ ...route97 }),
      edit: router({ ...route98 }),
    ...
    send: router({ ...route100 }),
    messages: router({ ...route101 }),
    "imap-client": router({
      messages: router({ ...route102 }),
      folders: router({
        list: router({ ...route103 }),
        sync: router({ ...route104 }),
      }),
      config: router({ ...route105 }),
      health: router({ ...route106 }),
      sync: router({ ...route107 }),
      accounts: router({ ...route108 }),
    }),
  }),
  import: router({ ...route109 }),
  newsletter: router({
    unsubscribe: router({ ...route110 }),
    subscribe: router({ ...route111 }),
    status: router({ ...route112 }),
  }),
  browser: router({
    "performance-analyze-insight": router({ ...route113 }),
    "get-console-message": router({ ...route114 }),
    "new-page": router({ ...route115 }),
    "take-snapshot": router({ ...route116 }),
    drag: router({ ...route117 }),
    "get-network-request": router({ ...route118 }),
    "list-pages": router({ ...route119 }),
    "close-page": router({ ...route120 }),
    "resize-page": router({ ...route121 }),
    fill: router({ ...route122 }),
    hover: router({ ...route123 }),
    "upload-file": router({ ...route124 }),
    "handle-dialog": router({ ...route125 }),
    "select-page": router({ ...route126 }),
    "navigate-page": router({ ...route127 }),
    "press-key": router({ ...route128 }),
    "fill-form": router({ ...route129 }),
    "performance-stop-trace": router({ ...route130 }),
    "performance-start-trace": router({ ...route131 }),
    emulate: router({ ...route132 }),
    "take-screenshot": router({ ...route133 }),
    "list-network-requests": router({ ...route134 }),
    "evaluate-script": router({ ...route135 }),
    "list-console-messages": router({ ...route136 }),
    "wait-for": router({ ...route137 }),
    click: router({ ...route138 }),
  }),
});
