...
const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      outputFile: requestField(scopedTranslation, {
        ...
        schema: z
          .string()
          .default("src/app/api/[locale]/system/generated/skills-index.ts"),
      }),
      ...
      skillsFound: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        content: "post.fields.skillsFound.title",
  ...
  examples: {
    requests: {
      default: {
        outputFile: "src/app/api/[locale]/system/generated/skills-index.ts",
        dryRun: false,
      },
    },
    responses: {
