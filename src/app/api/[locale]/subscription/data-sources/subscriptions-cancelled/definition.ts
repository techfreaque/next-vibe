/**
 * Subscriptions Cancelled - Endpoint Definition
...
import { SUBSCRIPTIONS_CANCELLED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const SubscriptionsCancelledWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.SubscriptionsCancelledWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [SUBSCRIPTIONS_CANCELLED_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: SubscriptionsCancelledWidget,
    noFormElement: true,
