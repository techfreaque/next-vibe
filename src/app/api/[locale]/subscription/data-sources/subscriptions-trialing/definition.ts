/**
 * Subscriptions Trialing - Endpoint Definition
...
import { SUBSCRIPTIONS_TRIALING_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const SubscriptionsTrialingWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.SubscriptionsTrialingWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [SUBSCRIPTIONS_TRIALING_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: SubscriptionsTrialingWidget,
    noFormElement: true,
