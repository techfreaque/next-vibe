/**
 * Subscriptions Trialing — Repository
 * Server-only. DB access.
 * Snapshot: count of trialing subscriptions per resolution bucket.
 */
...
export class QuerySubscriptionsTrialingRepository {
  static async querySubscriptionsTrialing(data: {
