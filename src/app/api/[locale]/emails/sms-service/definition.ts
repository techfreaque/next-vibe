...
const { POST } = createEndpoint({
  ...
  fields: objectField(
    {
      ...
      title: "app.api.emails.smsService.send.container.title",
      description: "app.api.emails.smsService.send.container.description",
      ...
      to: requestDataField(
        {
          ...
          label: "app.api.emails.smsService.send.to.label",
          description: "app.api.emails.smsService.send.to.description",
          placeholder: "app.api.emails.smsService.send.to.placeholder",
          columns: 6,
        },
        z.string().min(1),
      ),
      ...
      message: requestDataField(
        {
          ...
          label: "app.api.emails.smsService.send.message.label",
          description: "app.api.emails.smsService.send.message.description",
          placeholder: "app.api.emails.smsService.send.message.placeholder",
          columns: 12,
        },
      ...
      leadId: requestDataField(
        {
          ...
          label: "app.api.emails.smsService.send.leadId.label",
          description: "app.api.emails.smsService.send.leadId.description",
          placeholder: "app.api.emails.smsService.send.leadId.placeholder",
          columns: 6,
        },
        z.string().optional(),
      ),
      ...
      result: objectField(
        ...
        { response: true },
        {
          success: responseField(
            {
              ...
              text: "app.api.emails.smsService.send.response.result.success",
            },
            z.boolean(),
          ),
          ...
          sentAt: responseField(
            {
              type: WidgetType.TEXT,
              content: "app.api.emails.smsService.send.response.result.sentAt",
            },
            z.string(),
          ),
  ...
  errorTypes: {
    ...
    [EndpointErrorTypes.CONFLICT]: {
      ...
      description: "app.api.emails.smsService.send.errors.conflict.description",
    },
    [EndpointErrorTypes.NOT_FOUND]: {
      title: "app.api.emails.smsService.send.errors.notFound.title",
      description: "app.api.emails.smsService.send.errors.notFound.description",
    },
    [EndpointErrorTypes.NETWORK_ERROR]: {
      title: "app.api.emails.smsService.send.errors.network.title",
      description: "app.api.emails.smsService.send.errors.network.description",
    },
    [EndpointErrorTypes.SERVER_ERROR]: {
      title: "app.api.emails.smsService.send.errors.server.title",
      description: "app.api.emails.smsService.send.errors.server.description",
    },
    [EndpointErrorTypes.UNKNOWN_ERROR]: {
      title: "app.api.emails.smsService.send.errors.unknown.title",
      description: "app.api.emails.smsService.send.errors.unknown.description",
    },
  ...
  // === SUCCESS HANDLING ===
  successTypes: {
    title: "app.api.emails.smsService.send.success.title",
    description: "app.api.emails.smsService.send.success.description",
  },
