...
export const translations: typeof enTranslations = {
  ...
  enums: {
    sortField: {
      ...
      priority: "Priorytet",
      totalEmailsSent: "Wysłane e-maile",
      lastUsedAt: "Ostatnio używano",
    },
    ...
    healthStatusFilter: { all: "Wszystkie statusy zdrowia" },
    campaignType: {
    ...
    campaignTypeFilter: { all: "Wszystkie typy kampanii" },
  },
};
