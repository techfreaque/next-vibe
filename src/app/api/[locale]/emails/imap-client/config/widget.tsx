        ...
        <Div className="p-4 flex flex-col gap-6">
          ...
          <Div className="flex flex-col gap-3">
            <Span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              {t("app.api.emails.imapClient.config.connection")}
            </Span>
            <TextFieldWidget
          ...
          <Div className="flex flex-col gap-3">
            <Span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              {t("app.api.emails.imapClient.config.server")}
            </Span>
            <Div className="grid grid-cols-2 gap-3">
              <BooleanFieldWidget
          ...
          <Div className="flex flex-col gap-3">
            <Span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              {t("app.api.emails.imapClient.config.sync")}
            </Span>
            <Div className="grid grid-cols-2 gap-3">
              <BooleanFieldWidget
          ...
          <Div className="flex flex-col gap-3">
            <Span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              {t("app.api.emails.imapClient.config.resilience")}
            </Span>
            <Div className="grid grid-cols-2 gap-3">
              <NumberFieldWidget
          ...
          <Div className="flex flex-col gap-3">
            <Span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              {t("app.api.emails.imapClient.config.monitoring")}
            </Span>
            <Div className="grid grid-cols-2 gap-3">
              <BooleanFieldWidget
          ...
          <Div className="flex items-center justify-end pt-2">
            <SubmitButtonWidget
              field={{
                text: "app.api.emails.imapClient.config.submit",
                loadingText: "app.api.emails.imapClient.config.submitting",
                icon: "save",
                variant: "primary",
                size: "sm",
              }}
