  ...
  get: {
    ...
    response: {
      ...
      organizations: {
        ...
        allowDisablePrivateAccess: "Allow Disable Private",
        hostname: "Hostname",
        hostnameAllowed: "Hostname Allowed",
        vpnPairingMode: "VPN Mode",
        vpnOtpRequired: "VPN OTP",
        ipAddressesWhitelist: "IP Whitelist",
        userCanAccess: "User Access",
        storeEnabled: "Store",
        dataTemporarilyDisabled: "Data Paused",
        mfaRequired: "MFA",
      },
      total: "Total",
      totalPages: "Pages",
    ...
    widget: {
      ...
      noOrgsHint: "No organizations are registered on this tenant.",
