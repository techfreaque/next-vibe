export const translations = {
  ...
  post: {
    title: "Przywróć tagi urządzenia",
    description: "Przywraca wcześniej usunięte dane tagów urządzenia Corvina.",
    orgId: {
    ...
    since: {
      label: "Od",
      description:
        "Początek zakresu czasu do przywrócenia (ISO 8601 lub znacznik czasu).",
      placeholder: "2024-01-01T00:00:00Z",
    },
    to: {
      label: "Do",
      description:
        "Koniec zakresu czasu do przywrócenia (ISO 8601 lub znacznik czasu).",
    ...
    response: {
      undeletedCount: "Liczba przywróconych",
    },
    widget: {
      title: "Tagi przywrócone",
      restoredMessage: "przywrócono",
    },
    errors: {
      validation: {
      ...
      forbidden: {
        title: "Zabroniony",
        description: "Brak dostępu do przywracania danych urządzenia.",
      },
      notFound: {
    ...
    success: { title: "Sukces", description: "Dane tagów przywrócone." },
  },
};
