export const translations = {
  ...
  get: {
    title: "Gerätekonfiguration abrufen",
    description: "Lädt die vollständige Konfiguration eines Geräts als JSON.",
    orgId: {
    ...
    errors: {
      ...
      forbidden: {
        ...
        description: "Kein Zugriff auf Gerätekonfiguration.",
      },
      notFound: {
    ...
    success: {
      title: "Erfolg",
      description: "Gerätekonfiguration erfolgreich geladen.",
    },
  },
};
