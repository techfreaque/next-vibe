...
const { GET } = createEndpoint({
  ...
  fields: customWidgetObject({
    render: DeviceConfigurationContainer,
    ...
    children: {
      ...
      configJson: responseField(scopedTranslation, {
        ...
        content: "get.response.configJson" as const,
        schema: z.string(),
      }),
    },
  }),
...
export type DeviceConfigurationUrlVariablesOutput =
  typeof GET.types.UrlVariablesOutput;
export type DeviceConfigurationResponseOutput = typeof GET.types.ResponseOutput;
