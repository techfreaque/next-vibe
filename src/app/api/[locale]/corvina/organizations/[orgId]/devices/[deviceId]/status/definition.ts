...
const DeviceStatusContainer = lazyWidget(() =>
  import("./widget.cli").then((m) => ({ default: m.DeviceStatusContainer })),
);
  ...
  fields: customWidgetObject({
    ...
    children: {
      ...
      ipAddress: responseField(scopedTranslation, {
        type: WidgetType.TEXT,
        content: "get.response.ipAddress" as const,
...
export type DeviceStatusUrlVariablesOutput =
  typeof GET.types.UrlVariablesOutput;
export type DeviceStatusResponseOutput = typeof GET.types.ResponseOutput;
