...
const { GET } = createEndpoint({
        ...
        child: objectField(scopedTranslation, {
          ...
          children: {
            ...
            type: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "get.response.tags.type" as const,
              schema: z.string(),
            }),
          },
        }),
  ...
  examples: {
    ...
    responses: {
      default: {
        tags: [
          { name: "Test_Model:1/Codesys_Heartbeat", type: "integer" },
          { name: "Test_Model:1/Temperature", type: "float" },
        ],
      },
    },
  },
...
export type AvailableTagsUrlVariablesOutput =
  typeof GET.types.UrlVariablesOutput;
export type AvailableTagsResponseOutput = typeof GET.types.ResponseOutput;
