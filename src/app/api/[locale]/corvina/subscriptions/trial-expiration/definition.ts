...
const SubscriptionsTrialExpirationContainer = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.SubscriptionsTrialExpirationContainer,
  })),
);
...
const { GET } = createEndpoint({
  scopedTranslation,
  method: Methods.GET,
  path: ["corvina", "subscriptions", "trial-expiration"],
  ...
  aliases: ["corvina_subscriptions_trial_expiration"],

  fields: customWidgetObject({
    render: SubscriptionsTrialExpirationContainer,
...
export type SubscriptionsTrialExpirationRequestOutput =
  typeof GET.types.RequestOutput;
export type SubscriptionsTrialExpirationResponseOutput =
