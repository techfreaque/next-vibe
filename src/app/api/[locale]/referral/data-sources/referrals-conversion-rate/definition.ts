/**
 * Referral Conversion Rate - Endpoint Definition
...
import { REFERRALS_CONVERSION_RATE_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const ReferralsConversionRateWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.ReferralsConversionRateWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [REFERRALS_CONVERSION_RATE_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: ReferralsConversionRateWidget,
    noFormElement: true,
