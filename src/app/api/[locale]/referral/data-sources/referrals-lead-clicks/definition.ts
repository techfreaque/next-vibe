/**
 * Referral Lead Clicks - Endpoint Definition
...
import { REFERRALS_LEAD_CLICKS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const ReferralsLeadClicksWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ReferralsLeadClicksWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [REFERRALS_LEAD_CLICKS_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: ReferralsLeadClicksWidget,
    noFormElement: true,
