/**
 * Referral Earnings Volume - Endpoint Definition
...
import { REFERRALS_EARNINGS_VOLUME_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const ReferralsEarningsVolumeWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.ReferralsEarningsVolumeWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [REFERRALS_EARNINGS_VOLUME_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: ReferralsEarningsVolumeWidget,
    noFormElement: true,
