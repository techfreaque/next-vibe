/**
 * Referral Payouts - Endpoint Definition
...
import { REFERRALS_PAYOUTS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const ReferralsPayoutsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.ReferralsPayoutsWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [REFERRALS_PAYOUTS_ALIAS],
  method: Methods.POST,
