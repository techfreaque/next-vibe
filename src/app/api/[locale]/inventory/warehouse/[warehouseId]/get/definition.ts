...
import listDef0 from "@/app/api/[locale]/inventory/warehouse/list/definition";
      ...
      result: objectField(scopedTranslation, {
        ...
        children: {
          id: responseField(scopedTranslation, {
            ...
            content: "warehouseGet.get.response.id" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          companyId: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.companyId" as const,
            hidden: true,
            schema: z.uuid(),
          }),
          name: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.name" as const,
            schema: z.string(),
          }),
          code: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.code" as const,
            schema: z.string(),
          }),
          address: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.address" as const,
            schema: z.string().nullable(),
          }),
          isActive: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.isActive" as const,
            schema: z.boolean(),
          }),
          isDefault: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.isDefault" as const,
            schema: z.boolean(),
          }),
          createdAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.createdAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
          updatedAt: responseField(scopedTranslation, {
            type: WidgetType.TEXT,
            content: "warehouseGet.get.response.updatedAt" as const,
            fieldType: FieldDataType.DATETIME,
            schema: z.coerce.date(),
          }),
        },
