  ...
  fields: customWidgetObject({
    ...
    children: {
      ...
      productId: requestField(scopedTranslation, {
        ...
        schema: z.uuid().optional(),
        listEndpoint: catalogListDef.GET,
        labelField: "name",
      }),
        ...
        child: objectField(scopedTranslation, {
          ...
          children: {
            id: responseField(scopedTranslation, {
              ...
              content: "stockList.get.response.id",
              hidden: true,
              schema: z.uuid(),
            }),
            warehouseId: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.warehouseId",
              hidden: true,
              schema: z.uuid(),
            }),
            productId: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.productId",
              schema: z.uuid(),
            }),
            productName: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.productName",
              schema: z.string().nullable(),
            }),
            warehouseName: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.warehouseName",
              schema: z.string().nullable(),
            }),
            quantityOnHand: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.quantityOnHand",
              schema: z.number(),
            }),
            quantityReserved: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.quantityReserved",
              schema: z.number(),
            }),
            quantityOnOrder: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.quantityOnOrder",
              schema: z.number(),
            }),
            quantityAvailable: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.quantityAvailable",
              schema: z.number(),
            }),
            reorderPoint: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.reorderPoint",
              schema: z.number().nullable(),
            }),
            unitCost: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.unitCost",
              schema: z.number().nullable(),
            }),
            isLowStock: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.isLowStock",
              schema: z.boolean(),
            }),
            updatedAt: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              content: "stockList.get.response.updatedAt",
