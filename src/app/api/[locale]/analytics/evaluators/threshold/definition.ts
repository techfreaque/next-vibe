...
const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [EVALUATOR_THRESHOLD_ALIAS],
  method: Methods.POST,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      op: requestField(scopedTranslation, {
      ...
      value: requestField(scopedTranslation, {
        ...
        label: "post.fields.value.label",
        description: "post.fields.value.description",
        schema: z.number(),
        columns: 6,
      }),
  ...
  examples: {
    requests: {
      default: {
        source: [
          { timestamp: new Date("2024-01-01"), value: 105 },
          { timestamp: new Date("2024-01-02"), value: 98 },
