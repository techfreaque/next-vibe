/**
 * Vibe Sense - RSI (Relative Strength Index) Endpoint Definition
 *
...
import { RSI_ALIAS } from "./constants";
...
const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      period: requestField(scopedTranslation, {
        ...
        schema: z.number().int().min(2).max(100).default(14),
        columns: 6,
      }),
  ...
  examples: {
    requests: {
      default: {
        source: [
          ...
          { timestamp: new Date("2024-01-02"), value: 43 },
          { timestamp: new Date("2024-01-03"), value: 45 },
        ],
        range: {
    ...
    responses: {
      default: {
        result: [{ timestamp: new Date("2024-01-03"), value: 66.67 }],
