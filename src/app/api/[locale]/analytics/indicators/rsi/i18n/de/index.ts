...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      period: {
        label: "Periode",
        description: "Anzahl der Perioden (2–100)",
      },
      result: { label: "RSI", description: "Ausgabe-Zeitreihe" },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "RSI berechnet",
      description: "RSI-Reihe zurückgegeben",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Serverfehler",
        description: "RSI-Berechnung fehlgeschlagen",
      },
      unknown: {
