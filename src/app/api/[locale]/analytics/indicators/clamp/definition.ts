/**
 * Vibe Sense - Clamp Endpoint Definition
 *
...
import { CLAMP_ALIAS } from "./constants";
...
const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      min: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.NUMBER,
        label: "post.fields.min.label",
        description: "post.fields.min.description",
        schema: z.number(),
        columns: 6,
      }),
      max: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.NUMBER,
        label: "post.fields.max.label",
        description: "post.fields.max.description",
        schema: z.number(),
        columns: 6,
      }),
    ...
    responses: {
      default: {
        result: [
          ...
          { timestamp: new Date("2024-01-03"), value: 0 },
        ],
