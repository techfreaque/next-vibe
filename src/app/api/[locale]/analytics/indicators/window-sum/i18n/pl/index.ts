...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Suma okna", description: "Wyjściowa seria czasowa" },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Suma okna obliczona",
      description: "Seria sumy okna zwrócona",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Błąd serwera",
        description: "Obliczenie sumy okna nie powiodło się",
      },
      unknown: {
        title: "Nieznany błąd",
