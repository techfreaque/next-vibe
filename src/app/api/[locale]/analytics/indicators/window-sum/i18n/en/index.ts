export const translations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Window Sum", description: "Output time series" },
      meta: { label: "Meta", description: "Node execution metadata" },
    },
    success: {
      title: "Window Sum computed",
      description: "Window sum series returned",
    },
    errors: {
      unauthorized: {
        title: "Unauthorized",
      ...
      server: {
        title: "Server error",
        description: "Window Sum computation failed",
      },
      unknown: {
        title: "Unknown error",
