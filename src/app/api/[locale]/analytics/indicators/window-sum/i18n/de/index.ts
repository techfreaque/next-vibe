...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Fenstersumme", description: "Ausgabe-Zeitreihe" },
      meta: { label: "Meta", description: "Knotenausführungsmetadaten" },
    },
    success: {
      title: "Fenstersumme berechnet",
      description: "Fenstersummen-Reihe zurückgegeben",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Serverfehler",
        description: "Fenstersummen-Berechnung fehlgeschlagen",
      },
      unknown: {
