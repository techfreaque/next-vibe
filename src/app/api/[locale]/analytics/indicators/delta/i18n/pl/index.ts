...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Delta", description: "Wyjściowa seria czasowa" },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Delta obliczona",
      description: "Seria delta zwrócona",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Błąd serwera",
        description: "Obliczenie delta nie powiodło się",
      },
      unknown: {
        title: "Nieznany błąd",
