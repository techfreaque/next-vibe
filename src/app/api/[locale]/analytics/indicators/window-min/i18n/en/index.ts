export const translations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Window Min", description: "Output time series" },
      meta: { label: "Meta", description: "Node execution metadata" },
    },
    success: {
      title: "Window Min computed",
      description: "Window minimum series returned",
    },
    errors: {
      unauthorized: {
        title: "Unauthorized",
      ...
      server: {
        title: "Server error",
        description: "Window Min computation failed",
      },
      unknown: {
        title: "Unknown error",
