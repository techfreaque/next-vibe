...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Minimum okna", description: "Wyjściowa seria czasowa" },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Minimum okna obliczone",
      description: "Seria minimum okna zwrócona",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Błąd serwera",
        description: "Obliczenie minimum okna nie powiodło się",
      },
      unknown: {
        title: "Nieznany błąd",
