...
export const translations: typeof enTranslations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Średnia okna", description: "Wyjściowa seria czasowa" },
      meta: { label: "Meta", description: "Metadane wykonania węzła" },
    },
    success: {
      title: "Średnia okna obliczona",
      description: "Seria średniej okna zwrócona",
    },
    errors: {
      unauthorized: {
      ...
      server: {
        title: "Błąd serwera",
        description: "Obliczenie średniej okna nie powiodło się",
      },
      unknown: {
        title: "Nieznany błąd",
