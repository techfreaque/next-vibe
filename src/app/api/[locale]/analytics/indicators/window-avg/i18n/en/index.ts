export const translations = {
  ...
  post: {
    ...
    fields: {
      ...
      result: { label: "Window Avg", description: "Output time series" },
      meta: { label: "Meta", description: "Node execution metadata" },
    },
    success: {
      title: "Window Avg computed",
      description: "Window average series returned",
    },
    errors: {
      unauthorized: {
        title: "Unauthorized",
      ...
      server: {
        title: "Server error",
        description: "Window Avg computation failed",
      },
      unknown: {
        title: "Unknown error",
