export const translations = {
  ...
  post: {
    ...
    fields: {
      ...
      period: {
        label: "Period",
        description: "Number of periods (1–500)",
      },
      result: { label: "EMA", description: "Output time series" },
      meta: { label: "Meta", description: "Node execution metadata" },
    },
    success: {
      title: "EMA computed",
      description: "EMA series returned",
    },
    errors: {
      unauthorized: {
        title: "Unauthorized",
      ...
      server: { title: "Server error", description: "EMA computation failed" },
      unknown: {
        title: "Unknown error",
