...
export const { POST } = createEndpoint({
  ...
  title: "providers.sailthru.title" as const,
  description: "providers.sailthru.description" as const,
  icon: "mail",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      sailthruApiKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
        label: "providers.sailthru.sailthruApiKey.label" as const,
        description: "providers.sailthru.sailthruApiKey.description" as const,
        placeholder: "providers.sailthru.sailthruApiKey.placeholder" as const,
        schema: z.string().min(1),
      }),
      sailthruSecret: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
        label: "providers.sailthru.sailthruSecret.label" as const,
        description: "providers.sailthru.sailthruSecret.description" as const,
        placeholder: "providers.sailthru.sailthruSecret.placeholder" as const,
        schema: z.string().min(1),
      }),
      listName: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.sailthru.listName.label" as const,
        description: "providers.sailthru.listName.description" as const,
        placeholder: "providers.sailthru.listName.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const sailthruEndpoints = { POST } as const;
export default sailthruEndpoints;
export type SailthruConfigPostRequestOutput = typeof POST.types.RequestOutput;
