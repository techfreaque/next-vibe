...
export const { POST } = createEndpoint({
  ...
  title: "providers.shopify.title" as const,
  description: "providers.shopify.description" as const,
  icon: "mail",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      shopifyDomain: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.shopify.shopifyDomain.label" as const,
        description: "providers.shopify.shopifyDomain.description" as const,
        placeholder: "providers.shopify.shopifyDomain.placeholder" as const,
        schema: z.string().min(1),
      }),
      shopifyAccessToken: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
        label: "providers.shopify.shopifyAccessToken.label" as const,
        description:
          "providers.shopify.shopifyAccessToken.description" as const,
        placeholder:
          "providers.shopify.shopifyAccessToken.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const shopifyEndpoints = { POST } as const;
export default shopifyEndpoints;
export type ShopifyConfigPostRequestOutput = typeof POST.types.RequestOutput;
