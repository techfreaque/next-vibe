...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.datanext.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      datanextApiKey: requestField(scopedTranslation, {
      ...
      datanextFormId: requestField(scopedTranslation, {
        ...
        label: "providers.datanext.datanextFormId.label" as const,
        description: "providers.datanext.datanextFormId.description" as const,
        placeholder: "providers.datanext.datanextFormId.placeholder" as const,
        schema: z.string().min(1),
      }),
      datanextCampaignId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.datanext.datanextCampaignId.label" as const,
        description:
          "providers.datanext.datanextCampaignId.description" as const,
        placeholder:
          "providers.datanext.datanextCampaignId.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const datanextEndpoints = { POST } as const;
export default datanextEndpoints;
export type DatanextConfigPostRequestOutput = typeof POST.types.RequestOutput;
