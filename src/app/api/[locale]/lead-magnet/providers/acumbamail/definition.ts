...
export const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      acumbamailApiKey: requestField(scopedTranslation, {
  ...
  examples: {
    ...
    responses: { default: { provider: "ACUMBAMAIL", isActiveResponse: true } },
  },
});

const acumbamailEndpoints = { POST } as const;
export default acumbamailEndpoints;
export type AcumbamailConfigPostRequestOutput = typeof POST.types.RequestOutput;
