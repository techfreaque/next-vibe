...
export const { POST } = createEndpoint({
  ...
  title: "providers.edrone.title" as const,
  titleShort: "providers.edrone.titleShort" as const,
  description: "providers.edrone.description" as const,
  icon: "mail",
  category: "leads",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      edroneAppId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.edrone.edroneAppId.label" as const,
        description: "providers.edrone.edroneAppId.description" as const,
        placeholder: "providers.edrone.edroneAppId.placeholder" as const,
...
const edroneEndpoints = { POST } as const;
export default edroneEndpoints;
export type EdroneConfigPostRequestOutput = typeof POST.types.RequestOutput;
