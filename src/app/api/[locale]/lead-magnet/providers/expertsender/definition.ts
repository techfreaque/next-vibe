...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.expertsender.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      expertSenderApiDomain: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.expertsender.expertSenderApiDomain.label" as const,
        description:
          "providers.expertsender.expertSenderApiDomain.description" as const,
        placeholder:
          "providers.expertsender.expertSenderApiDomain.placeholder" as const,
        schema: z.string().min(1),
      }),
      expertSenderApiKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
...
const expertsenderEndpoints = { POST } as const;
export default expertsenderEndpoints;
export type ExpertSenderConfigPostRequestOutput =
