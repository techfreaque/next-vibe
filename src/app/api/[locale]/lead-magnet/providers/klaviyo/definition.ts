...
export const { POST } = createEndpoint({
  ...
  title: "providers.klaviyo.title" as const,
  description: "providers.klaviyo.description" as const,
  icon: "mail",
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      klaviyoApiKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
        label: "providers.klaviyo.klaviyoApiKey.label" as const,
        description: "providers.klaviyo.klaviyoApiKey.description" as const,
        placeholder: "providers.klaviyo.klaviyoApiKey.placeholder" as const,
...
const klaviyoEndpoints = { POST } as const;
export default klaviyoEndpoints;

export type KlaviyoConfigPostRequestOutput = typeof POST.types.RequestOutput;
export type KlaviyoConfigPostResponseOutput = typeof POST.types.ResponseOutput;
