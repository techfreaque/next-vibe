...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.salesmanago.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      salesManagoClientId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.salesmanago.salesManagoClientId.label" as const,
        description:
          "providers.salesmanago.salesManagoClientId.description" as const,
        placeholder:
          "providers.salesmanago.salesManagoClientId.placeholder" as const,
        schema: z.string().min(1),
      }),
      salesManagoApiKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
      ...
      salesManagoDomain: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.salesmanago.salesManagoDomain.label" as const,
        description:
          "providers.salesmanago.salesManagoDomain.description" as const,
        placeholder:
          "providers.salesmanago.salesManagoDomain.placeholder" as const,
        schema: z.string().min(1),
      }),
      salesManagoOwner: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.salesmanago.salesManagoOwner.label" as const,
        description:
          "providers.salesmanago.salesManagoOwner.description" as const,
        placeholder:
          "providers.salesmanago.salesManagoOwner.placeholder" as const,
        schema: z.string().min(1),
      }),
  ...
  examples: {
    ...
    responses: { default: { provider: "SALESMANAGO", isActiveResponse: true } },
  },
});

const salesmanagoEndpoints = { POST } as const;
export default salesmanagoEndpoints;
export type SalesManagoConfigPostRequestOutput =
