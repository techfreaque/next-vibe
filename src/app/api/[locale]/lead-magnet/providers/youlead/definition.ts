...
export const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      youLeadAppId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.youlead.youLeadAppId.label" as const,
        description: "providers.youlead.youLeadAppId.description" as const,
        placeholder: "providers.youlead.youLeadAppId.placeholder" as const,
        schema: z.string().min(1),
      }),
      youLeadClientId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.youlead.youLeadClientId.label" as const,
        description: "providers.youlead.youLeadClientId.description" as const,
        placeholder: "providers.youlead.youLeadClientId.placeholder" as const,
        schema: z.string().min(1),
      }),
      youLeadAppSecretKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
        label: "providers.youlead.youLeadAppSecretKey.label" as const,
        description:
          "providers.youlead.youLeadAppSecretKey.description" as const,
        placeholder:
          "providers.youlead.youLeadAppSecretKey.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const youleadEndpoints = { POST } as const;
export default youleadEndpoints;
export type YouLeadConfigPostRequestOutput = typeof POST.types.RequestOutput;
