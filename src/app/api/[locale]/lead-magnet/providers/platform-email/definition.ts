...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.platformEmail.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      notifyEmail: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.EMAIL,
        label: "providers.platformEmail.notifyEmail.label" as const,
        description: "providers.platformEmail.notifyEmail.description" as const,
        placeholder: "providers.platformEmail.notifyEmail.placeholder" as const,
        schema: z.email(),
      }),
      notifyEmailName: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.platformEmail.notifyEmailName.label" as const,
        description:
          "providers.platformEmail.notifyEmailName.description" as const,
        placeholder:
          "providers.platformEmail.notifyEmailName.placeholder" as const,
...
const platformEmailEndpoints = { POST } as const;
export default platformEmailEndpoints;

export type PlatformEmailPostRequestOutput = typeof POST.types.RequestOutput;
export type PlatformEmailPostResponseOutput = typeof POST.types.ResponseOutput;
