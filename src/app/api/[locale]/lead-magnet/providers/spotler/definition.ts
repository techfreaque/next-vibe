...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.spotler.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      spotlerConsumerKey: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.spotler.spotlerConsumerKey.label" as const,
        description:
          "providers.spotler.spotlerConsumerKey.description" as const,
        placeholder:
          "providers.spotler.spotlerConsumerKey.placeholder" as const,
        schema: z.string().min(1),
      }),
      spotlerConsumerSecret: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
...
const spotlerEndpoints = { POST } as const;
export default spotlerEndpoints;
export type SpotlerConfigPostRequestOutput = typeof POST.types.RequestOutput;
