...
/**
 * Generate metadata for the Data-Driven Login page with translations
 */
  ...
  return metadataGenerator(locale, {
    ...
    additionalMetadata: {
      openGraph: {
        ...
        url: `${translations.websiteUrl}/${locale}/login-new`,
        type: "website",
        images: [
          {
...
/**
 * Data-Driven Login Page
 *
 * This page demonstrates the new data-driven approach to form rendering.
 * It uses the LoginFormNew component which automatically renders all form fields
 * from the endpoint definition, eliminating the need for manual field configuration.
 *
 * Benefits:
 * - Automatic field generation from definition.ts
 * - Type-safe with full TypeScript inference
 * - Easy to maintain - changes to definition.ts automatically reflect in UI
 * - Consistent with unified-interface architecture
 * - Reuses all existing hooks and components
 */
  ...
  return (
    <>
      ...
      <Div className="">
        ...
        {/* Use the new data-driven login form */}
        <LoginFormNew locale={locale} loginOptions={loginOptionsResponse.data} />
      </Div>
    </>
  );
}
