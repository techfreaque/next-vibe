...
import { getCountryFromLocale } from "next-vibe/core/language-utils";
...
import PricingSection from "@/app/[locale]/(site)/pricing/_components/pricing-section";
import { InvoiceStatus } from "@/app/api/[locale]/v1/core/payment/enum";
import type { PaymentResponseType } from "@/app/api/[locale]/v1/core/payment/schema";
import { SubscriptionStatus } from "@/app/api/[locale]/v1/core/subscription/enum";
import { useSubscriptionManagement } from "@/app/api/[locale]/v1/core/subscription/hooks";
import type { SubscriptionGetResponseType } from "@/app/api/[locale]/v1/core/subscription/schema";
...
interface SubscriptionClientContentProps {
  ...
  initialBillingHistory?: PaymentResponseType | null;
