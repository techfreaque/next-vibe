...
export const translations: typeof enTranslations = {
  ...
  plans: {
    ...
    PROFESSIONAL: {
      name: "Pakiet kredytowy",
      price: "€5",
      description: "Płać za to, czego używasz z pakietami kredytowymi",
      cta: "Kup kredyty",
      features: [
        "Pakiet kredytowy €5",
        "Kredyty nigdy nie wygasają",
        "Wszystkie modele AI wliczone",
        "Akceptowane płatności kryptowalutowe",
        "Nie wymagana subskrypcja",
      ],
    },
    PREMIUM: {
      name: "Nielimitowany",
    ...
    ENTERPRISE: {
      ...
      features: [
        ...
        "Gwarancje SLA",
        "Opcje white-label",
        "Niestandardowa integracja modeli AI",
