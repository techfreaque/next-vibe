  ...
  const openPositions: readonly JobPosition[] = [
    {
      ...
      description: t("pages.careers.jobs.socialMediaManager.shortDescription"),
      type: "Full-time",
    ...
    },
    {
      ...
      description: t("pages.careers.jobs.contentCreator.shortDescription"),
      type: "Full-time",
      ...
      <div className="container max-w-6xl mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            {t("pages.careers.description", { appName: t("common.appName") })}
          </p>
          ...
          <div className="relative h-[300px] rounded-xl overflow-hidden shadow-xl mb-12">
            ...
            <div className="absolute bottom-0 left-0 p-8 z-20 text-white">
              <h2 className="text-3xl font-bold mb-2">
                {t("pages.careers.joinTeam")}
              </h2>
              <p className="text-lg max-w-lg">{t("pages.careers.subtitle")}</p>
            </div>
          </div>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">
              {t("pages.careers.whyWorkWithUs")}
            </h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              {t("pages.careers.workplaceDescription")}
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-lg mb-2 text-blue-600 dark:text-blue-400">
                  {t("pages.careers.benefits.innovationTitle")}
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  {t("pages.careers.benefits.innovationDesc")}
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-lg mb-2 text-blue-600 dark:text-blue-400">
                  {t("pages.careers.benefits.teamTitle")}
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  {t("pages.careers.benefits.teamDesc")}
                </p>
              </div>
            </div>
          </section>
                  ...
                  <div className="flex space-x-3">
                    <Button className="flex-1" asChild>
                      <Link href={`/${locale}/careers/${position.id}`}>
                        {t("pages.careers.jobDetail.moreDetails")}
                      </Link>
                    </Button>
          ...
          <section className="text-center bg-blue-50 bg-gradient-to-r from-blue-50 to-cyan-50 dark:bg-gray-800 dark:from-gray-800 dark:to-gray-700 p-8 rounded-xl">
            <h2 className="text-2xl font-semibold mb-4">
              {t("pages.careers.readyToJoin")}
            </h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
              {t("pages.careers.explorePositions")}
            </p>
            <Button size="lg" asChild>
              <Link href={`/${locale}/help`}>{t("nav.contact")}</Link>
            </Button>
          </section>
        </div>
      </div>
