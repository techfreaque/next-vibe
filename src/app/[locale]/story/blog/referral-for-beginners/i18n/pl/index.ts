...
export const translations: typeof enTranslations = {
  meta: {
    ...
    keywords:
      "program polecający, marketing afiliacyjny dla początkujących, pasywny dochód AI",
  },
  hero: {
    ...
    title:
      "Nigdy nie robiłem/am marketingu afiliacyjnego. Czy mogę tu naprawdę zarabiać?",
    subtitle:
      "Przystępny przewodnik dla osób, które nigdy nikomu niczego nie polecały.",
    quote:
  ...
  different: {
    ...
    row1Type: "Kupon restauracyjny",
    row1Earn: "Jeden darmowy posiłek",
    row1When: "Raz",
    row2Type: "Affiliate e-commerce",
    row2Earn: "~5-10% zakupu",
    row2When: "Raz przy zakupie",
    row3Type: "Polecenie subskrypcji AI",
    row3Earn: "10% subskrypcji",
    row3When: "Co miesiąc, cyklicznie",
    p2: "Efekt procentu składanego jest realny. Poleć 10 osób w styczniu, a jeśli wszystkie pozostaną subskrybentami do grudnia, zarobisz od każdej 12 razy.",
  },
  multilevel: {
  ...
  expectations: {
    title: "Realistyczne oczekiwania (bez przesady)",
    p1: "Nie wzbogacisz się, polecając dwóch znajomych. Ale matematyka jest prosta i uczciwa:",
    scenario1Label: "Zwykły użytkownik",
    scenario1Spend: "~8$/mies.",
    scenario1Earn: "= 0,80$/mies. za polecenie",
  ...
  firststeps: {
    ...
    step4Title: "Poczekaj i sprawdź",
    step4Body:
      "Twój panel pokazuje odwiedzających, rejestracje i zarobki w czasie rzeczywistym. Brak minimalnego wydatku, żeby zacząć śledzić.",
  },
  close: {
