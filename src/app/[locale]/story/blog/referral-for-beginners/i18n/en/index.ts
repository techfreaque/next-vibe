export const translations = {
  meta: {
    ...
    keywords:
      "referral program, affiliate marketing beginners, passive income AI",
  },
  hero: {
    ...
    title:
      "I've never done affiliate marketing. Can I actually earn money here?",
    subtitle:
      "A plain-language guide for people who have never referred anyone to anything before.",
    quote:
  ...
  different: {
    ...
    row1Type: "Restaurant voucher",
    row1Earn: "One free meal",
    row1When: "Once",
    row2Type: "E-commerce affiliate",
    row2Earn: "~5-10% of sale",
    row2When: "Once per purchase",
    row3Type: "AI subscription referral",
    row3Earn: "10% of subscription",
    row3When: "Every month, recurring",
    p2: "The compounding effect is real. Refer 10 people in January, and if they all stay subscribed through December, you've earned from each of them 12 times.",
  },
  multilevel: {
  ...
  expectations: {
    ...
    p1: "You're not going to get rich from referring two friends. But the math is simple and honest:",
    scenario1Label: "Typical user",
    scenario1Spend: "~$8/mo average spend",
    scenario1Earn: "= $0.80/mo per referral",
    scenario2Label: "Developer / power user",
    scenario2Spend: "$200+/mo",
    scenario2Earn: "= $20+/mo per referral",
    note: "The average developer today runs a $200/mo Claude Code or Codex subscription as their baseline — and some carry both. One developer referral earns you more than 25 casual ones.",
    example:
      "Refer 10 people, and they average $8/mo: that's $8/mo for you, $96/year. Not life-changing. But it's money you didn't have before, from things you were already saying to people anyway.",
  },
  firststeps: {
    ...
    step4Title: "Wait and check back",
    step4Body:
      "Your dashboard shows visitors, signups, and earnings in real time. No minimum spend to start tracking.",
  },
  close: {
    title: "That's really all there is to it",
    p1: "You don't need a blog. You don't need followers. You don't need to understand the multi-level structure. You just need to tell people about something you actually use.",
    p2: "If you want to go deeper — understand the commission math, find the best promotion angles, or ask questions — our Discord is the right place.",
