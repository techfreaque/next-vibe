...
export const translations: typeof enTranslations = {
  ...
  useCase: {
    ...
    p2: "Wzorzec jest prosty: wszędzie tam, gdzie naturalnie wspominasz {{appName}}, dodaj swój kod polecający. Osoby, które klikną i zapiszą się, przynoszą Ci 10% prowizji - cyklicznie. Nie musisz zmieniać tego, co mówisz - po prostu dodaj link.",
    examples: [
      'GitHub README: "Zbudowałem/am to z API {{appName}}. Jeśli chcesz spróbować: [link polecający]"',
      'Stopka posta na blogu: "Narzędzia, których używam: ...{{appName}} do dostępu do AI [link ref]"',
      'Discord/Slack: "Używam {{appName}} - tu moje polecenie, jeśli chcesz spróbować"',
      'Opis YouTube: "Narzędzia AI użyte w tym filmie: {{appName}} [link polecający]"',
    ],
  },
  apiAngle: {
    title: "Kąt API / next-vibe",
    p1: "Jeśli budujesz na API {{appName}} lub przyczyniasz się do next-vibe, Twoi użytkownicy są naturalnymi poleceniami. Ktoś, kto używa narzędzia, które zbudowałeś/aś na platformie, jest już o krok od bezpośredniej subskrypcji.",
  ...
  multilevel: {
    ...
    p1: "Jeśli publikujesz narzędzia lub biblioteki open source, z których korzystają deweloperzy, Twoi użytkownicy sami są deweloperami. Niektórzy z nich będą dalej polecać {{appName}}. Gdy to robią, Ty też dostajesz udział w tych poleceniach - do 5 poziomów głębokości.",
  ...
  crypto: {
    ...
    p2: "Alternatywnie możesz natychmiast zamienić zarobki na kredyty platformy. Jeśli sam/a używasz {{appName}} (do asystowania przy kodowaniu, prototypowania, testowania), Twoje zarobki z poleceń kompensują Twoje własne koszty użytkowania.",
  },
  close: {
