export const translations = {
  meta: {
    ...
    description:
      "For developers: how to turn your existing AI work — blog posts, READMEs, tutorials, open-source tools — into a passive referral income stream.",
  ...
  math: {
    title: "The math (code-style)",
    subtitle: "Two scenarios: casual user vs heavy user",
    tableHeaderReferrals: "Referred users",
    tableHeaderCasual: "Casual ($8/mo avg)",
    tableHeaderHeavy: "Dev ($200+/mo)",
    rows: [
      { referrals: "10", casual: "$8/mo", heavy: "$100/mo" },
      { referrals: "50", casual: "$40/mo", heavy: "$500/mo" },
      { referrals: "100", casual: "$80/mo", heavy: "$1,000/mo" },
    ],
  ...
  close: {
    ...
    p1: "You're already building, writing, and talking about AI tools. Adding a referral link costs you nothing and takes five minutes.",
    p2: "The compounding math — recurring commissions, rising ARPU, multi-level chain — works in your favor the more you build in public.",
