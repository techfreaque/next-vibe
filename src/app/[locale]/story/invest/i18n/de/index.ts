...
export const translations: typeof enTranslations = {
  ...
  description:
    "Unterstütze die offene KI-Plattform, die Mainstream-Anbieter nicht bauen können.",
  meta: {
    title: "In unbottled.ai investieren",
    description:
    ...
    keywords:
      "investieren, unbottled.ai, next-vibe, KI, Open Source, Angel, Seed, Finanzierung",
  },
};
