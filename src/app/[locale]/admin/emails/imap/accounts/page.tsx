...
import { ImapAccountsManagement } from "@/app/api/[locale]/emails/imap-client/_components/imap-accounts-management";
...
export default async function ImapAccountsPage({
  ...
  return (
    <Div className="container mx-auto py-6 flex flex-col gap-6">
      <Div className="mb-6">
        <H1 className="text-3xl font-bold">{t("app.admin.emails.imap.admin.accounts.title")}</H1>
