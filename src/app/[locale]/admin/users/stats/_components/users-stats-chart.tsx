    ...
    <div className="border-t">
      <div className="flex items-center justify-between p-4 border-b">
        <h4 className="text-sm font-medium">
          {t("app.admin.users.admin.stats.legend.title")}
        </h4>
        <div className="flex gap-2">
          ...
          >
            {t("app.admin.users.admin.stats.legend.showAll")}
          </button>
          <button
            onClick={onHideAll}
            className="text-xs text-muted-foreground hover:text-foreground"
          >
            {t("app.admin.users.admin.stats.legend.hideAll")}
          </button>
        </div>
      </div>
...
export function UsersStatsChart({
  ...
  if (!data || !data.series || data.series.length === 0) {
    return (
      <Card className={className}>
        <CardHeader>
          <CardTitle>{t("app.admin.users.admin.stats.chart.title")}</CardTitle>
        </CardHeader>
        <CardContent>
          <div
          ...
          >
            {t("app.admin.users.admin.stats.chart.noData")}
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card className={className}>
      <CardHeader>
        <CardTitle>
          {data.title || t("app.admin.users.admin.stats.chart.title")}
        </CardTitle>
        {data.subtitle && (
