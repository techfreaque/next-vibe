          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">
                {t("leads.admin.emails.preview.actions.title")}
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t("leads.admin.emails.preview.actions.description")}
              </p>
            </div>
            <Dialog open={isTestEmailOpen} onOpenChange={setIsTestEmailOpen}>
              <DialogTrigger asChild>
                <Button className="flex items-center space-x-2">
                  ...
                  <span>{t("leads.admin.emails.testEmail.button")}</span>
                </Button>
              </DialogTrigger>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                <span className="font-medium text-gray-700 dark:text-gray-300">
                  {t("leads.admin.emails.recipient")}:
                </span>
                <span className="ml-2 text-gray-600 dark:text-gray-400">
                  {emailPreview.to}
                </span>
            ...
            <div className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
              <div className="bg-gray-100 dark:bg-gray-700 px-4 py-2 border-b border-gray-200 dark:border-gray-600">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    {t("leads.admin.emails.email_preview")}
                  </span>
                  <div className="flex items-center space-x-2">
                    <Mail className="h-4 w-4 text-gray-500" />
                    <span className="text-xs text-gray-500">
                      {t("leads.admin.emails.preview.live")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white">
                <iframe
                  ...
                  title={t("leads.admin.emails.preview_title")}
