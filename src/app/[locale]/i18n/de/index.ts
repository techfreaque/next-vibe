...
export const translations: typeof enTranslations = {
  ...
  endpointCategories: {
    ai: "KI",
    aiInference: "Inferenz",
    aiGeneration: "Generierung",
    aiSearch: "Suche",
    aiTools: "Werkzeuge",
    aiSkills: "Charaktere",
    analytics: "Analytik",
    analyticsDataSources: "Analytik: Datenquellen",
    analyticsEvaluators: "Evaluatoren",
    analyticsIndicators: "Indikatoren",
    analyticsTransformers: "Transformatoren",
    analyticsVibeSense: "Vibe Sense",
    browser: "Browser",
    browserPages: "Seiten",
    browserInteraction: "Interaktion",
    browserInspection: "Inspektion",
    browserDevTools: "DevTools",
    desktop: "Desktop",
    desktopCapture: "Erfassung",
    desktopInteraction: "Interaktion",
    desktopInspection: "Inspektion",
    desktopWindows: "Fenster",
    chat: "Chat",
    chatFavorites: "Favoriten",
    chatSettings: "Einstellungen",
    chatOrganization: "Organisation",
    memories: "Erinnerungen",
    memoriesManagement: "Verwaltung",
    memoriesSearch: "Suche",
    messages: "Nachrichten",
    messagesFiles: "Dateien",
    messagesSearch: "Suche",
    messagesModerating: "Moderation",
    skills: "Charaktere",
    skillsManagement: "Verwaltung",
    skillsModeration: "Moderation",
    skillsCommunity: "Community",
    threads: "Threads",
    threadsManagement: "Verwaltung",
    threadsSharing: "Teilen",
    threadsSearch: "Suche",
    credits: "Guthaben",
    creditsManagement: "Verwaltung",
    creditsAnalytics: "Credits",
    leads: "Leads",
    leadsManagement: "Verwaltung",
    leadsImport: "Import",
    leadsAnalytics: "Leads",
    leadMagnet: "Lead-Magnet",
    leadMagnetCapture: "Erfassung",
    leadMagnetIntegrations: "Integrationen",
    emailCampaigns: "E-Mail-Kampagnen",
    emailCampaignsQueue: "Warteschlange",
    emailCampaignsJourneys: "Journeys",
    emailCampaignsProcessing: "Verarbeitung",
    emailCampaignsStats: "Statistiken",
    messenger: "Messenger",
    messengerAccounts: "Konten",
    messengerInbox: "Posteingang",
    messengerMessages: "Nachrichten",
    messengerProviders: "Anbieter",
    newsletter: "Newsletter",
    newsletterSubscriptions: "Abonnements",
    newsletterAnalytics: "Newsletter",
    payments: "Zahlungen",
    paymentTransactions: "Transaktionen",
    paymentProviders: "Anbieter",
    paymentAnalytics: "Zahlungen",
    referral: "Empfehlung",
    referralProgram: "Programm",
    referralPayouts: "Auszahlungen",
    referralAnalytics: "Empfehlungen",
    ssh: "SSH",
    sshConnections: "Verbindungen",
    sshTerminal: "Terminal",
    sshFiles: "Dateien",
    sshExecution: "Ausführung",
    subscriptions: "Abonnements",
    subscriptionManagement: "Verwaltung",
    subscriptionAnalytics: "Abonnements",
    server: "Server",
    serverManagement: "Verwaltung",
    serverElectron: "Desktop",
    serverGuard: "Guard",
    database: "Datenbank",
    databaseMigrations: "Migrationen",
    databaseTools: "Werkzeuge",
    tasks: "Aufgaben",
    tasksCron: "Hintergrund",
    tasksPulse: "Pulse",
    tasksMonitoring: "Überwachung",
    tasksSync: "Synchronisation",
    devTools: "Entwicklungstools",
    devToolsCheck: "Prüfung",
    devToolsGenerators: "Generatoren",
    devToolsBuild: "Build",
    interfaces: "Schnittstellen",
    interfacesCli: "CLI",
    interfacesMcp: "MCP",
    interfacesFrame: "Frame",
    settings: "Einstellungen",
    settingsEnv: "Umgebung",
    settingsHelp: "Hilfe",
    settingsKeys: "Schlüssel",
    userAuth: "Benutzerkonto",
    userAuthLogin: "Anmeldung",
    userAuthProfile: "Profil",
    userAuthSessions: "Sitzungen",
    userAuthDirectory: "Verzeichnis",
    userAdmin: "Benutzerverwaltung",
    userAdminManagement: "Verwaltung",
    userAdminStats: "Statistiken",
    remote: "Fernverbindungen",
    remoteInstances: "Instanzen",
    remoteSelf: "Eigene",
    users: "Benutzer",
    support: "Support",
    corvina: "Corvina",
    corvinaOrganizations: "Organisationen",
    corvinaSubscriptions: "Abonnements",
    corvinaLicenses: "Lizenzen",
    corvinaDeviceLicenses: "Abonnements",
    corvinaDeviceSubscriptions: "Geräte-Abonnements",
  },
  ui: {
    iconPicker: {
