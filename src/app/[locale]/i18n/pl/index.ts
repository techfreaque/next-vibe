...
export const translations: typeof enTranslations = {
  ...
  error: {
    ...
    errorTypes: {
      ...
      external_service_error: "Błąd zewnętrznej usługi",
      two_factor_required: "Wymagana autentykacja dwuskładnikowa",
