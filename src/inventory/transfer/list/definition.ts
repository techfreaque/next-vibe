        ...
        child: objectField(scopedTranslation, {
          ...
          children: {
            id: responseField(scopedTranslation, {
              ...
              label: "transferList.get.response.id" as const,
              hidden: true,
              schema: z.uuid(),
            }),
            fromWarehouseId: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.fromWarehouseId" as const,
              hidden: true,
              schema: z.uuid(),
            }),
            fromWarehouseName: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.fromWarehouseName" as const,
              schema: z.string(),
            }),
            toWarehouseId: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.toWarehouseId" as const,
              hidden: true,
              schema: z.uuid(),
            }),
            toWarehouseName: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.toWarehouseName" as const,
              schema: z.string(),
            }),
            status: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.status" as const,
              schema: z.string(),
            }),
            reference: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.reference" as const,
              schema: z.string().nullable(),
            }),
            createdAt: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.createdAt" as const,
              fieldType: FieldDataType.DATETIME,
              schema: z.coerce.date(),
            }),
            completedAt: responseField(scopedTranslation, {
              type: WidgetType.TEXT,
              label: "transferList.get.response.completedAt" as const,
              fieldType: FieldDataType.DATETIME,
