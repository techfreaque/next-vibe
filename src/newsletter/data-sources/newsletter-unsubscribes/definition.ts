/**
 * Newsletter Unsubscribes - Endpoint Definition
...
import { NEWSLETTER_UNSUBSCRIBES_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const NewsletterUnsubscribesWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.NewsletterUnsubscribesWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [NEWSLETTER_UNSUBSCRIBES_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: NewsletterUnsubscribesWidget,
    noFormElement: true,
