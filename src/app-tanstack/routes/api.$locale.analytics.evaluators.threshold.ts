...
export const Route = createFileRoute("/api/$locale/analytics/evaluators/threshold")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/analytics/evaluators/threshold/route")) },
});
