// AUTO-GENERATED from src/app/api/[locale]/lead-magnet/providers/google-sheets/oauth/start/route.ts. Add "use custom" to this file to preserve customizations.
