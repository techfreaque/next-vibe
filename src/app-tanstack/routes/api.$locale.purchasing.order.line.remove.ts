...
export const Route = createFileRoute("/api/$locale/purchasing/order/line/remove")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/purchasing/order/line/remove/route")) },
});
