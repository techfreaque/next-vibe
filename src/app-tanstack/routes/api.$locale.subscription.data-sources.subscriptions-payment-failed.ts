...
export const Route = createFileRoute("/api/$locale/subscription/data-sources/subscriptions-payment-failed")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/subscription/data-sources/subscriptions-payment-failed/route")) },
});
