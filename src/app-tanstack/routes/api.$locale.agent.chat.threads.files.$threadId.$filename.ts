...
export const Route = createFileRoute("/api/$locale/agent/chat/threads/files/$threadId/$filename")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/threads/files/[threadId]/[filename]/route")) },
});
