...
export const Route = createFileRoute("/api/$locale/messenger/data-sources/messenger-delivered")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/messenger/data-sources/messenger-delivered/route")) },
});
