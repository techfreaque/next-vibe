...
const loadData = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    const { tanstackLoader } = await import("@/app/[locale]/story/blog/referral-for-developers/page");
        return tanstackLoader({ params: Promise.resolve(toNextParams(data)) });
  });

export const Route = createFileRoute("/$locale/story/blog/referral-for-developers/")({
  staleTime: 0,
