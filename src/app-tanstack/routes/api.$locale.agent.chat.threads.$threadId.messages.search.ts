...
export const Route = createFileRoute("/api/$locale/agent/chat/threads/$threadId/messages/search")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/threads/[threadId]/messages/search/route")) },
});
