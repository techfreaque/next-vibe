// AUTO-GENERATED from src/app/[locale]/admin/leads/layout.tsx. Add "use custom" to this file to preserve customizations.
...
import { TanstackPage as Layout } from "@/app/[locale]/admin/leads/layout";

const loadData = createServerFn({ method: "GET" })
  .inputValidator((data: Record<string, string>) => data)
  .handler(async ({ data }) => {
    const { tanstackLoader } = await import("@/app/[locale]/admin/leads/layout");
