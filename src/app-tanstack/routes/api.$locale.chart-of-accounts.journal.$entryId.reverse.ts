...
export const Route = createFileRoute("/api/$locale/chart-of-accounts/journal/$entryId/reverse")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/chart-of-accounts/journal/[entryId]/reverse/route")) },
});
