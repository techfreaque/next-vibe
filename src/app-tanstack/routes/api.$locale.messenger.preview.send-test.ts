...
export const Route = createFileRoute("/api/$locale/messenger/preview/send-test")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/messenger/preview/send-test/route")) },
});
