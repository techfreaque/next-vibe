...
export const Route = createFileRoute("/api/$locale/agent/chat/threads/search-messages")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/threads/search-messages/route")) },
});
