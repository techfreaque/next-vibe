...
export const Route = createFileRoute("/api/$locale/chart-of-accounts/account/$accountId/deactivate")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/chart-of-accounts/account/[accountId]/deactivate/route")) },
});
