...
export const Route = createFileRoute("/api/$locale/analytics/transformers/field-pick")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/analytics/transformers/field-pick/route")) },
});
