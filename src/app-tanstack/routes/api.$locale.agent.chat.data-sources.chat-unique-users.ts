...
export const Route = createFileRoute("/api/$locale/agent/chat/data-sources/chat-unique-users")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/data-sources/chat-unique-users/route")) },
});
