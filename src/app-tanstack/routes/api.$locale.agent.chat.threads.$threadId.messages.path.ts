...
export const Route = createFileRoute("/api/$locale/agent/chat/threads/$threadId/messages/path")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/threads/[threadId]/messages/path/route")) },
});
