...
const loadData = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    const { tanstackLoader } = await import("@/app/[locale]/story/newsletter/unsubscribe/[email]/page");
        return tanstackLoader({ params: Promise.resolve(toNextParams(data)) });
  });

export const Route = createFileRoute("/$locale/story/newsletter/unsubscribe/$email/")({
  staleTime: 0,
