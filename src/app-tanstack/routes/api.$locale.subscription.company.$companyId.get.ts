...
export const Route = createFileRoute("/api/$locale/subscription/company/$companyId/get")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/subscription/company/[companyId]/get/route")) },
});
