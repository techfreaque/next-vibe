...
export const Route = createFileRoute("/api/$locale/payment/invoice/$invoiceId/record-payment")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/payment/invoice/[invoiceId]/record-payment/route")) },
});
