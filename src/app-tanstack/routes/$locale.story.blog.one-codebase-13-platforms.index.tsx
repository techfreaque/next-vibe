...
const loadData = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    const { tanstackLoader } = await import("@/app/[locale]/story/blog/one-codebase-13-platforms/page");
        return tanstackLoader({ params: Promise.resolve(toNextParams(data)) });
  });

export const Route = createFileRoute("/$locale/story/blog/one-codebase-13-platforms/")({
  staleTime: 0,
