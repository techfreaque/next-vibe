...
export const Route = createFileRoute("/api/$locale/companies/$companyId/members/list")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/companies/[companyId]/members/list/route")) },
});
