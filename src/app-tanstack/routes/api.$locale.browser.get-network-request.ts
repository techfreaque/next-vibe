...
export const Route = createFileRoute("/api/$locale/browser/get-network-request")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/browser/get-network-request/route")) },
});
