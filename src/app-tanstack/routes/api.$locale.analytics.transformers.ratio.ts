...
export const Route = createFileRoute("/api/$locale/analytics/transformers/ratio")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/analytics/transformers/ratio/route")) },
});
