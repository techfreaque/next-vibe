...
export const Route = createFileRoute("/api/$locale/leads/campaigns/emails/test-mail")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/leads/campaigns/emails/test-mail/route")) },
});
