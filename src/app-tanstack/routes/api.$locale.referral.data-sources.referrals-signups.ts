...
export const Route = createFileRoute("/api/$locale/referral/data-sources/referrals-signups")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/referral/data-sources/referrals-signups/route")) },
});
