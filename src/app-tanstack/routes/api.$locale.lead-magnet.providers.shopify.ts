...
export const Route = createFileRoute("/api/$locale/lead-magnet/providers/shopify")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/lead-magnet/providers/shopify/route")) },
});
