...
export const Route = createFileRoute("/api/$locale/chart-of-accounts/account/create")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/chart-of-accounts/account/create/route")) },
});
