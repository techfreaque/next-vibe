...
export const Route = createFileRoute("/api/$locale/payment/providers/stripe/webhook")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/payment/providers/stripe/webhook/route")) },
});
