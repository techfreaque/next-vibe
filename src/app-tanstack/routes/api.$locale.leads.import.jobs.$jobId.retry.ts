...
export const Route = createFileRoute("/api/$locale/leads/import/jobs/$jobId/retry")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/leads/import/jobs/[jobId]/retry/route")) },
});
