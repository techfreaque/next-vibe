...
export const Route = createFileRoute("/api/$locale/payment/data-sources/payments-invoices-paid")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/payment/data-sources/payments-invoices-paid/route")) },
});
