...
export const Route = createFileRoute("/api/$locale/agent/chat/folders/subfolders/$subFolderId/rename")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/folders/subfolders/[subFolderId]/rename/route")) },
});
