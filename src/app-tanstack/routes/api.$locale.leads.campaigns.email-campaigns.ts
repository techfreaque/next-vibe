...
export const Route = createFileRoute("/api/$locale/leads/campaigns/email-campaigns")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/leads/campaigns/email-campaigns/route")) },
});
