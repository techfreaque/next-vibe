...
export const Route = createFileRoute("/api/$locale/payment/data-sources/payments-failed")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/payment/data-sources/payments-failed/route")) },
});
