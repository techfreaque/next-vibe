...
export const Route = createFileRoute("/api/$locale/chart-of-accounts/account/$accountId/update")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/chart-of-accounts/account/[accountId]/update/route")) },
});
