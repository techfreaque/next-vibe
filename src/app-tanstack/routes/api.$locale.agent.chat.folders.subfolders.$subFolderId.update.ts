...
export const Route = createFileRoute("/api/$locale/agent/chat/folders/subfolders/$subFolderId/update")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/folders/subfolders/[subFolderId]/update/route")) },
});
