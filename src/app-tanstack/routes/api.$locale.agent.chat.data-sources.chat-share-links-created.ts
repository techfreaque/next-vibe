...
export const Route = createFileRoute("/api/$locale/agent/chat/data-sources/chat-share-links-created")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/data-sources/chat-share-links-created/route")) },
});
