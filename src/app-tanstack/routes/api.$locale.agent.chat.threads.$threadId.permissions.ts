...
export const Route = createFileRoute("/api/$locale/agent/chat/threads/$threadId/permissions")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/agent/chat/threads/[threadId]/permissions/route")) },
});
