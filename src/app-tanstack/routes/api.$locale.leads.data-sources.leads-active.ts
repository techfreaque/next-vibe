...
export const Route = createFileRoute("/api/$locale/leads/data-sources/leads-active")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/leads/data-sources/leads-active/route")) },
});
