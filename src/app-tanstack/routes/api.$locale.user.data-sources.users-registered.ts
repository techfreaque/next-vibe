...
export const Route = createFileRoute("/api/$locale/user/data-sources/users-registered")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/user/data-sources/users-registered/route")) },
});
