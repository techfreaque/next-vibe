// AUTO-GENERATED from src/app/[locale]/admin/vibe-frame/layout.tsx. Add "use custom" to this file to preserve customizations.
...
import { TanstackPage as Layout } from "@/app/[locale]/admin/vibe-frame/layout";

const loadData = createServerFn({ method: "GET" })
  .inputValidator((data: Record<string, string>) => data)
  .handler(async ({ data }) => {
    const { tanstackLoader } = await import("@/app/[locale]/admin/vibe-frame/layout");
