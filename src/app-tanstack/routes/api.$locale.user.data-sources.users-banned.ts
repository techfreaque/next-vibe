...
export const Route = createFileRoute("/api/$locale/user/data-sources/users-banned")({
  server: { handlers: wrapNextApiRoute(() => import("@/app/api/[locale]/user/data-sources/users-banned/route")) },
});
