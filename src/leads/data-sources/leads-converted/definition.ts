/**
 * Leads Converted - Endpoint Definition
...
import { LEADS_CONVERTED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsConvertedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsConvertedWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_CONVERTED_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsConvertedWidget,
    noFormElement: true,
