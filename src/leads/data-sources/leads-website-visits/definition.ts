/**
 * Leads Website Visits - Endpoint Definition
...
import { LEADS_WEBSITE_VISITS_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsWebsiteVisitsWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsWebsiteVisitsWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_WEBSITE_VISITS_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsWebsiteVisitsWidget,
    noFormElement: true,
