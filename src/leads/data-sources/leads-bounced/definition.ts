/**
 * Leads Bounced - Endpoint Definition
...
import { LEADS_BOUNCED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const LeadsBouncedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.LeadsBouncedWidget })),
);
...
const { POST } = createEndpoint({
  ...
  aliases: [LEADS_BOUNCED_ALIAS],
  allowedRoles: [UserRole.ADMIN],

  fields: customWidgetObject({
    render: LeadsBouncedWidget,
    noFormElement: true,
