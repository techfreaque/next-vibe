...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.mailup.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      mailupClientId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.mailup.mailupClientId.label" as const,
        description: "providers.mailup.mailupClientId.description" as const,
        placeholder: "providers.mailup.mailupClientId.placeholder" as const,
        schema: z.string().min(1),
      }),
      mailupClientSecret: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
      ...
      mailupUsername: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.mailup.mailupUsername.label" as const,
        description: "providers.mailup.mailupUsername.description" as const,
        placeholder: "providers.mailup.mailupUsername.placeholder" as const,
        schema: z.string().min(1),
      }),
      mailupPassword: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.PASSWORD,
      ...
      mailupListId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.mailup.mailupListId.label" as const,
        description: "providers.mailup.mailupListId.description" as const,
        placeholder: "providers.mailup.mailupListId.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const mailupEndpoints = { POST } as const;
export default mailupEndpoints;
export type MailupConfigPostRequestOutput = typeof POST.types.RequestOutput;
