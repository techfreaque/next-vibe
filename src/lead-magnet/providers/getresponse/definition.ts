...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.getresponse.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      getresponseApiKey: requestField(scopedTranslation, {
  ...
  examples: {
    ...
    responses: { default: { provider: "GETRESPONSE", isActiveResponse: true } },
  },
});

const getresponseEndpoints = { POST } as const;
export default getresponseEndpoints;

export type GetResponseConfigPostRequestOutput =
