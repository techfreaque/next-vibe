...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.adobecampaign.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      adobeCampaignOrganizationId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label:
          "providers.adobecampaign.adobeCampaignOrganizationId.label" as const,
        description:
          "providers.adobecampaign.adobeCampaignOrganizationId.description" as const,
        placeholder:
          "providers.adobecampaign.adobeCampaignOrganizationId.placeholder" as const,
        schema: z.string().min(1),
      }),
      adobeCampaignClientId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.adobecampaign.adobeCampaignClientId.label" as const,
        description:
          "providers.adobecampaign.adobeCampaignClientId.description" as const,
        placeholder:
          "providers.adobecampaign.adobeCampaignClientId.placeholder" as const,
        schema: z.string().min(1),
      }),
      adobeCampaignClientSecret: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
      ...
      adobeCampaignListId: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.adobecampaign.adobeCampaignListId.label" as const,
        description:
          "providers.adobecampaign.adobeCampaignListId.description" as const,
        placeholder:
          "providers.adobecampaign.adobeCampaignListId.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const adobecampaignEndpoints = { POST } as const;
export default adobecampaignEndpoints;
export type AdobeCampaignConfigPostRequestOutput =
