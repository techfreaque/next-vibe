...
export const { POST } = createEndpoint({
  ...
  titleShort: "providers.mapp.titleShort" as const,
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      mappUsername: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.mapp.mappUsername.label" as const,
        description: "providers.mapp.mappUsername.description" as const,
        placeholder: "providers.mapp.mappUsername.placeholder" as const,
        schema: z.string().min(1),
      }),
      mappPassword: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
      ...
      mappDomain: requestField(scopedTranslation, {
        type: WidgetType.FORM_FIELD,
        fieldType: FieldDataType.TEXT,
        label: "providers.mapp.mappDomain.label" as const,
        description: "providers.mapp.mappDomain.description" as const,
        placeholder: "providers.mapp.mappDomain.placeholder" as const,
        schema: z.string().min(1),
      }),
...
const mappEndpoints = { POST } as const;
export default mappEndpoints;
export type MappConfigPostRequestOutput = typeof POST.types.RequestOutput;
