...
} from "@/app/api/[locale]/remote-connection/system-prompt/prompt";
...
export async function loadAllPromptFragments(
  ...
  const autonomyStatusBuilt =
    promptContextData &&
    (autonomyStatusFragment.condition
      ? autonomyStatusFragment.condition(promptContextData)
      : true)
  ...
  const bootstrapBuilt =
    ...
    (bootstrapFragment.condition
      ...
      : null;
  const codingAgentSettingBuilt =
    codingAgentSettingData &&
    (codingAgentSettingFragment.condition
      ? codingAgentSettingFragment.condition(codingAgentSettingData)
      : true)
      ? codingAgentSettingFragment.build(codingAgentSettingData)
      : null;
  const contactBuilt =
    contactData &&
    (contactFragment.condition ? contactFragment.condition(contactData) : true)
      ? contactFragment.build(contactData)
      : null;
  const cortexBuilt =
    cortexData &&
    (cortexFragment.condition ? cortexFragment.condition(cortexData) : true)
      ? cortexFragment.build(cortexData)
      : null;
  const desktopBuilt =
    desktopData &&
    (desktopFragment.condition ? desktopFragment.condition(desktopData) : true)
      ? desktopFragment.build(desktopData)
      : null;
  ...
  const languageBuilt =
    ...
    (languageFragment.condition
      ...
      : null;
  const mediaCapabilitiesBuilt =
    promptContextData &&
    (mediaCapabilitiesFragment.condition
      ? mediaCapabilitiesFragment.condition(promptContextData)
      : true)
  ...
  const skillBuilt =
    ...
    (skillFragment.condition ? skillFragment.condition(skillData) : true)
      ...
      : null;
  const sshConnectionsBuilt =
    remoteInstancesData &&
    (sshConnectionsFragment.condition
      ? sshConnectionsFragment.condition(remoteInstancesData)
      : true)
      ? sshConnectionsFragment.build(remoteInstancesData)
      : null;
  const subAgentGuardBuilt =
    promptContextData &&
    (subAgentGuardFragment.condition
      ? subAgentGuardFragment.condition(promptContextData)
      : true)
  ...
  const userNameBuilt =
    ...
    (userNameFragment.condition
      ...
      : null;
  const webBuilt =
    webData && (webFragment.condition ? webFragment.condition(webData) : true)
      ? webFragment.build(webData)
      : null;
