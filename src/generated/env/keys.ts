...
export const ENV_KEYS = [
  ...
  {
    key: "CHROME_REMOTE_DEBUG_PORT",
    module: "browser",
    comment:
      "Port the shared automation Chrome listens on for remote debugging. Every process on the machine attaches to the same port, so this only needs changing to run a fully separate browser (e.g. a test suite). Default: 9222.",
    example: "9222",
    sensitive: false,
    fieldType: "text",
    onboardingRequired: false,
  ...
  {
    key: "NOWPAYMENTS_CALLBACK_DOMAIN",
    module: "payment",
    comment:
  ...
  {
    key: "NEXT_PUBLIC_SUPPORT_EMAIL_DE",
    module: "contact",
    comment: "",
  ...
  {
    key: "NEXT_PUBLIC_SUPPORT_EMAIL_PL",
    module: "contact",
    comment: "",
    example: "hi@unbottled.ai",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_SUPPORT_EMAIL_GLOBAL",
    module: "contact",
    comment: "",
    example: "hi@unbottled.ai",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_OPEN_ROUTER",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_CLAUDE_CODE",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_BRAVE_SEARCH",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_KAGI_SEARCH",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_UNCENSORED_AI",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_FREEDOM_GPT",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_VENICE_AI",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_SCRAPPEY",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_OPEN_AI_IMAGES",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_OPEN_AI_STT",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_REPLICATE",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_MODELS_LAB",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_EDEN_AI_STT",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_DEEPGRAM",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_OPEN_AI_TTS",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_EDEN_AI_TTS",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_AGENT_ELEVENLABS",
    module: "agent",
    comment: "",
    example: "",
    sensitive: false,
  ...
  {
    key: "NEXT_PUBLIC_DEBUG_PRODUCTION",
    module: "core",
    comment: "",
    example: "false",
    sensitive: false,
