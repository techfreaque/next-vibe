  ...
  switch (path) {
    ...
    case "await-task":
      return (await import("@/vibe/execute-tool/await-task/route")).tools
        .POST as GenericHandlerBase;
    case "b":
      return (await import("@/vibe/server/server/build/route")).tools
        .POST as GenericHandlerBase;
    ...
    case "builder":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/builder/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "c":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/vibe-check/route"
        )
      ).tools.POST as GenericHandlerBase;
    ...
    case "cc":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/config/create/route"
        )
      ).tools.POST as GenericHandlerBase;
    ...
    case "cron:stats":
      return (await import("@/vibe/tasks/cron/stats/route")).tools
        .GET as GenericHandlerBase;
    case "d":
      return (await import("@/vibe/server/server/dev/route")).tools
        .POST as GenericHandlerBase;
    case "db-health":
    ...
    case "el":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/lint/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "electron":
      return (await import("@/vibe/server/server/electron/start/route")).tools
        .POST as GenericHandlerBase;
    case "electron:build":
      return (await import("@/vibe/server/server/electron/build/route")).tools
        .POST as GenericHandlerBase;
    case "electron:dev":
      return (await import("@/vibe/server/server/electron/start/route")).tools
        .POST as GenericHandlerBase;
    ...
    case "gen":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/generators/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "gen-key":
    ...
    case "guard":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/guard/start/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "guard-destroy":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/guard/destroy/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "guard-start":
      return (
    ...
    case "guard-stop":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/guard/stop/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "guard:destroy":
      return (
    ...
    case "guard:status":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/guard/status/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "guard:stop":
      return (
    ...
    case "headless-client":
      return (await import("@/vibe/server/server/headless-client/route")).tools
        .POST as GenericHandlerBase;
    case "health":
      return (await import("@/vibe/server/server/health/route")).tools
        .GET as GenericHandlerBase;
    case "help":
      return (await import("@/vibe/help-tool/route")).tools
        .GET as GenericHandlerBase;
    case "image-push":
      return (await import("@/vibe/server/server/image-push/route")).tools
        .POST as GenericHandlerBase;
    case "import-leads":
    ...
    case "install":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/platforms/cli/setup/install/route"
        )
      ).tools.POST as GenericHandlerBase;
    ...
    case "l":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/oxlint/route"
        )
      ).tools.POST as GenericHandlerBase;
    ...
    case "push":
      return (await import("@/vibe/tooling/infra/deploy/push/route")).tools
        .POST as GenericHandlerBase;
    case "re":
      return (await import("@/vibe/server/server/rebuild/route")).tools
        .POST as GenericHandlerBase;
    case "rebuild":
      return (await import("@/vibe/server/server/rebuild/route")).tools
        .POST as GenericHandlerBase;
    ...
    case "runner":
      return (await import("@/vibe/tasks/unified-runner/route")).tools
        .POST as GenericHandlerBase;
    case "s":
      return (await import("@/vibe/server/server/start/route")).tools
        .POST as GenericHandlerBase;
    case "scale":
      return (await import("@/vibe/tooling/infra/scale/replicas/route")).tools
        .POST as GenericHandlerBase;
    ...
    case "setup:uninstall":
      return (await import("@/vibe/platforms/cli/setup/uninstall/route")).tools
        .POST as GenericHandlerBase;
    case "setup:update":
      return (
        await import(
    ...
    case "start":
      return (await import("@/vibe/server/server/start/route")).tools
        .POST as GenericHandlerBase;
    case "status":
      return (await import("@/vibe/platforms/cli/setup/status/route")).tools
        .POST as GenericHandlerBase;
    case "stripe":
      return (await import("@/payment/providers/stripe/cli/route")).tools
        .POST as GenericHandlerBase;
    ...
    case "t":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/testing/test/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "task-execute":
      return (await import("@/vibe/tasks/execute/route")).tools
    ...
    case "tc":
      return (
        await import(
          /* turbopackIgnore: true */ /* webpackIgnore: true */ "@/vibe/tooling/check/typecheck/route"
        )
      ).tools.POST as GenericHandlerBase;
    case "test":
      return (
