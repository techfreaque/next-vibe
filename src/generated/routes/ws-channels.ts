...
import {
  ...
  userChannelResolver,
  type WsChannelEntry,
} from "../../vibe/realtime/server/ws-channel-registry";
...
export async function getGeneratedWsEndpoints(): Promise<WsChannelEntry[]> {
  const [
    ...
    import("@/vibe/core/generators/definition"),
    ...
    import("@/vibe/tooling/check/definition"),
  ]);
  ...
  return [
    ...
    {
      endpoint: vibe_core_generators_POSTDef.default.POST,
      resolveChannel: userChannelResolver,
    },
    {
    ...
    {
      endpoint: vibe_tooling_check_POSTDef.default.POST,
      resolveChannel: userChannelResolver,
    },
  ];
}
