...
export const endpointsMeta: EndpointMeta[] = [
    ...
    examples: {
      ...
      responses: {
        default: {
          ...
          active: true,
          checkErrors: [],
          createdAt: "2026-07-12T09:33:33.304Z",
        },
      },
    },
  },
  {
    ...
    examples: {
      ...
      responses: {
        default: {
          variantKey: "MY_VARIANT",
          updatedAt: "2026-07-12T09:33:33.304Z",
        },
      },
    },
  },
  ...
  },
  {
    ...
    description:
      "Baut das Produktions-Docker-Image und pusht es in die Registry, damit der Deploy-Server es nur noch zieht statt selbst zu bauen",
    icon: "container",
    category: "devTools",
    subCategory: "serverManagement",
    tags: ["Image Push"],
