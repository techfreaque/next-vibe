  ...
  switch (path) {
    ...
    case "await-task":
      return (await import("@/vibe/execute-tool/await-task/definition")).default
        .POST;
    case "b":
      return (await import("@/vibe/platforms/web/build/definition")).default
        .POST;
    ...
    case "builder":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/builder/definition"
        )
      ).default.POST;
    case "c":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/check/definition"
        )
      ).default.POST;
    ...
    case "cc":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/check/config/definition"
        )
      ).default.POST;
    ...
    case "cron:stats":
      return (await import("@/vibe/tasks/cron/stats/definition")).default.GET;
    case "d":
      return (await import("@/vibe/platforms/web/dev/definition")).default.POST;
    case "db-health":
    ...
    case "electron":
      return (await import("@/vibe/platforms/electron/start/definition"))
        .default.POST;
    case "electron:build":
      return (await import("@/vibe/platforms/electron/build/definition"))
        .default.POST;
    case "electron:dev":
      return (await import("@/vibe/platforms/electron/start/definition"))
        .default.POST;
    ...
    case "gen":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/core/generators/definition"
        )
      ).default.POST;
    case "gen-key":
    ...
    case "guard":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/guard/start/definition"
        )
      ).default.POST;
    case "guard-destroy":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/guard/destroy/definition"
        )
      ).default.POST;
    case "guard-start":
      return (
    ...
    case "guard-stop":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/guard/stop/definition"
        )
      ).default.POST;
    case "guard:destroy":
      return (
    ...
    case "guard:status":
      return (
        await import(
          /* webpackIgnore: true */ /* turbopackIgnore: true */ "@/vibe/tooling/guard/status/definition"
        )
      ).default.POST;
    case "guard:stop":
      return (
    ...
    case "headless-client":
      return (await import("@/vibe/platforms/headless-client/definition"))
        .default.POST;
    case "health":
      return (await import("@/vibe/platforms/web/health/definition")).default
        .GET;
    case "help":
      return (await import("@/vibe/help-tool/definition")).default.GET;
    case "image-push":
      return (await import("@/vibe/tooling/image-push/definition")).default
        .POST;
    case "import-leads":
    ...
    case "push":
      return (await import("@/vibe/tooling/infra/deploy/push/definition"))
        .default.POST;
    case "re":
      return (await import("@/vibe/platforms/web/rebuild/definition")).default
        .POST;
    case "rebuild":
      return (await import("@/vibe/platforms/web/rebuild/definition")).default
        .POST;
    ...
    case "runner":
      return (await import("@/vibe/tasks/unified-runner/definition")).default
        .POST;
    case "s":
      return (await import("@/vibe/platforms/web/start/definition")).default
        .POST;
    case "scale":
      return (await import("@/vibe/tooling/infra/scale/replicas/definition"))
        .default.POST;
