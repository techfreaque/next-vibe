...
export const endpointsMeta: EndpointMeta[] = [
    ...
    examples: {
      inputs: {
        default: {
          ...
          attachments: [],
          resumeToken: null,
          voiceMode: { enabled: false, voice: "openai-nova" },
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: {
          signals: [
            [{ timestamp: {}, fired: true }, { timestamp: {}, fired: false }],
            [{ timestamp: {}, fired: true }, { timestamp: {}, fired: true }],
          ],
        },
      },
      responses: {
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: {
          signals: [
            [{ timestamp: {}, fired: false }, { timestamp: {}, fired: true }],
            [{ timestamp: {}, fired: true }, { timestamp: {}, fired: false }],
          ],
        },
      },
  ...
  },
  {
    ...
    examples: {
      ...
      responses: {
        default: {
          result: [{ timestamp: {}, value: 2 }, { timestamp: {}, value: -1 }],
          meta: { actualResolution: "enums.resolution.1d", lookbackUsed: 0 },
        },
      },
    },
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: {
          a: [{ timestamp: {}, value: 100 }, { timestamp: {}, value: 102 }],
          b: [{ timestamp: {}, value: 50 }, { timestamp: {}, value: 48 }],
          range: { from: {}, to: {} },
        },
      },
      responses: {
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: {
          a: [{ timestamp: {}, value: 200 }, { timestamp: {}, value: 150 }],
          b: [{ timestamp: {}, value: 100 }, { timestamp: {}, value: 50 }],
          range: { from: {}, to: {} },
        },
      },
      responses: {
        default: {
          result: [{ timestamp: {}, value: 2 }, { timestamp: {}, value: 3 }],
          meta: { actualResolution: "enums.resolution.1d", lookbackUsed: 0 },
        },
      },
    },
    ...
    examples: {
      ...
      responses: {
        default: {
          ...
          active: true,
          checkErrors: [],
          createdAt: "2026-07-01T15:37:46.338Z",
        },
      },
    },
  },
  {
    ...
    examples: {
      ...
      responses: {
        default: {
          variantKey: "MY_VARIANT",
          updatedAt: "2026-07-01T15:37:46.338Z",
        },
      },
    },
  },
  ...
  {
    toolName: "system_core_utils_dataflow_cleanup_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "cleanup"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_archive_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "archive"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_backtest_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "backtest"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_data_GET",
    method: "GET",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "data"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
    title: "Graph-Details",
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_edit_PUT",
    method: "PUT",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "edit"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_promote_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "promote"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_trigger_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "trigger"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_id_versions_GET",
    method: "GET",
    path: ["system", "core", "utils", "dataflow", "graphs", "[id]", "versions"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  },
  {
    ...
    method: "GET",
    path: ["system", "core", "utils", "dataflow", "graphs"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_core_utils_dataflow_graphs_POST",
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "graphs"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  },
  {
    ...
    method: "POST",
    path: ["system", "core", "utils", "dataflow", "run-config"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  },
  {
    ...
    examples: {
      ...
      responses: {
        default: { credential: "leadid123:token456:https://unbottled.ai" },
      },
    },
  },
  {
  ...
  {
    toolName: "system_execute-tool_complete_POST",
    method: "POST",
  ...
  },
  {
    ...
    tags: ["tools"],
    examples: {
      inputs: { default: { callId: "pending-call-uuid-here" } },
      responses: { default: { dismissed: true } },
    },
  },
  {
    toolName: "tool-help",
  ...
  },
  {
    ...
    method: "POST",
    path: ["system", "identity", "attribution"],
    allowedRoles: [
      "enums.userRole.admin",
      "enums.userRole.aiToolOff",
      "enums.userRole.mcpOff",
  ...
  {
    toolName: "system_identity_lead_id_GET",
    method: "GET",
    path: ["system", "identity", "lead", "[id]"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_identity_lead_id_PATCH",
    method: "PATCH",
    path: ["system", "identity", "lead", "[id]"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  {
    toolName: "system_identity_lead_id_DELETE",
    method: "DELETE",
    path: ["system", "identity", "lead", "[id]"],
    allowedRoles: ["enums.userRole.admin"],
    aliases: [],
  ...
  },
  {
    ...
    method: "GET",
    path: ["system", "identity", "tracking", "engagement"],
    allowedRoles: [
      "enums.userRole.public",
      "enums.userRole.customer",
      "enums.userRole.admin",
  ...
  },
  {
    toolName: "update",
    method: "POST",
    path: ["system", "platforms", "cli", "setup", "update"],
    allowedRoles: ["enums.userRole.admin"],
  ...
  {
    toolName: "generate:tanstack",
    method: "POST",
    path: ["system", "platforms", "tanstack-start", "generate"],
    allowedRoles: ["enums.userRole.admin", "enums.userRole.webOff"],
    aliases: ["tanstack:generate"],
    ...
    category: "devTools",
    subCategory: "Build",
    tags: ["TanStack-Routen Generieren"],
    examples: {
      responses: {
        default: {
          success: true,
  ...
  },
  {
    ...
    examples: {
      ...
      responses: { default: { received: true } },
    },
  },
  {
    toolName: "build",
  ...
  },
  {
    ...
    examples: {
      ...
      responses: {
        default: { completed: true, updatedAt: "2026-02-26T21:00:00.000Z" },
      },
    },
  },
  {
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: {},
        specificPaths: { paths: ["src/components", "src/utils"] },
      },
      responses: {
        default: { items: [], files: [], totalIssues: 0, totalFiles: 0 },
  ...
  {
    toolName: "system_tooling_generators_client-routes-index_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Client-Routen-Index generieren"],
    examples: {
      inputs: {
        default: {
  ...
  {
    toolName: "system_tooling_generators_email-templates_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["E-Mail-Vorlagen generieren"],
    examples: {
      inputs: {
        default: {
  ...
  {
    toolName: "system_tooling_generators_endpoint_POST",
    method: "POST",
    ...
    examples: {
      inputs: {
        default: { outputFile: "src/generated/endpoint.ts", dryRun: false },
      },
      responses: {
        default: {
          success: true,
  ...
  {
    toolName: "system_tooling_generators_endpoints-meta_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Endpoints-Meta generieren"],
    examples: {
      inputs: {
        default: { outputDir: "src/generated/endpoints-meta", dryRun: false },
      },
      responses: {
        default: {
          success: true,
  ...
  {
    toolName: "system_tooling_generators_env-keys_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Env-Schlüssel generieren"],
    examples: {
      inputs: {
        default: { outputFile: "src/generated/env-keys.ts", dryRun: false },
      },
      responses: {
        default: {
          success: true,
  ...
  },
  {
    ...
    examples: {
      inputs: {
        default: { outputDir: "src/generated", verbose: false, dryRun: false },
      },
      responses: {
        default: {
          success: true,
  ...
  {
    toolName: "system_tooling_generators_generate-trpc-router_POST",
    method: "POST",
    path: ["system", "tooling", "generators", "generate-trpc-router"],
    allowedRoles: [],
    aliases: [],
    title: "tRPC-Router generieren",
    titleShort: "tRPC-Router generieren",
  ...
  {
    toolName: "system_tooling_generators_prompt-fragments_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Prompt-Fragmente generieren"],
    examples: {
      inputs: {
        default: {
  ...
  {
    toolName: "system_tooling_generators_route-handlers_POST",
    method: "POST",
  ...
  {
    toolName: "system_tooling_generators_seeds_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Seeds erfolgreich generiert"],
    examples: {
      inputs: {
        default: {
          outputDir: "src/generated",
  ...
  {
    toolName: "system_tooling_generators_skills-index_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Skills-Index generieren"],
    examples: {
      inputs: {
        default: { outputFile: "src/generated/skills-index.ts", dryRun: false },
      },
      responses: {
        default: {
          success: true,
  ...
  {
    toolName: "system_tooling_generators_task-index_POST",
    method: "POST",
    ...
    category: "devTools",
    subCategory: "Generators",
    tags: ["Task-Index generieren"],
    examples: {
      inputs: {
        default: { outputFile: "src/generated/tasks-index.ts", dryRun: false },
      },
      responses: {
        default: {
          success: true,
