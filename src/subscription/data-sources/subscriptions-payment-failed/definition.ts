/**
 * Subscriptions Payment Failed - Endpoint Definition
...
import { SUBSCRIPTIONS_PAYMENT_FAILED_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const SubscriptionsPaymentFailedWidget = lazyWidget(() =>
  import("./widget").then((m) => ({
    default: m.SubscriptionsPaymentFailedWidget,
  })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [SUBSCRIPTIONS_PAYMENT_FAILED_ALIAS],
  method: Methods.POST,
  ...
  fields: customWidgetObject({
    render: SubscriptionsPaymentFailedWidget,
    noFormElement: true,
