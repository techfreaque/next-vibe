/**
 * Subscriptions New - Endpoint Definition
...
import { SUBSCRIPTIONS_NEW_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const SubscriptionsNewWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.SubscriptionsNewWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [SUBSCRIPTIONS_NEW_ALIAS],
  method: Methods.POST,
