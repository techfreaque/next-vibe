...
export const translations: typeof enTranslations = {
  error: {
    ...
    general: {
      unknown_validation_error: "Wystąpił nieznany błąd walidacji.",
    },
  },
  errorTypes: {
  ...
  errors: {
    ...
    serverError: {
      description: "Wystąpił błąd serwera. Proszę spróbować ponownie.",
    },
    validationFailed: {
      description: "Walidacja nie powiodła się. Sprawdź swoje dane.",
    },
  },
  cli: {
    vibe: {
      errors: {
        routeNotFound: "Nie znaleziono trasy dla narzędzia: {{toolName}}",
        executionFailed: "Wykonanie nie powiodło się",
        unknownError: "Wystąpił nieznany błąd",
        unknownErrorDetail: "Wystąpił nieznany błąd: {{error}}",
      },
    },
  },
  shared: {
