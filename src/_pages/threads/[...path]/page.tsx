...
import { FolderContentsRepository } from "next-vibe/agent/chat/folder-contents/[rootFolderId]/repository";
import type { FolderListResponseOutput } from "next-vibe/agent/chat/folders/[rootFolderId]/definition";
import { scopedTranslation as foldersScopedTranslation } from "next-vibe/agent/chat/folders/[rootFolderId]/i18n";
import { ChatFoldersRepository } from "next-vibe/agent/chat/folders/[rootFolderId]/repository";
import { RootFolderPermissionsRepository } from "next-vibe/agent/chat/folders/[rootFolderId]/root-permissions/repository";
import { FolderRepository } from "next-vibe/agent/chat/folders/subfolders/[subFolderId]/repository";
import type { RootFolderPermissions } from "next-vibe/agent/chat/hooks/context";
import type { PublicFeedGetResponseOutput } from "next-vibe/agent/chat/public-feed/definition";
import { FeedSortMode } from "next-vibe/agent/chat/public-feed/definition";
import { scopedTranslation as publicFeedScopedTranslation } from "next-vibe/agent/chat/public-feed/i18n";
import { PublicFeedRepository } from "next-vibe/agent/chat/public-feed/repository";
import type { ChatSettingsGetResponseOutput } from "next-vibe/agent/chat/settings/definition";
import { scopedTranslation as settingsScopedTranslation } from "next-vibe/agent/chat/settings/i18n";
import { ChatSettingsRepository } from "next-vibe/agent/chat/settings/repository";
import type { MessageListResponseOutput } from "next-vibe/agent/chat/threads/[threadId]/messages/definition";
import { scopedTranslation as messagesScopedTranslation } from "next-vibe/agent/chat/threads/[threadId]/messages/i18n";
import type { PathGetResponseOutput } from "next-vibe/agent/chat/threads/[threadId]/messages/path/definition";
import { scopedTranslation as pathScopedTranslation } from "next-vibe/agent/chat/threads/[threadId]/messages/path/i18n";
import { pathRepository } from "next-vibe/agent/chat/threads/[threadId]/messages/path/repository";
import { MessagesRepository } from "next-vibe/agent/chat/threads/[threadId]/messages/repository";
import { ThreadByIdRepository } from "next-vibe/agent/chat/threads/[threadId]/repository";
import type { ThreadListResponseOutput } from "next-vibe/agent/chat/threads/definition";
import { scopedTranslation as threadsScopedTranslation } from "next-vibe/agent/chat/threads/i18n";
