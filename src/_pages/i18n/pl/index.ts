...
export const translations: typeof enTranslations = {
  ...
  endpointCategories: {
    ai: "AI",
    aiInference: "Wnioskowanie",
    aiGeneration: "Generowanie",
    aiSearch: "Wyszukiwanie",
    aiTools: "Narzędzia",
    aiSkills: "Postacie",
    analytics: "Analityka",
    analyticsDataSources: "Analityka: Źródła danych",
    analyticsEvaluators: "Ewaluatory",
    analyticsIndicators: "Wskaźniki",
    analyticsTransformers: "Transformatory",
    ...
    chatOrganization: "Organizacja",
    memories: "Wspomnienia",
    memoriesManagement: "Zarządzanie",
    memoriesSearch: "Wyszukiwanie",
    messages: "Wiadomości",
    messagesFiles: "Pliki",
    messagesSearch: "Wyszukiwanie",
    messagesModerating: "Moderacja",
    skills: "Postacie",
    skillsManagement: "Zarządzanie",
    skillsModeration: "Moderacja",
    skillsCommunity: "Społeczność",
    threads: "Wątki",
    threadsManagement: "Zarządzanie",
    threadsSharing: "Udostępnianie",
    threadsSearch: "Wyszukiwanie",
    credits: "Kredyty",
    creditsManagement: "Zarządzanie",
    creditsAnalytics: "Kredyty",
    leads: "Leady",
    leadsManagement: "Zarządzanie",
    leadsImport: "Import",
    leadsAnalytics: "Leady",
    leadMagnet: "Lead Magnet",
    leadMagnetCapture: "Pozyskiwanie",
    leadMagnetIntegrations: "Integracje",
    emailCampaigns: "Kampanie e-mail",
    emailCampaignsQueue: "Kolejka",
    emailCampaignsJourneys: "Ścieżki",
    emailCampaignsProcessing: "Przetwarzanie",
    emailCampaignsStats: "Statystyki",
    messenger: "Messenger",
    messengerAccounts: "Konta",
    messengerInbox: "Skrzynka odbiorcza",
    messengerMessages: "Wiadomości",
    messengerProviders: "Dostawcy",
    newsletter: "Newsletter",
    newsletterSubscriptions: "Subskrypcje",
    newsletterAnalytics: "Newsletter",
    payments: "Płatności",
    paymentTransactions: "Transakcje",
    paymentProviders: "Dostawcy",
    paymentAnalytics: "Płatności",
    referral: "Polecenie",
    referralProgram: "Program",
    referralPayouts: "Wypłaty",
    referralAnalytics: "Polecenia",
    ssh: "SSH",
    sshConnections: "Połączenia",
    sshTerminal: "Terminal",
    sshFiles: "Pliki",
    sshExecution: "Wykonanie",
    subscriptions: "Subskrypcje",
    subscriptionManagement: "Zarządzanie",
    subscriptionAnalytics: "Subskrypcje",
    server: "Serwer",
    serverManagement: "Zarządzanie",
    ...
    devToolsCheck: "Sprawdzanie",
    devToolsGenerators: "Generatory",
    devToolsBuild: "Build",
    ...
    settings: "Ustawienia",
    settingsEnv: "Środowisko",
    settingsHelp: "Pomoc",
    settingsKeys: "Klucze",
    userAuth: "Konto użytkownika",
    userAuthLogin: "Logowanie",
    userAuthProfile: "Profil",
    userAuthSessions: "Sesje",
    userAuthDirectory: "Katalog",
    userAdmin: "Administracja użytkownikami",
    userAdminManagement: "Zarządzanie",
    userAdminStats: "Statystyki",
    remote: "Połączenia zdalne",
    remoteInstances: "Instancje",
    remoteSelf: "Własna",
    users: "Użytkownicy",
    support: "Wsparcie",
    accounting: "Księgowość",
    accountingAccounts: "Konta",
    accountingPeriods: "Okresy",
    accountingJournal: "Dziennik",
    accountingLedger: "Księga główna",
    companies: "Firmy",
    companyManagement: "Zarządzanie firmą",
    companyMembers: "Członkowie firmy",
    products: "Produkty",
    catalogManagement: "Zarządzanie katalogiem",
