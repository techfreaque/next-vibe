export const translations = {
  ...
  sections: {
    ...
    subscriptions: {
      ...
      plans: {
        ...
        content:
          "We offer a subscription plan and credit packs. Credit packs never expire, even after subscription ends.",
      },
      billing: {
        title: "Billing",
        content:
  ...
  post: {
    ...
    form: {
      title: "Terms Of Service Configuration",
      description: "Configure terms of service parameters",
    },
    response: {
      title: "Response",
      description: "Terms Of Service response data",
    },
    errors: {
      unauthorized: {
        title: "Unauthorized",
