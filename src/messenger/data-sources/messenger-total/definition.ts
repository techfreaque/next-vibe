/**
 * Messenger Total - Endpoint Definition
...
import { MESSENGER_TOTAL_ALIAS } from "./constants";
import { scopedTranslation } from "./i18n";
const MessengerTotalWidget = lazyWidget(() =>
  import("./widget").then((m) => ({ default: m.MessengerTotalWidget })),
);

const { POST } = createEndpoint({
  scopedTranslation,
  aliases: [MESSENGER_TOTAL_ALIAS],
  method: Methods.POST,
