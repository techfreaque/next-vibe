...
export const translations: typeof enTranslations = {
  ...
  preview: {
    ...
    sendTest: {
      ...
      error: {
        templateNotFound: "E-Mail-Vorlage {{templateId}} nicht gefunden",
        invalidProps: "Ungültige Vorlagendaten: {{error}}",
        sendFailed: "Test-E-Mail konnte nicht gesendet werden: {{error}}",
      },
      success: "Test-E-Mail versendet",
      successDetail: "Test-E-Mail an {{email}} versendet",
      title: "Test-E-Mail senden",
