...
export const translations: typeof enTranslations = {
  ...
  preview: {
    ...
    sendTest: {
      ...
      error: {
        templateNotFound: "Nie znaleziono szablonu e-mail {{templateId}}",
        invalidProps: "Nieprawidłowe dane szablonu: {{error}}",
        sendFailed: "Nie udało się wysłać testowego e-maila: {{error}}",
      },
      success: "Testowy e-mail wysłany",
      successDetail: "Testowy e-mail wysłany na {{email}}",
