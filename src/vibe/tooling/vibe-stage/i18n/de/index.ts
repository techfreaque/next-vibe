...
export const translations: typeof enTranslations = {
  ...
  response: {
    ...
    renamed: "Umbenannt (Verschiebungen)",
    deleted: "Gelöscht (generiert/Fixtures)",
  ...
  widget: {
    ...
    renamedCount: "Verschiebungen gestagt",
    deletedCount: "Löschungen gestagt",
    renameFile: "verschoben",
    deleteFile: "entfernt",
