...
interface CodeQualityCheckResult {
...
function CodeQualityIssueListCli({
  items,
  editorUriScheme,
}: {
...
function CodeQualityFilesListCli({
  files,
  totalFiles,
}: {
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      {remainingFiles > 0 && (
        <Text dimColor>
          {t("widgets.codeQualityFiles.andMoreFiles", {
...
function CodeQualitySummaryCli({
  totalIssues,
  totalFiles,
  totalErrors,
  displayedIssues,
