...
export const translations: typeof enTranslations = {
  ...
  widget: {
    ...
    connected: {
      ...
      lastSynced: "Pierwsza synchronizacja",
      wsConnected: "Połączono od",
      refresh: "Odśwież",
      transportReverseWs: "Reverse WS (tunel)",
      transportDirectHttp: "Bezpośrednie HTTP",
    },
    notConnected: {
