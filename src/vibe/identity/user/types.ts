...
export const standardUserSchema = z.object({
  ...
  userRoles: z.array(
    z.object({
      id: z.uuid(),
      role: z.enum(UserPermissionRole),
    }),
  ),
...
export const completeUserSchema = standardUserSchema.extend({
  ...
  rumbleUrl: z.string().nullable().optional(),
  odyseeUrl: z.string().nullable().optional(),
  nostrUrl: z.string().nullable().optional(),
  gabUrl: z.string().nullable().optional(),
  tribeUrl: z.string().nullable().optional(),
