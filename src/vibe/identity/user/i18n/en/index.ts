export const translations = {
  ...
  errors: {
    ...
    auth_required: "Authentication is required. One of these roles: {{roles}}",
    auth_retrieval_failed: "Failed to retrieve authentication: {{error}}",
    not_found: "User not found",
    not_found_by_id: "No user found with ID {{userId}}",
    not_found_by_email: "No user found with email {{email}}",
    roles_lookup_failed: "Failed to look up roles for user {{userId}}",
    roles_batch_fetch_failed: "Failed to batch fetch roles for {{count}} users",
    id_lookup_failed: "Failed to look up user {{userId}}: {{error}}",
    email_lookup_failed: "Failed to look up user by email {{email}}: {{error}}",
    email_check_failed: "Failed to check email {{email}}: {{error}}",
    email_duplicate_check_failed:
      "Failed to check email {{email}} against other users (excluding {{excludeUserId}}): {{error}}",
    search_failed: "Failed to search users for {{query}}: {{error}}",
    list_failed: "Failed to list users: {{error}}",
    email_already_in_use: "Email address is already in use",
    creation_failed: "Failed to create user: {{error}}",
    no_data_returned: "No data returned from database",
    password_hashing_failed: "Failed to hash password for {{email}}: {{error}}",
