/**
 * Error Logs Errors - Endpoint Definition
...
import { scopedTranslation } from "next-vibe/logger/error-monitor/data-sources/error-logs-errors/i18n";
