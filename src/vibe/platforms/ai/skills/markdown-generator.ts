...
type SkillTier = "public-user" | "user-with-account";
...
const SKILL_TIERS: Record<SkillTier, SkillTierConfig> = {
  "public-user": {
    tier: "public-user",
...
export async function generateTierAiRunMarkdown(
  ...
  const agentUrl = `${baseUrl}/api/${locale}/system/platforms/ai/skills/AGENT.md`;
 ...
 */
async function getSkillSkillInfo(
  skillId: string,
  locale: CountryLanguage,
