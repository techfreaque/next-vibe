 ...
 * GET /api/[locale]/system/platforms/ai/skills/[skill-id]-skill.md
 *
 ...
 *
 * Examples:
 *   /api/en/system/platforms/ai/skills/research-agent-skill.md
 *   /api/en/system/platforms/ai/skills/writer-skill.md
 *
