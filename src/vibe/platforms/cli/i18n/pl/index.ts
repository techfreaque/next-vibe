...
export const translations: typeof enTranslations = {
  ...
  vibe: {
    ...
    errors: {
      ...
      executionFailedDetail: "Wykonanie nie powiodło się: {{error}}",
      ...
      writeFailed: "Nie udało się zapisać sesji: {{error}}",
      deleteFailed: "Nie udało się usunąć sesji: {{error}}",
      storeFailed: "Nie udało się przechować sesji: {{error}}",
      clearFailed: "Nie udało się wyczyścić sesji: {{error}}",
