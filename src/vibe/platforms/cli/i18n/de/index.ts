...
export const translations: typeof enTranslations = {
  ...
  vibe: {
    ...
    errors: {
      ...
      executionFailedDetail: "Ausführung fehlgeschlagen: {{error}}",
      ...
      writeFailed: "Sitzung konnte nicht geschrieben werden: {{error}}",
      deleteFailed: "Sitzung konnte nicht gelöscht werden: {{error}}",
      storeFailed: "Sitzung konnte nicht gespeichert werden: {{error}}",
      clearFailed: "Sitzung konnte nicht gelöscht werden: {{error}}",
