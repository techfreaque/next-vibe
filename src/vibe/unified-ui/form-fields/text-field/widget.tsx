/**
 * Text Field Widget - Platform-agnostic React implementation
...
import { renderPrefillDisplay } from "next-vibe/unified-ui/form-fields/_shared/prefill";
...
/**
 * Text Field Widget Component
 *
 * Platform-agnostic text input field that works on both web and native.
 * Supports text, email, url, and tel input types.
 *
 * Features:
 * - Auto-inferred config from endpoint fields
 * - Schema-based validation
 * - Required field styling with themes
 * - Prefill display support
 * - Description tooltips
 * - Platform-agnostic (web/native via next-vibe-ui)
 *
 * @param props - React widget props
 * @returns Platform-agnostic text field component
 */
              ...
              !fieldState.isDirty ? (
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    field.size === "lg" ? "h-12 text-base rounded-xl" : "h-10",
                  )}
                />
              )}
            </FormControl>
