/**
 * Color Field Widget - Platform-agnostic React implementation
 */
...
import type { ColorFieldWidgetConfig } from "./types";

export function ColorFieldWidget<
              ...
              !fieldState.isDirty ? (
                ...
                <Div className="flex gap-2 items-center">
                  ...
                  <Input
                    ...
                    onBlur={formField.onBlur}
                    placeholder={
                      field.placeholder ? tField(field.placeholder) : "#000000"
                    }
                    disabled={isDisabled || field.disabled || field.readonly}
...
export default ColorFieldWidget;
