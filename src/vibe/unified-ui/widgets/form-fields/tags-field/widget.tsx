/**
 * Tags Field Widget - Platform-agnostic React implementation
...
import type { TagsFieldWidgetConfig, TagsWidgetSchema } from "./types";
  ...
  return (
    <FormField
      ...
      render={({ field: formField, fieldState }) => {
        ...
        // A single value may arrive as a bare string (see TagsWidgetSchema).
        // Normalise on read so the field only ever renders — and onChange only
        // ever writes — an array.
        const rawValue: string | string[] | null | undefined = formField.value;
...
export default TagsFieldWidget;
