 ...
 */
// The flat form value type for an endpoint — request-data ∪ url-path-params.
// Delegates to the endpoint's own `types.FormValues` (built via MergeFormValues)
// so this and the form hooks/resolver share one definition and unify cleanly.
