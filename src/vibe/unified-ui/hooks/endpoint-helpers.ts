 ...
 */
type PostRequest<T> = T extends { POST: CreateApiEndpointAny }
  ? T["POST"]["types"]["RequestOutput"]
  : never;

type PostResponse<T> = T extends { POST: CreateApiEndpointAny }
  ? T["POST"]["types"]["ResponseOutput"]
  : never;

type PostUrlVariables<T> = T extends { POST: CreateApiEndpointAny }
 ...
 */
type PutRequest<T> = T extends { PUT: CreateApiEndpointAny }
  ? T["PUT"]["types"]["RequestOutput"]
  : never;

type PutResponse<T> = T extends { PUT: CreateApiEndpointAny }
  ? T["PUT"]["types"]["ResponseOutput"]
  : never;

type PutUrlVariables<T> = T extends { PUT: CreateApiEndpointAny }
