...
/**
 * Deliberately terse on the CLI: each setup has already narrated its own work
 * through the logger by the time this renders, so repeating every summary here
 * would print the run twice. This is the verdict, not the transcript.
 *
