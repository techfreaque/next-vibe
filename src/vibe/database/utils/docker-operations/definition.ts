...
import { scopedTranslation } from "next-vibe/database/utils/docker-operations/i18n";
...
const { POST } = createEndpoint({
  ...
  fields: objectField(scopedTranslation, {
    ...
    children: {
      ...
      command: requestField(scopedTranslation, {
        ...
        label: "fields.command.label",
        description: "fields.command.description",
        placeholder: "fields.command.placeholder",
        columns: 12,
  ...
  errorTypes: {
    ...
    [EndpointErrorTypes.NETWORK_ERROR]: {
      ...
      description: "errors.timeout.description",
    },
