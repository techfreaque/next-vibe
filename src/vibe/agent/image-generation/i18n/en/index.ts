...
export const translations = {
  ...
  post: {
    ...
    errors: {
      ...
      providerUnavailable:
        "{{label}} is unavailable right now. Pick another model at {{url}}",
      insufficientCredits:
      ...
      noImageGenerated: "The model did not generate an image",
      ...
      nonJsonResponse:
        "Provider returned a non-JSON response (HTTP {{status}}): {{body}}",
    },
    success: {
