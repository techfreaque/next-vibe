...
export const translations: typeof enTranslations = {
  ...
  uploadingAttachments: "Dateien werden hochgeladen...",
  gapFill: {
    transcribingAudio: "Audio wird transkribiert…",
    analyzingImage: "Bild wird analysiert…",
    describingVideo: "Video wird beschrieben…",
    ...
    showImageDescription: "Bildbeschreibung anzeigen",
    hideImageDescription: "Bildbeschreibung ausblenden",
    showVideoDescription: "Videobeschreibung anzeigen",
    hideVideoDescription: "Videobeschreibung ausblenden",
  },
  errorCode: "Fehlercode",
  streamInterrupted: {
    label: "Generierung gestoppt",
    hint: "Teilantwort gespeichert. Neue Nachricht senden zum Fortfahren.",
  },
  errorFeedback: {
    ...
    errorLabel: "Fehler",
    causeLabel: "Ursache",
    userContextLabel: "Mehr Kontext hinzufügen (optional)",
    separator: "·",
  },
  compacting: {
  ...
  widget: {
    common: {
      ...
      assistantMessageActions: {
        ...
        timeToFirstTokenTitle: "Zeit bis erstes Token",
        streamingTime: "{{seconds}}s Streaming",
        streamingTimeTitle: "Gesamte Streaming-Dauer",
