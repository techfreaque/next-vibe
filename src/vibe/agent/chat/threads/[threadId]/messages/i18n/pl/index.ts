...
export const translations: typeof enTranslations = {
  ...
  uploadingAttachments: "Przesyłanie plików...",
  gapFill: {
    transcribingAudio: "Transkrypcja audio…",
    analyzingImage: "Analizowanie obrazu…",
    describingVideo: "Opisywanie wideo…",
    processingMedia: "Przetwarzanie mediów…",
    variantUsing: "przez {{model}}",
    variantCost: "{{cost}} kredytów",
    ...
    showImageDescription: "Pokaż opis obrazu",
    hideImageDescription: "Ukryj opis obrazu",
    showVideoDescription: "Pokaż opis wideo",
    hideVideoDescription: "Ukryj opis wideo",
  },
  errorCode: "Kod błędu",
  streamInterrupted: {
  ...
  post: {
    ...
    errors: {
      validation: {
        ...
        parentNotFound: "Nie znaleziono wiadomości nadrzędnej",
      },
      network: {
        title: "Network Error",
        description: "Unable to connect to the server",
