...
export const translations: typeof enTranslations = {
  id: {
    ...
    patch: {
      ...
      promptAppend: {
        ...
        placeholder:
          "z. B. Antworte immer in einem freundlichen, lockeren Ton.",
      },
      memoryLimit: {
  ...
  fallbacks: {
    ...
    noModelConfiguration: "Fehler: Keine Modellkonfiguration",
    configurationMissing: "Konfiguration fehlt",
    noModel: "Kein Modell",
    dash: "—",
  },
  enums: {
  ...
  get: {
    ...
    viewSkill: "Details",
    deleteVariant: "Variante entfernen?",
    deleteVariantAction: "Entfernen",
    deleteGroup: {
    ...
    sections: {
      ...
      background: "Hintergrund-Agenten",
    },
    container: {
