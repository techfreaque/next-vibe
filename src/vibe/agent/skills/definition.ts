  ...
  fields: customWidgetObject({
    ...
    children: {
      ...
      title: widgetField(scopedTranslation, {
        ...
        size: "base",
        label: "get.browser.advancedModelAccess" as const,
        emphasis: "bold",
        inline: true,
        usage: { response: true },
      }),
      ...
      description: widgetField(scopedTranslation, {
        ...
        size: "xs",
        variant: "muted",
        label: "get.browser.configureFiltersText" as const,
      ...
      name: widgetField(scopedTranslation, {
        type: WidgetType.TEXT,
        size: "base",
        label: "get.browser.configureAiModelsTitle" as const,
        emphasis: "bold",
      ...
      modelDescription: widgetField(scopedTranslation, {
        ...
        size: "xs",
        variant: "muted",
        label: "get.browser.advancedChooseText" as const,
        contentParams: {
      ...
      skillsTitle: widgetField(scopedTranslation, {
        type: WidgetType.TEXT,
        size: "base",
        label: "get.browser.skillPresets" as const,
        emphasis: "bold",
        inline: true,
        usage: { response: true },
      }),
      ...
      skillsDesc: widgetField(scopedTranslation, {
        ...
        size: "xs",
        variant: "muted",
        label: "get.browser.pickSkillText" as const,
        className: "text-muted-foreground pb-4",
        usage: { response: true },
      }),
