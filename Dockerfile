...
ARG JWT_SECRET_KEY
ARG CRON_SECRET
ARG NEXT_PUBLIC_VIBE_IS_CLOUD
ARG VIBE_REMOTE_URL
ARG PULSE_INTERVAL_MINUTES
ARG VIBE_ADMIN_USER_EMAIL
ARG VIBE_ADMIN_USER_PASSWORD
ARG VIBE_CLI_LOCALE
ARG NEXT_PUBLIC_VIBE_DEBUG
ARG VIBE_LOG_PATH
ARG VIBE_DISABLE_PROXY
ARG WS_PUBSUB_TYPE
ARG REDIS_URL
ARG DEV_WATCHER_CONTINUOUS
ARG VIBE_SECRET_KEY
ARG NEXT_PUBLIC_DEBUG_PRODUCTION
ARG NEXT_PUBLIC_AGENT_OPEN_ROUTER
ARG NEXT_PUBLIC_AGENT_CLAUDE_CODE
ARG NEXT_PUBLIC_AGENT_VOICE
ARG NEXT_PUBLIC_AGENT_BRAVE_SEARCH
ARG NEXT_PUBLIC_AGENT_KAGI_SEARCH
ARG NEXT_PUBLIC_AGENT_UNCENSORED_AI
ARG NEXT_PUBLIC_AGENT_FREEDOM_GPT
ARG NEXT_PUBLIC_AGENT_GAB_AI
ARG NEXT_PUBLIC_AGENT_VENICE_AI
ARG NEXT_PUBLIC_AGENT_SCRAPPEY
ARG NEXT_PUBLIC_AGENT_OPEN_AI_IMAGES
ARG NEXT_PUBLIC_AGENT_OPEN_AI_STT
ARG NEXT_PUBLIC_AGENT_REPLICATE
ARG NEXT_PUBLIC_AGENT_FAL_AI
ARG NEXT_PUBLIC_AGENT_MODELS_LAB
ARG NEXT_PUBLIC_AGENT_UNBOTTLED
ARG NEXT_PUBLIC_AGENT_EDEN_AI_STT
ARG NEXT_PUBLIC_AGENT_DEEPGRAM
ARG NEXT_PUBLIC_AGENT_OPEN_AI_TTS
ARG NEXT_PUBLIC_AGENT_EDEN_AI_TTS
ARG NEXT_PUBLIC_AGENT_ELEVENLABS
ARG CLAUDE_CODE_ENABLED
ARG VIBE_TEST_AI_MODEL
...
ARG MODELSLAB_API_KEY
ARG UNBOTTLED_CLOUD_CREDENTIALS
...
ENV NEXT_PUBLIC_VIBE_DEBUG=$NEXT_PUBLIC_VIBE_DEBUG
ENV VIBE_LOG_PATH=$VIBE_LOG_PATH
ENV VIBE_DISABLE_PROXY=$VIBE_DISABLE_PROXY
ENV WS_PUBSUB_TYPE=$WS_PUBSUB_TYPE
ENV REDIS_URL=$REDIS_URL
ENV DEV_WATCHER_CONTINUOUS=$DEV_WATCHER_CONTINUOUS
ENV VIBE_SECRET_KEY=$VIBE_SECRET_KEY
ENV NEXT_PUBLIC_DEBUG_PRODUCTION=$NEXT_PUBLIC_DEBUG_PRODUCTION
ENV NEXT_PUBLIC_AGENT_OPEN_ROUTER=$NEXT_PUBLIC_AGENT_OPEN_ROUTER
ENV NEXT_PUBLIC_AGENT_CLAUDE_CODE=$NEXT_PUBLIC_AGENT_CLAUDE_CODE
ENV NEXT_PUBLIC_AGENT_VOICE=$NEXT_PUBLIC_AGENT_VOICE
ENV NEXT_PUBLIC_AGENT_BRAVE_SEARCH=$NEXT_PUBLIC_AGENT_BRAVE_SEARCH
ENV NEXT_PUBLIC_AGENT_KAGI_SEARCH=$NEXT_PUBLIC_AGENT_KAGI_SEARCH
ENV NEXT_PUBLIC_AGENT_UNCENSORED_AI=$NEXT_PUBLIC_AGENT_UNCENSORED_AI
ENV NEXT_PUBLIC_AGENT_FREEDOM_GPT=$NEXT_PUBLIC_AGENT_FREEDOM_GPT
ENV NEXT_PUBLIC_AGENT_GAB_AI=$NEXT_PUBLIC_AGENT_GAB_AI
ENV NEXT_PUBLIC_AGENT_VENICE_AI=$NEXT_PUBLIC_AGENT_VENICE_AI
ENV NEXT_PUBLIC_AGENT_SCRAPPEY=$NEXT_PUBLIC_AGENT_SCRAPPEY
ENV NEXT_PUBLIC_AGENT_OPEN_AI_IMAGES=$NEXT_PUBLIC_AGENT_OPEN_AI_IMAGES
ENV NEXT_PUBLIC_AGENT_OPEN_AI_STT=$NEXT_PUBLIC_AGENT_OPEN_AI_STT
ENV NEXT_PUBLIC_AGENT_REPLICATE=$NEXT_PUBLIC_AGENT_REPLICATE
ENV NEXT_PUBLIC_AGENT_FAL_AI=$NEXT_PUBLIC_AGENT_FAL_AI
ENV NEXT_PUBLIC_AGENT_MODELS_LAB=$NEXT_PUBLIC_AGENT_MODELS_LAB
ENV NEXT_PUBLIC_AGENT_UNBOTTLED=$NEXT_PUBLIC_AGENT_UNBOTTLED
ENV NEXT_PUBLIC_AGENT_EDEN_AI_STT=$NEXT_PUBLIC_AGENT_EDEN_AI_STT
ENV NEXT_PUBLIC_AGENT_DEEPGRAM=$NEXT_PUBLIC_AGENT_DEEPGRAM
ENV NEXT_PUBLIC_AGENT_OPEN_AI_TTS=$NEXT_PUBLIC_AGENT_OPEN_AI_TTS
ENV NEXT_PUBLIC_AGENT_EDEN_AI_TTS=$NEXT_PUBLIC_AGENT_EDEN_AI_TTS
ENV NEXT_PUBLIC_AGENT_ELEVENLABS=$NEXT_PUBLIC_AGENT_ELEVENLABS
ENV CLAUDE_CODE_ENABLED=$CLAUDE_CODE_ENABLED
ENV VIBE_TEST_AI_MODEL=$VIBE_TEST_AI_MODEL
...
ENV FAL_AI_API_KEY=$FAL_AI_API_KEY
ENV ELEVENLABS_API_KEY=$ELEVENLABS_API_KEY
ENV DEEPGRAM_API_KEY=$DEEPGRAM_API_KEY
ENV MODELSLAB_API_KEY=$MODELSLAB_API_KEY
ENV UNBOTTLED_CLOUD_CREDENTIALS=$UNBOTTLED_CLOUD_CREDENTIALS
...
ENV CHROME_EXECUTABLE_PATH=$CHROME_EXECUTABLE_PATH
ENV CHROME_USER_DATA_DIR=$CHROME_USER_DATA_DIR
ENV CHROME_HEADLESS=$CHROME_HEADLESS
ENV CHROME_MCP_DEBUG=$CHROME_MCP_DEBUG
ENV CHROME_MCP_TIMEOUT=$CHROME_MCP_TIMEOUT
...
ENV CORVINA_API_BASE_URL=$CORVINA_API_BASE_URL
ENV CORVINA_PLATFORM_API_BASE_URL=$CORVINA_PLATFORM_API_BASE_URL
ENV CORVINA_API_KEY=$CORVINA_API_KEY
ENV LEADS_EMAIL_FROM_EMAIL=$LEADS_EMAIL_FROM_EMAIL
ENV LEADS_EMAIL_FROM_NAME=$LEADS_EMAIL_FROM_NAME
...
ENV LEADS_IMAP_HOST=$LEADS_IMAP_HOST
ENV LEADS_IMAP_PORT=$LEADS_IMAP_PORT
ENV LEADS_IMAP_SECURE=$LEADS_IMAP_SECURE
ENV LEADS_IMAP_USER=$LEADS_IMAP_USER
ENV LEADS_IMAP_PASS=$LEADS_IMAP_PASS
...
ENV IMAP_SECURE=$IMAP_SECURE
ENV IMAP_USER=$IMAP_USER
ENV IMAP_PASS=$IMAP_PASS
